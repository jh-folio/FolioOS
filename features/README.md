...
| `topic_report/` | 딥 리서치 탭 | 0.2 기본 화면의 질문-first 계획 승인, Smart Collection 재사용, 근거 추적 보고서(내부 Topic Report v2 호환) |
...
0.2 기본 사용자 화면은 Home, 브리핑, RSS 피드, 시장 내러티브, 기업 분석, 딥 리서치, 설정입니다. Dashboard와 Watchlist route는 호환을 위해 남지만 기본 navigation/Home/command palette에서는 숨깁니다.
