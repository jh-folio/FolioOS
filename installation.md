...
Releases unzip into a **version-named folder** such as `FolioOS-v0.5.2/`. The new folder starts with an empty `data/`, so your reports and collected articles do not follow automatically unless you tell them to.
...
```powershell
py -3 scripts\package_release.py --version v0.5.2
py -3 scripts\verify_release.py --release-dir dist\FolioOS-v0.5.2
```
