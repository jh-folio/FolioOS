import { n as e, o as t, s as n, t as r } from "./PixelOfficeScene-ChUqFsWX.js";
import { A as i, B as a, C as o, E as s, L as c, M as l, N as u, O as d, R as f, S as p, T as m, _ as h, a as g, f as _, i as v, k as y, l as b, m as x, n as S, o as C, p as w, r as T, s as E, t as ee, u as te, v as ne, y as re, z as D } from "./Geometry-BFCE0DPo.js";
import { a as ie, c as ae, f as oe, i as O, n as k, o as se, r as A, s as ce } from "./Filter-Bn4pCCDL.js";
import { a as le, c as j, i as M, l as N, o as ue, s as de, u as P } from "./FilterSystem-DFwXUSHG.js";
import { n as F, t as I } from "./Cache-BRp-gP8S.js";
import { n as fe, r as L, t as R } from "./canvasUtils-BTqx9q1Z.js";
import { t as pe } from "./CanvasPool-MBzGEYFt.js";
import { a as me, c as he, i as ge, l as _e, n as ve, o as ye, r as be, s as xe, t as z, u as Se } from "./GraphicsContext-DSLg3PV-.js";
import { a as Ce, c as we, d as Te, f as Ee, i as De, l as Oe, m as ke, n as Ae, o as B, p as je, r as Me, t as Ne, u as Pe } from "./RenderTargetSystem-C2X9hDHj.js";
import { a as Fe, c as Ie, d as Le, f as Re, i as ze, l as Be, m as Ve, o as He, p as V, r as Ue, s as We, t as H, u as Ge } from "./GCManagedHash-CBZAeQ_B.js";
import { t as Ke } from "./getTextureBatchBindGroup-CwG9Mz6G.js";
import { a as qe, c as Je, d as Ye, f as Xe, i as Ze, l as Qe, n as $e, o as et, p as tt, r as nt, s as rt, t as it, u as at } from "./BufferResource-Ch2IsR_5.js";
...
function gt(e, t, n, r) {
	...
	if (i instanceof _e) {
		...
		let a = i.texture;
		if (a) {
			let o = R.getTintedPattern(a, t), s = n ? ut.copyFrom(n).scale(a.source.pixelWidth, a.source.pixelHeight) : ut.copyFrom(i.transform);
			return r && !e.textureSpace && s.append(r), R.applyPatternTransform(o, s), o;
		}
	}
	if (i instanceof he) {
		let e = R.getTintedPattern(i.texture, t);
		return R.applyPatternTransform(e, i.transform, !1), e;
	}
	let a = e.texture;
	if (a && a !== x.WHITE) {
		if (!a.source.resource) return ot;
		let r = R.getTintedPattern(a, t), i = n ? ut.copyFrom(n).scale(a.source.pixelWidth, a.source.pixelHeight) : e.matrix;
		return R.applyPatternTransform(r, i), r;
	}
	return ft(t);
}
var _t = class {
	...
	execute(e, t) {
		...
		if (f <= 0) return;
		let p = s & 16777215, m = oe(o(c & 16777215, p)), g = n._roundPixels | t._roundPixels;
		i.save(), r.setContextTransform(a, g === 1), r.setBlendMode(t.groupBlendMode);
		let _ = t.context.instructions;
		for (let e = 0; e < _.length; e++) {
			let t = _[e];
			if (t.action === "texture") {
				let e = t.data, n = e.image, s = n ? R.getCanvasSource(n) : null;
				if (!s) continue;
				let c = e.alpha * f;
				if (c <= 0) continue;
				let l = o(e.style, m);
				i.globalAlpha = c;
				let u = s;
				l !== 16777215 && (u = R.getTintedCanvas({ texture: n }, l));
				let d = n.frame, p = n.source._resolution ?? n.source.resolution ?? 1, _ = d.x * p, v = d.y * p, y = d.width * p, b = d.height * p;
				u !== s && (_ = 0, v = 0);
				let x = e.transform, S = x && !x.isIdentity(), C = n.rotate;
				S || C ? (st.copyFrom(a), S && st.append(x), C && h.matrixAppendRotationInv(st, C, e.dx, e.dy, e.dw, e.dh), r.setContextTransform(st, g === 1)) : r.setContextTransform(a, g === 1), i.drawImage(u, _, v, u === s ? y : u.width, u === s ? b : u.height, C ? 0 : e.dx, C ? 0 : e.dy, e.dw, e.dh), (S || C) && r.setContextTransform(a, g === 1);
				continue;
			}
			let n = t.data, s = n?.path?.shapePath;
			if (!s?.shapePrimitives?.length) continue;
			let c = n.style, l = o(c.color, m), u = c.alpha * f;
			if (u <= 0) continue;
			...
			for (let e = 0; e < p.length; e++) {
				...
				if (r && (i.save(), i.transform(n.a, n.b, n.c, n.d, n.tx, n.ty)), d) {
					...
					if (e.alignment !== .5 && !e.pixelLine) {
						let n = [], r = [], a = [];
						me[t.shape.type]?.build(t.shape, n) ? (Se(n, e, !1, t.shape.closePath ?? !0, r, a), i.fillStyle = u, dt(i, r, a)) : (i.strokeStyle = u, i.beginPath(), mt(i, t.shape), i.stroke());
...
var vt = class e {
	...
	execute(t, n) {
		...
		for (let t = 0; t < r.length; t++) {
			...
			let l = c, u = l.texture, d = u ? R.getCanvasSource(u) : null;
			if (!d) continue;
			...
			if (x <= 0) continue;
			s.globalAlpha = x;
			let S = g & 16777215, C = oe(o(_ & 16777215, S)), w = u.frame, T = f.addressModeU ?? f.addressMode, E = f.addressModeV ?? f.addressMode, ee = e._getPatternRepeat(T, E), te = u.source._resolution ?? u.source.resolution ?? 1, ne = l.renderable?.renderGroup?.isCachedAsTexture, re = w.x * te, D = w.y * te, ie = w.width * te, ae = w.height * te, O = l.bounds, k = i.renderTarget.renderTarget.isRoot, se = O.minX, A = O.minY, ce = O.maxX - O.minX, le = O.maxY - O.minY, j = u.rotate, M = u.uvs, N = Math.min(M.x0, M.x1, M.x2, M.x3, M.y0, M.y1, M.y2, M.y3), ue = Math.max(M.x0, M.x1, M.x2, M.x3, M.y0, M.y1, M.y2, M.y3), de = ee !== "no-repeat" && (N < 0 || ue > 1), P = j && !(!de && (C !== 16777215 || j));
			P ? (e._tempPatternMatrix.copyFrom(l.transform), h.matrixAppendRotationInv(e._tempPatternMatrix, j, se, A, ce, le), a.setContextTransform(e._tempPatternMatrix, l.roundPixels === 1, void 0, ne && k)) : a.setContextTransform(l.transform, l.roundPixels === 1, void 0, ne && k);
			let F = ce, I = le, fe = P ? 0 : se, L = P ? 0 : A;
			if (!P && l.roundPixels === 1 && (fe |= 0, L |= 0), de) {
				let t = d, n = C !== 16777215 && !j, r = w.width <= u.source.width && w.height <= u.source.height;
				n && r && (t = R.getTintedCanvas({ texture: u }, C));
				let i = s.createPattern(t, ee);
				if (!i) continue;
				let a = F, o = I;
				if (a === 0 || o === 0) continue;
				let c = 1 / a, l = 1 / o, f = (M.x1 - M.x0) * c, p = (M.y1 - M.y0) * c, m = (M.x3 - M.x0) * l, h = (M.y3 - M.y0) * l, g = M.x0 - f * fe - m * L, _ = M.y0 - p * fe - h * L, v = u.source.pixelWidth, y = u.source.pixelHeight;
				e._tempPatternMatrix.set(f * v, p * y, m * v, h * y, g * v, _ * y), R.applyPatternTransform(i, e._tempPatternMatrix), s.fillStyle = i, s.fillRect(fe, L, F, I);
			} else {
				let e = C !== 16777215 || j ? R.getTintedCanvas({ texture: u }, C) : d, t = e !== d;
				s.drawImage(e, t ? 0 : re, t ? 0 : D, t ? e.width : ie, t ? e.height : ae, fe, L, F, I);
			}
		}
	}
};
...
var W = "source-over";
function Pt() {
	let e = fe(), t = /* @__PURE__ */ Object.create(null);
...
var Bt = class {
	...
	initSource(e) {}
	generateCanvas(e) {
		let t = w.get().createCanvas(), n = t.getContext("2d"), r = R.getCanvasSource(e);
		if (!r) return t;
...
a.handleByNamedList(D.CanvasSystem, Wt), a.handleByNamedList(D.CanvasPipes, Gt), a.handleByNamedList(D.CanvasPipesAdaptor, Kt), a.add(...Vt, ...Ht, ...Ut);
...
var en = class e {
	...
	init(t) {
		...
		if (t.context && n && (d("Renderer created with both a context and multiview enabled. Disabling multiView as both cannot work together."), n = !1), n ? this.canvas = w.get().createCanvas(this._renderer.canvas.width, this._renderer.canvas.height) : this.canvas = this._renderer.view.canvas, t.context) this.initFromContext(t.context);
		else {
...
var un = new ee({ attributes: { aPosition: [
	...
	_getBackBufferTexture(e) {
		return this._backBufferTexture = this._backBufferTexture || new x({ source: new ne({
			width: e.width,
			height: e.height,
	...
	return {
		...
		upload(t, n, r, i) {
			...
			for (let t = 0; t < or.length; t++) {
				let o = a[or[t]];
				(e[o.uploadMethodId] || e.image).upload(o, n, r, i, rn.TEXTURE_CUBE_MAP_POSITIVE_X + t, (n._layerInitMask & 1 << t) == 0), n._layerInitMask |= 1 << t;
			}
...
var Tr = wr;
a.handleByMap(D.TextureUploaderWebGL, Tr.uploadExtensions);
//#endregion
...
a.handleByNamedList(D.WebGLSystem, kr), a.handleByNamedList(D.WebGLPipes, Ar), a.handleByNamedList(D.WebGLPipesAdaptor, jr), a.add(...Er, ...Dr, ...Or);
...
var ti = class {
	...
	_generateBufferKey(e) {
		...
		return e._layoutKey = _(t.join("|"), "geometry"), e._layoutKey;
	}
	_generateAttributeLocationsKey(e) {
		...
		return e._attributeLocationsKey = _(t.join("|"), "programAttributes"), e._attributeLocationsKey;
	}
...
var pi = {
	...
	getPixels(e) {
		let t = this.generateCanvas(e), n = pe.getOptimalCanvasAndContext(t.width, t.height), r = n.context;
		r.drawImage(t, 0, 0);
		let { width: i, height: a } = t, o = r.getImageData(0, 0, i, a), s = new Uint8ClampedArray(o.data.buffer);
		return pe.returnCanvasAndContext(n), {
			pixels: s,
			width: i,
			height: a
		};
...
var vi = _i;
a.handleByMap(D.TextureUploaderWebGPU, vi.uploadExtensions);
//#endregion
...
a.handleByNamedList(D.WebGPUSystem, Si), a.handleByNamedList(D.WebGPUPipes, Ci), a.handleByNamedList(D.WebGPUPipesAdaptor, wi), a.add(...yi, ...bi, ...xi);
...
function zi(e) {
	return typeof e == "string" ? Ni.has(e.charCodeAt(0)) : !1;
}
function J(e, t) {
	return typeof e == "string" ? Pi.has(e.charCodeAt(0)) : !1;
}
function Bi(e) {
	return typeof e == "string" ? Fi.has(e.charCodeAt(0)) : !1;
}
function Vi(e) {
	return typeof e == "string" ? Ii.has(e.charCodeAt(0)) : !1;
}
function Hi(e) {
...
function sa(e, t, n, r = 0, i = 0, a = 0) {
	...
	} else if (e.fill instanceof he) {
		let n = e.fill, r = t.createPattern(n.texture.source.resource, "repeat");
		return R.applyPatternTransform(r, n.transform, !1), r;
	} else if (e.fill instanceof _e) {
...
var ca = class e extends Ei {
	...
	_nextPage() {
		...
		let e = this.resolution, t = pe.getOptimalCanvasAndContext(this._textureSize, this._textureSize, e);
		this._setupContext(t.context, this._style, e);
		let n = e * (this.baseRenderedFontSize / this.baseMeasurementFontSize), r = new x({ source: new L({
			resource: t.canvas,
			resolution: n,
	...
	destroy() {
		...
		for (let e = 0; e < this.pages.length; e++) {
			...
			pe.returnCanvasAndContext(t), n.destroy(!0);
		}
		this.pages = null;
	}
};
...
var ha = 0, ga = new class {
	...
	constructor(e, t) {
		...
		Object.keys(r.pages).forEach((e) => {
			...
			let t = r.chars[e], { frame: i, source: a, rotate: o } = n[t.page], s = new x({
				frame: h.transformRectCoords(t, i, o, new m()),
...
var ya = {
	...
	test: () => !0,
	load: async () => {
		await import("./browserAll-C_ZQ3FAx.js");
	}
}, xa = {
	extension: {
		type: D.Environment,
	...
	load: async () => {
		await import("./webworkerAll-DKPhouwA.js");
	}
}, Sa;
function Ca(e) {
	return Sa === void 0 && (Sa = (() => {
...
async function Da(e) {
	...
	for (let i = 0; i < t.length; i++) {
		...
		if (a === "webgpu" && await Ta()) {
			let { WebGPURenderer: t } = await import("./WebGPURenderer-CKceVP85.js");
			n = t, r = {
				...e,
				...e.webgpu
			};
			break;
		} else if (a === "webgl" && Ca(e.failIfMajorPerformanceCaveat ?? Ce.defaultOptions.failIfMajorPerformanceCaveat)) {
			let { WebGLRenderer: t } = await import("./WebGLRenderer--2B8uCV2.js");
			n = t, r = {
				...e,
				...e.webgl
			};
			...
			let { CanvasRenderer: t } = await import("./CanvasRenderer-YX3mWW7K.js");
			n = t, r = {
				...e,
				...e.canvasOptions
			};
...
ka.extension = D.Application, a.add(Oa), a.add(ka);
//#endregion
//#region node_modules/pixi.js/lib/app/Application.mjs
var Aa = class e {
	constructor(...e) {
		this.stage = new ae(), e[0] !== void 0 && y(i, "Application constructor options are deprecated, please use Application.init() instead.");
	}
	async init(t) {
		t = { ...t }, this.stage ||= new ae(), this.renderer = await Da(t), e._plugins.forEach((e) => {
			e.init.call(this, t);
		});
	}
	render() {
...
Aa._plugins = [];
var ja = Aa;
a.handleByList(D.Application, ja._plugins), a.add(De);
//#endregion
...
var Ma = {
	...
	id: "bitmap-font",
	test(e) {
		return Fa.includes(N.extname(e).toLowerCase());
	},
	async testParse(e) {
	...
	async parse(e, t, n) {
		...
		let [c, { BitmapFont: l }] = await Promise.all([n.load(o), import("./BitmapFont-Bbc8YVE_.js")]);
		return new l({
			data: r,
...
function Ga(e) {
	return Wa ? !1 : document.createElement("video").canPlayType(e) !== "";
}
//#endregion
...
function Vo() {
	let e = [], t = [];
	for (let n of Fo) {
		let r = M.MIME_TYPES[n.substring(1)] || `video/${n.substring(1)}`;
...
var Ho = {
	...
	constructor() {
		this._detections = [], this._initialized = !1, this.resolver = new de(), this.loader = new Za(), this.cache = I, this._backgroundLoader = new Ra(this.loader), this._backgroundLoader.active = !0, this.reset();
	}
	async init(e = {}) {
...
a.handleByList(D.LoadParser, Go.loader.parsers).handleByList(D.ResolveParser, Go.resolver.parsers).handleByList(D.CacheParser, Go.cache.parsers).handleByList(D.DetectionParser, Go.detections), a.add(za, Ua, Va, Ya, Ka, qa, Ja, no, ao, mo, yo, Po, Ho, La, Ia, Uo, Wo);
var Ko = {
	loader: D.LoadParser,
...
var qo = [
	...
	assets: [
		...
		},
		{
			...
			role: "scene_object",
			src: "/pixel-office/scenes/classic/object-market-board-v1.png",
			width: 560,
			height: 315,
			depth: 11800,
		...
		},
		{
			...
			role: "scene_object",
			src: "/pixel-office/scenes/classic/object-memo-board-v1.png",
			width: 560,
			height: 315,
			depth: 21300,
			objectId: "memo_board"
		...
		{
			id: "classic_news_desk_object",
			role: "scene_object",
			src: "/pixel-office/scenes/classic/object-news-desk-v1.png",
			width: 560,
			height: 315,
			depth: 13700,
			objectId: "news_desk"
		...
		{
			id: "classic_research_desk_object",
			role: "scene_object",
			src: "/pixel-office/scenes/classic/object-research-desk-v1.png",
			width: 560,
			height: 315,
			depth: 17800,
		...
		},
		{
			...
			role: "scene_object",
			src: "/pixel-office/scenes/classic/object-report-shelf-v1.png",
			width: 560,
			height: 315,
			depth: 24900,
		...
		},
		{
			...
			role: "scene_object",
			src: "/pixel-office/scenes/classic/object-agent-seat-rug-v1.png",
			width: 560,
			height: 315,
			depth: 200,
			objectId: "agent_seat"
		},
		{
			...
			role: "scene_object",
			src: "/pixel-office/scenes/classic/object-agent-seat-chair-v1.png",
			width: 560,
			height: 315,
			depth: 26300,
			objectId: "agent_seat"
		},
		{
			...
			role: "scene_object",
			src: "/pixel-office/scenes/classic/object-agent-seat-side-table-v1.png",
			width: 560,
			height: 315,
			depth: 27100,
			objectId: "agent_seat"
		},
		{
			...
			role: "scene_object",
			src: "/pixel-office/scenes/classic/object-agent-seat-coffee-table-v1.png",
			width: 560,
			height: 315,
			depth: 28200,
			objectId: "agent_seat"
		...
		{
			id: "classic_portfolio_monitor_object",
			role: "scene_object",
			src: "/pixel-office/scenes/classic/object-portfolio-monitor-v1.png",
			width: 560,
			height: 315,
			depth: 29600,
...
function us(e, t, n) {
	...
	let i = new O(n.roomBase.texture);
	...
	ls(a, t);
	let o = new ae(), s = new O(n.characterIdle.texture);
	s.anchor.set(.5, 1);
...
function Os({ manifest: e, statuses: t, intent: n, reducedMotion: r, onReady: i, onFailure: a, onPhaseChange: o }) {
	...
	return (0, U.useEffect)(() => {
		...
		return (async () => {
			try {
				if (Ds(e), re.defaultOptions.scaleMode = "nearest", r = new ja(), await r.init({
