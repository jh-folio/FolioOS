import { A as e, B as t, C as n, E as r, L as i, M as a, N as o, O as s, P as c, R as l, S as u, T as d, b as f, j as p, k as m, m as h, p as g, w as _, z as v } from "./Geometry-DGpI5VLa.js";
import { r as y } from "./canvasUtils-BZeDVeMM.js";
import { n as b, t as x } from "./GCManagedHash-DosM8O0d.js";
import { t as S } from "./getTextureBatchBindGroup-0U455dfl.js";
...
var w = class e {
	...
	containsPolygon(e) {
		let t = this.getBounds(E), n = e.getBounds(D);
	...
	strokeContains(e, t, n, r = .5) {
		...
		for (let n = 0; n < c; n += 2) {
			...
			if (C(e, t, r, i, c, l) <= (Math.sign((c - r) * (t - i) - (l - i) * (e - r)) < 0 ? o : a)) return !0;
		}
		return !1;
	}
	getBounds(e) {
	...
	get x() {
		return m("8.11.0", "Polygon.lastX is deprecated, please use Polygon.lastX instead."), this.points[this.points.length - 2];
	}
	get y() {
		return m("8.11.0", "Polygon.y is deprecated, please use Polygon.lastY instead."), this.points[this.points.length - 1];
	}
	get startX() {
	...
	strokeContains(e, t, n, r = .5) {
		...
		return (e >= i - l && e <= i + u || e >= h - u && e <= h + l) && t >= f && t <= f + m || (t >= a - l && t <= a + u || t >= g - u && t <= g + l) && e >= d && e <= d + p || e < d && t < f && k(e, t, d, f, c, u, l) || e > h - c && t < f && k(e, t, h - c, f, c, u, l) || e > h - c && t > g - c && k(e, t, h - c, g - c, c, u, l) || e < d && t > g - c && k(e, t, d, g - c, c, u, l);
	}
	toString() {
...
function F(e, t, n, r, i, a) {
	...
	let s = t, l = s.alignment;
	if (t.alignment !== .5) {
		let t = N(e);
		n && (t *= -1), l = (l - .5) * t + .5;
	}
	let u = new c(e[0], e[1]), d = new c(e[e.length - 2], e[e.length - 1]), f = r, p = Math.abs(u.x - d.x) < o && Math.abs(u.y - d.y) < o;
	if (f) {
		e = e.slice(), p && (e.pop(), e.pop(), d.set(e[e.length - 2], e[e.length - 1]));
		let t = (u.x + d.x) * .5, n = (d.y + u.y) * .5;
		e.unshift(t, n), e.push(t, n);
	}
	let m = i, h = e.length / 2, g = e.length, _ = m.length / 2, v = s.width / 2, y = v * v, b = s.miterLimit * s.miterLimit, x = e[0], S = e[1], C = e[2], w = e[3], T = 0, E = 0, D = -(S - w), O = x - C, k = 0, A = 0, F = Math.sqrt(D * D + O * O);
	D /= F, O /= F, D *= v, O *= v;
	let I = l, L = (1 - I) * 2, R = I * 2;
	f || (s.cap === "round" ? g += P(x - D * (L - R) * .5, S - O * (L - R) * .5, x - D * L, S - O * L, x + D * R, S + O * R, m, !0) + 2 : s.cap === "square" && (g += ee(x, S, D, O, L, R, !0, m))), m.push(x - D * L, S - O * L), m.push(x + D * R, S + O * R);
	for (let t = 1; t < h - 1; ++t) {
		x = e[(t - 1) * 2], S = e[(t - 1) * 2 + 1], C = e[t * 2], w = e[t * 2 + 1], T = e[(t + 1) * 2], E = e[(t + 1) * 2 + 1], D = -(S - w), O = x - C, F = Math.sqrt(D * D + O * O), D /= F, O /= F, D *= v, O *= v, k = -(w - E), A = C - T, F = Math.sqrt(k * k + A * A), k /= F, A /= F, k *= v, A *= v;
		let n = C - x, r = S - w, i = C - T, a = E - w, o = n * i + r * a, c = r * i - a * n, l = c < 0;
		if (Math.abs(c) < .001 * Math.abs(o)) {
			m.push(C - D * L, w - O * L), m.push(C + D * R, w + O * R), o >= 0 && (s.join === "round" ? g += P(C, w, C - D * L, w - O * L, C - k * L, w - A * L, m, !1) + 4 : g += 2, m.push(C - k * R, w - A * R), m.push(C + k * L, w + A * L));
			continue;
		}
		let u = (-D + x) * (-O + w) - (-D + C) * (-O + S), d = (-k + T) * (-A + w) - (-k + C) * (-A + E), f = (n * d - i * u) / c, p = (a * u - r * d) / c, h = (f - C) * (f - C) + (p - w) * (p - w), _ = C + (f - C) * L, j = w + (p - w) * L, M = C - (f - C) * R, N = w - (p - w) * R, ee = Math.min(n * n + r * r, i * i + a * a), I = l ? L : R;
		h <= ee + I * I * y ? s.join === "bevel" || h / y > b ? (l ? (m.push(_, j), m.push(C + D * R, w + O * R), m.push(_, j), m.push(C + k * R, w + A * R)) : (m.push(C - D * L, w - O * L), m.push(M, N), m.push(C - k * L, w - A * L), m.push(M, N)), g += 2) : s.join === "round" ? l ? (m.push(_, j), m.push(C + D * R, w + O * R), g += P(C, w, C + D * R, w + O * R, C + k * R, w + A * R, m, !0) + 4, m.push(_, j), m.push(C + k * R, w + A * R)) : (m.push(C - D * L, w - O * L), m.push(M, N), g += P(C, w, C - D * L, w - O * L, C - k * L, w - A * L, m, !1) + 4, m.push(C - k * L, w - A * L), m.push(M, N)) : (m.push(_, j), m.push(M, N)) : (m.push(C - D * L, w - O * L), m.push(C + D * R, w + O * R), s.join === "round" ? g += l ? P(C, w, C + D * R, w + O * R, C + k * R, w + A * R, m, !0) + 2 : P(C, w, C - D * L, w - O * L, C - k * L, w - A * L, m, !1) + 2 : s.join === "miter" && h / y <= b && (l ? (m.push(M, N), m.push(M, N)) : (m.push(_, j), m.push(_, j)), g += 2), m.push(C - k * L, w - A * L), m.push(C + k * R, w + A * R), g += 2);
	}
	x = e[(h - 2) * 2], S = e[(h - 2) * 2 + 1], C = e[(h - 1) * 2], w = e[(h - 1) * 2 + 1], D = -(S - w), O = x - C, F = Math.sqrt(D * D + O * O), D /= F, O /= F, D *= v, O *= v, m.push(C - D * L, w - O * L), m.push(C + D * R, w + O * R), f || (s.cap === "round" ? g += P(C - D * (L - R) * .5, w - O * (L - R) * .5, C - D * L, w - O * L, C + D * R, w + O * R, m, !1) + 2 : s.cap === "square" && (g += ee(C, w, D, O, L, R, !1, m)));
	let te = M * M;
	for (let e = _; e < g + _ - 2; ++e) x = m[e * 2], S = m[e * 2 + 1], C = m[(e + 1) * 2], w = m[(e + 1) * 2 + 1], T = m[(e + 2) * 2], E = m[(e + 2) * 2 + 1], !(Math.abs(x * (w - E) + C * (E - S) + T * (S - w)) < te) && a.push(e, e + 1, e + 2);
}
//#endregion
...
var I = [{
	...
	constructor(...t) {
		this.uid = a("fillGradient"), this._tick = 0, this.type = "linear", this.colorStops = [];
		let n = re(t);
		n = {
	...
	addColorStop(e, t) {
		return this.colorStops.push({
			offset: e,
			color: i.shared.setValue(t).toHexa()
		}), this;
	}
	buildLinearGradient() {
		if (this.texture) return;
		let { x: e, y: t } = this.start, { x: n, y: r } = this.end, i = n - e, a = r - t, s = i < 0 || a < 0;
		...
		let c = this.colorStops.length ? this.colorStops : I, l = this._textureSize, { canvas: u, context: d } = ne(l, 1), f = s ? d.createLinearGradient(this._textureSize, 0, 0, 0) : d.createLinearGradient(0, 0, this._textureSize, 0);
		te(f, c), d.fillStyle = f, d.fillRect(0, 0, l, 1), this.texture = new h({ source: new y({
			resource: u,
			addressMode: this._wrapMode
		}) });
		let p = Math.sqrt(i * i + a * a), m = Math.atan2(a, i), g = new o();
		g.scale(p / l, 1), g.rotate(m), g.translate(e, t), this.textureSpace === "local" && g.scale(l, l), this.transform = g;
	}
	buildGradient() {
	...
	buildRadialGradient() {
		if (this.texture) return;
		let e = this.colorStops.length ? this.colorStops : I, t = this._textureSize, { canvas: n, context: r } = ne(t, t), { x: i, y: a } = this.center, { x: s, y: c } = this.outerCenter, l = this.innerRadius, u = this.outerRadius, d = s - u, f = c - u, p = t / (u * 2), m = (i - d) * p, g = (a - f) * p, _ = r.createRadialGradient(m, g, l * p, (s - d) * p, (c - f) * p, u * p);
		te(_, e), r.fillStyle = e[e.length - 1].color, r.fillRect(0, 0, t, t), r.fillStyle = _, r.translate(m, g), r.rotate(this.rotation), r.scale(1, this.scale), r.translate(-m, -g), r.fillRect(0, 0, t, t), this.texture = new h({ source: new y({
			resource: n,
			addressMode: this._wrapMode
		}) });
		let v = new o();
		this.textureSpace === "local" ? v.scale(2 * u, 2 * u) : v.scale(1 / p, 1 / p), v.translate(d, f), this.transform = v;
	}
	destroy() {
...
function re(e) {
	let t = e[0] ?? {};
	return (typeof t == "number" || e[1]) && (m("8.5.2", "use options object instead"), t = {
		type: "linear",
		start: {
			x: e[0],
			y: e[1]
		...
		textureSpace: e[4],
		textureSize: e[5] ?? R.defaultLinearOptions.textureSize
	}), t;
}
//#endregion
...
var ae = {
	...
	constructor(e, t) {
		this.uid = a("fillPattern"), this._tick = 0, this.transform = new o();
		let n = ie(e) ? e : {
			texture: e,
			repetition: t
		};
		...
		let r = n.repetition;
		r && (this.texture.source.style.addressModeU = ae[r].addressModeU, this.texture.source.style.addressModeV = ae[r].addressModeV);
	}
	setTransform(e) {
		if (e) {
...
function se(e, t, n, r, i, a, o, s = null) {
	let c = 0;
	n *= t, i *= a;
...
var ue = new o(), de = class {
	...
	get color() {
		let e = this.baseColor, t = e >> 16 | e & 65280 | (e & 255) << 16, r = this.renderable;
		return r ? n(t, r.groupColor) + (this.alpha * r.groupAlpha * 255 << 24) : t + (this.alpha * 255 << 24);
	}
	get transform() {
		return this.renderable?.groupTransform || ue;
	}
	copyTo(e) {
...
var he = /* @__PURE__ */ new Set(), ge = !1;
function _e(e, t, n = 2) {
	let r = t && t.length, i = r ? t[0] * n : e.length;
	he.size && he.clear();
	let a = ve(e, 0, i, n, !0), o = [];
	if (!a || a.next === a.prev) return o;
	let s = 0, c = 0, l = 0;
	if (r && (a = Te(e, t, a, n)), e.length > 80 * n) {
		s = e[0], c = e[1];
		let t = s, r = c;
		for (let a = n; a < i; a += n) {
			let n = e[a], i = e[a + 1];
	...
	return ye(a, o, s, c, l), o;
}
function ve(e, t, n, r, i) {
	let a = null;
	if (i === et(e, t, n, r) > 0) for (let i = t; i < n; i += r) a = Ze(i / r | 0, e[i], e[i + 1], a);
	else for (let i = n - r; i >= t; i -= r) a = Ze(i / r | 0, e[i], e[i + 1], a);
	return a && J(a, a.next) && (Qe(a), a = a.next), a;
}
function B(e, t = e) {
	let n = t === e, r = e, i;
	do
		i = !1, r !== r.next && (he.size === 0 || !he.has(r)) && (J(r, r.next) || q(r.prev, r, r.next) === 0) ? ((n || r === t) && (t = r.prev), ge = !0, Qe(r), r = r.prev, i = !0) : (n || r !== t) && (r = r.next, i = !n);
	while (i || r !== t);
	return t;
}
function ye(e, t, n, r, i) {
	...
	for (; e.prev !== e.next;) {
		...
		if (q(s, e, c) < 0 && (i ? xe(e, n, r, i) : be(e))) {
			t.push(s.i, e.i, c.i), Qe(e), e = c, a = c;
			continue;
		}
		if (e = c, e === a) {
			if (ge = !1, e = B(e), ge) {
...
function be(e) {
	...
	for (; m !== t;) {
		if (m.x >= u && m.x <= f && m.y >= d && m.y <= p && (i !== m.x || s !== m.y) && We(i, s, a, c, o, l, m.x, m.y) && q(m.prev, m, m.next) >= 0) return !1;
		m = m.next;
	}
	return !0;
}
function xe(e, t, n, r) {
	let i = e.prev, a = e, o = e.next, s = i.x, c = a.x, l = o.x, u = i.y, d = a.y, f = o.y, p = Math.min(s, c, l), m = Math.min(u, d, f), h = Math.max(s, c, l), g = Math.max(u, d, f), _ = He(p, m, t, n, r), v = He(h, g, t, n, r), y = e.prevZ;
	for (; y && y.z >= _;) {
		if (y.x >= p && y.x <= h && y.y >= m && y.y <= g && y !== o && (s !== y.x || u !== y.y) && We(s, u, c, d, l, f, y.x, y.y) && q(y.prev, y, y.next) >= 0) return !1;
		y = y.prevZ;
	}
	let b = e.nextZ;
	for (; b && b.z <= v;) {
		if (b.x >= p && b.x <= h && b.y >= m && b.y <= g && b !== o && (s !== b.x || u !== b.y) && We(s, u, c, d, l, f, b.x, b.y) && q(b.prev, b, b.next) >= 0) return !1;
		b = b.nextZ;
	}
	return !0;
}
function Se(e, t) {
	...
	do {
		...
		Ke(i, n, n.next, a, !1) && Y(i, a) && Y(a, i) && (t.push(i.i, n.i, a.i), Qe(n), Qe(n.next), n = e = a, r = !0), n = n.next;
	} while (n !== e);
	return r ? B(n) : n;
}
function Ce(e, t, n, r, i) {
	...
	do {
		...
		for (; e !== a.prev;) {
			if (a.i !== e.i && Ge(a, e)) {
				let o = Xe(a, e);
				a = B(a, a.next), o = B(o, o.next), ye(a, t, n, r, i), ye(o, t, n, r, i);
				return;
			}
			e = e.next;
		}
...
function Te(e, t, n, r) {
	...
	for (let n = 0, a = t.length; n < a; n++) {
		let o = ve(e, t[n] * r, n < a - 1 ? t[n + 1] * r : e.length, r, !1);
		o === o.next && he.add(o), i.push(Ue(o));
	}
	i.sort(Ee), Me(e.length / r, t.length), Ne(n, n), we = !0;
	for (let e = 0; e < i.length; e++) n = De(i[e], n);
	return we = !1, B(n);
}
function Ee(e, t) {
...
function De(e, t) {
	let n = Le(e, t);
	if (!n) return t;
	let r = Xe(n, e), i = r.next;
	return Ne(n, i.next), B(r, r.next), B(n, n.next);
}
var Oe = 16, V = /* @__PURE__ */ new Float64Array(), ke = 0, Ae = [], je = [];
function Me(e, t) {
	let n = Math.ceil((e + 2 * t) / Oe) + t + 2;
	V.length < n * 4 && (V = new Float64Array(n * 4)), ke = 0;
}
function Ne(e, t) {
	let n = e;
	do {
		...
		je[e] = n;
		let c = e * 4;
		V[c] = r, V[c + 1] = i, V[c + 2] = a, V[c + 3] = o;
	} while (n !== t);
}
function Pe(e, t) {
	let n = e.z * 4;
	t.x < V[n] && (V[n] = t.x), t.y < V[n + 1] && (V[n + 1] = t.y), t.x > V[n + 2] && (V[n + 2] = t.x), t.y > V[n + 3] && (V[n + 3] = t.y);
}
function Fe(e) {
	let t = je[e];
...
function Le(e, t) {
	...
	if (J(e, n)) return n;
	for (let t = 0, s = 0; t < ke; t++, s += 4) {
		if (i < V[s + 1] || i > V[s + 3] || V[s] > r || V[s + 2] <= a) continue;
		let c = Fe(t);
		n = Ie(t);
		do {
			if (n.prev.next === n) {
				if (J(e, n.next)) return n.next;
	...
	for (let t = 0, f = 0; t < ke; t++, f += 4) {
		if (V[f + 2] < s || V[f] > r || V[f + 3] < l || V[f + 1] > u) continue;
		let p = Fe(t);
		n = Ie(t);
		do {
			if (n.prev.next === n && r >= n.x && n.x >= s && r !== n.x && We(i < c ? r : a, i, s, c, i < c ? a : r, i, n.x, n.y)) {
				let t = Math.abs(i - n.y) / (r - n.x);
				(Y(n, e) || n.y === i && n.next.y === i && n.next.x > r) && (t < d || t === d && (n.x > o.x || n.x === o.x && Re(o, n))) && (o = n, d = t);
			}
			n = n.next;
		} while (n !== p);
	}
...
var H = [], U = [], W = /* @__PURE__ */ new Uint32Array(), G = /* @__PURE__ */ new Uint32Array(), K = /* @__PURE__ */ new Uint32Array(256);
function ze(e, t, n, r) {
	let i = e, a = 0;
	do
		i.z = He(i.x, i.y, t, n, r), H[a++] = i, i = i.next;
	while (i !== e);
	Be(a);
	let o = null;
	for (let e = 0; e < a; e++) {
...
function Be(e) {
	if (e <= 32) {
		for (let t = 1; t < e; t++) {
			let e = H[t], n = e.z, r = t - 1;
			for (; r >= 0 && H[r].z > n;) H[r + 1] = H[r], r--;
			H[r + 1] = e;
		}
		return;
	}
	W.length < e && (W = new Uint32Array(e), G = new Uint32Array(e), U = Array(e));
	for (let t = 0; t < e; t++) W[t] = H[t].z;
	Ve(e, H, W, U, G, 0), Ve(e, U, G, H, W, 8), Ve(e, H, W, U, G, 16), Ve(e, U, G, H, W, 24);
}
function Ve(e, t, n, r, i, a) {
	K.fill(0);
	for (let t = 0; t < e; t++) K[n[t] >>> a & 255]++;
	let o = 0;
	for (let e = 0; e < 256; e++) {
		let t = K[e];
		K[e] = o, o += t;
...
function Ge(e, t) {
	let n = J(e, t) && q(e.prev, e, e.next) > 0 && q(t.prev, t, t.next) > 0;
	return e.next.i !== t.i && (n || Y(e, t) && Y(t, e) && (q(e.prev, e, t.prev) !== 0 || q(e, t.prev, t) !== 0)) && !Je(e, t) && (n || Ye(e, t));
}
function q(e, t, n) {
...
function Ke(e, t, n, r, i = !0) {
	let a = q(e, t, n), o = q(e, t, r), s = q(n, r, e), c = q(n, r, t);
	return (a > 0 && o < 0 || a < 0 && o > 0) && (s > 0 && c < 0 || s < 0 && c > 0) ? !0 : i ? !!(a === 0 && qe(e, n, t) || o === 0 && qe(e, r, t) || s === 0 && qe(n, e, r) || c === 0 && qe(n, t, r)) : !1;
}
function qe(e, t, n) {
...
function Je(e, t) {
	...
	do {
		...
		if (o.i !== e.i && s.i !== e.i && o.i !== t.i && s.i !== t.i && Ke(o, s, e, t)) return !0;
		o = s;
	} while (o !== e);
	return !1;
}
...
function Xe(e, t) {
	let n = $e(e.i, e.x, e.y), r = $e(t.i, t.x, t.y), i = e.next, a = t.prev;
...
function Qe(e) {
	e.next.prev = e.prev, e.prev.next = e.next, e.prevZ && (e.prevZ.nextZ = e.nextZ), e.nextZ && (e.nextZ.prevZ = e.prevZ), we && Pe(e.prev, e.next);
}
function $e(e, t, n) {
	return {
		i: e,
...
function lt(e, t, n, r) {
	...
	return !(t.fill instanceof R) && a.addressMode === "clamp-to-edge" && (a.addressMode = "repeat", a.update()), r && i.append(st.copyFrom(r).invert()), i;
}
//#endregion
//#region node_modules/pixi.js/lib/scene/graphics/shared/utils/buildContextBatches.mjs
var ut = {};
t.handleByMap(v.ShapeBuilder, ut), t.add(at, it, ot, z, fe, pe);
var dt = new d(), ft = new o();
function pt(e, t) {
	...
	for (let t = 0; t < e.instructions.length; t++) {
		...
		if (i.action === "texture") mt(i.data, r, n);
		else if (i.action === "fill" || i.action === "stroke") {
			let e = i.action === "stroke", t = i.data.path.shapePath, a = i.data.style, o = i.data.hole;
			e && o && ht(o.shapePath, a, !0, r, n), o && (t.shapePrimitives[t.shapePrimitives.length - 1].holes = o.shapePath.shapePrimitives), ht(t, a, e, r, n);
		}
	}
}
function mt(e, t, n) {
	let i = [], a = ut.rectangle, o = dt;
	o.x = e.dx, o.y = e.dy, o.width = e.dw, o.height = e.dh;
	let s = e.transform;
	if (!a.build(o, i)) return;
	let { vertices: c, uvs: l, indices: u } = n, d = u.length, f = c.length / 2;
	s && le(i, s), a.triangulate(i, c, 2, f, u, d);
...
function ht(e, t, n, i, a) {
	let { vertices: o, uvs: s, indices: c } = a;
	e.shapePrimitives.forEach(({ shape: e, transform: l, holes: u }) => {
		let d = [], f = ut[e.type];
		if (!f.build(e, d)) return;
		let p = c.length, m = o.length / 2, g = "triangle-list";
		if (l && le(d, l), n) {
			let n = e.closePath ?? !0, r = t;
			r.pixelLine ? (me(d, n, o, c), g = "line-list") : F(d, r, !1, n, o, c);
		} else if (u) {
			let e = [], t = d.slice();
			gt(u).forEach((n) => {
				e.push(t.length / 2), t.push(...n);
			}), nt(t, e, o, 2, m, c, p);
		} else f.triangulate(d, o, 2, m, c, p);
		let _ = s.length / 2, v = t.texture;
		if (v !== h.WHITE) {
			let n = lt(ft, t, e, l);
			se(o, 2, m, s, _, 2, o.length / 2 - m, n);
		} else ce(s, _, 2, o.length / 2 - m);
		let y = r.get(de);
		y.indexOffset = p, y.indexSize = c.length - p, y.attributeOffset = m, y.attributeSize = o.length / 2 - m, y.baseColor = t.color, y.alpha = t.alpha, y.texture = v, y.geometryData = a, y.topology = g, i.push(y);
	});
}
function gt(e) {
	let t = [];
	for (let n = 0; n < e.length; n++) {
		let r = e[n].shape, i = [];
		ut[r.type].build(r, i) && t.push(i);
	}
	return t;
}
//#endregion
//#region node_modules/parse-svg-path/dist/index.mjs
var _t = {
	a: 7,
	c: 6,
	h: 1,
	...
	v: 1,
	z: 0
}, vt = /([astvzqmhlc])([^astvzqmhlc]*)/gi, yt = /-?[0-9]*\.?[0-9]+(?:e[-+]?\d+)?/gi;
function bt(e) {
	let t = [];
	return e.replace(vt, (e, n, r) => {
		let i = n.toLowerCase(), a = n, o = xt(r);
		for (i === "m" && o.length > 2 && (t.push([a, ...o.splice(0, 2)]), i = "l", a = a === "m" ? "l" : "L");;) {
			if (o.length === _t[i]) return t.push([a, ...o]), "";
			if (o.length < _t[i]) throw Error("malformed path data");
			t.push([a, ...o.splice(0, _t[i])]);
		}
	}), t;
}
function xt(e) {
...
function St(e, t) {
	let n = bt(e), r = [], i = null, a = 0, o = 0;
	for (let e = 0; e < n.length; e++) {
		let c = n[e], l = c[0], u = c;
		switch (l) {
			case "M":
				a = u[1], o = u[2], t.moveTo(a, o);
				break;
			case "m":
				a += u[1], o += u[2], t.moveTo(a, o);
				break;
			...
			case "v":
				...
				break;
			case "L":
				a = u[1], o = u[2], t.lineTo(a, o);
				break;
			case "l":
				a += u[1], o += u[2], t.lineTo(a, o);
				break;
			case "C":
				a = u[5], o = u[6], t.bezierCurveTo(u[1], u[2], u[3], u[4], a, o);
				break;
			case "c":
				t.bezierCurveTo(a + u[1], o + u[2], a + u[3], o + u[4], a + u[5], o + u[6]), a += u[5], o += u[6];
				break;
			case "S":
				a = u[3], o = u[4], t.bezierCurveToShort(u[1], u[2], a, o);
				break;
			case "s":
				t.bezierCurveToShort(a + u[1], o + u[2], a + u[3], o + u[4]), a += u[3], o += u[4];
				break;
			case "Q":
				a = u[3], o = u[4], t.quadraticCurveTo(u[1], u[2], a, o);
				break;
			case "q":
				t.quadraticCurveTo(a + u[1], o + u[2], a + u[3], o + u[4]), a += u[3], o += u[4];
				break;
			case "T":
				a = u[1], o = u[2], t.quadraticCurveToShort(a, o);
				break;
			case "t":
				a += u[1], o += u[2], t.quadraticCurveToShort(a, o);
				break;
			case "A":
				a = u[6], o = u[7], t.arcToSvg(u[1], u[2], u[3], u[4], u[5], a, o);
				break;
			case "a":
				a += u[6], o += u[7], t.arcToSvg(u[1], u[2], u[3], u[4], u[5], a, o);
				break;
			...
			case "z":
				...
				break;
			default: s(`Unknown SVG path command: ${l}`);
		}
		l !== "Z" && l !== "z" && i === null && (i = {
			startX: a,
			startY: o
...
var Ct = class {
	...
	reset() {
		this.batches && this.batches.forEach((e) => {
			r.return(e);
		}), this.graphicsData && r.return(this.graphicsData), this.isBatchable = !1, this.context = null, this.batches.length = 0, this.geometryData.indices.length = 0, this.geometryData.vertices.length = 0, this.geometryData.uvs.length = 0, this.graphicsData = null;
	}
	destroy() {
	...
	constructor() {
		this.instructions = new u();
	}
	init(e) {
		let t = e.maxTextures;
		this.batcher ? this.batcher._updateMaxTextures(t) : this.batcher = new b({ maxTextures: t }), this.instructions.reset();
	}
	get geometry() {
		return m(p, "GraphicsContextRenderData#geometry is deprecated, please use batcher.geometry instead."), this.batcher.geometry;
	}
	destroy() {
	...
	constructor(e) {
		this._renderer = e, this._managedContexts = new x({
			renderer: e,
			type: "resource",
	...
	_initContextRenderData(e) {
		let t = r.get(wt, { maxTextures: this._renderer.limits.maxBatchableTextures }), n = e._gpuData[this._renderer.uid], { batches: i, geometryData: a } = n;
		n.graphicsData = t;
		let o = a.vertices.length, s = a.indices.length;
		for (let e = 0; e < i.length; e++) i[e].applyTransform = !1;
		let c = t.batcher;
		c.ensureAttributeBuffer(o), c.ensureIndexBuffer(s), c.begin();
		...
		for (let e = 0; e < u.length; e++) {
			let t = u[e];
			t.bindGroup = S(t.textures.textures, t.textures.count, this._renderer.limits.maxBatchableTextures);
		}
		return t;
	}
	_initContext(e) {
...
Tt.extension = {
	...
	name: "graphicsContext"
}, Tt.defaultOptions = { bezierSmoothness: .5 };
...
}, Kt = (e, t, n, r, i, a, o, s, c, l, u, d, f) => {
	let p = i ** 2, m = a ** 2, h = u ** 2, g = d ** 2, _ = p * m - p * g - m * h;
	_ < 0 && (_ = 0), _ /= p * g + m * h, _ = Math.sqrt(_) * (o === s ? -1 : 1);
	let v = _ * i / a * d, y = _ * -a / i * u, b = l * v - c * y + (e + n) / 2, x = c * v + l * y + (t + r) / 2, S = (u - v) / i, C = (d - y) / a, w = (-u - v) / i, T = (-d - y) / a, E = Gt(1, 0, S, C), D = Gt(S, C, w, T);
	s === 0 && D > 0 && (D -= Vt), s === 1 && D < 0 && (D += Vt), f.centerX = b, f.centerY = x, f.ang1 = E, f.ang2 = D;
};
function qt(e, t, n, r, i, a, o, s = 0, c = 0, l = 0) {
	if (a === 0 || o === 0) return;
	let u = Math.sin(s * Vt / 360), d = Math.cos(s * Vt / 360), f = d * (t - r) / 2 + u * (n - i) / 2, p = -u * (t - r) / 2 + d * (n - i) / 2;
	if (f === 0 && p === 0) return;
	a = Math.abs(a), o = Math.abs(o);
	let m = f ** 2 / a ** 2 + p ** 2 / o ** 2;
	m > 1 && (a *= Math.sqrt(m), o *= Math.sqrt(m)), Kt(t, n, r, i, a, o, c, l, u, d, f, p, Ht);
	let { ang1: h, ang2: g } = Ht, { centerX: _, centerY: v } = Ht, y = Math.abs(g) / (Vt / 4);
	...
	for (let t = 0; t < b; t++) {
		let t = Wt(h, g), { x: n, y: r } = Ut(t[0], a, o, d, u, _, v, C), { x: i, y: s } = Ut(t[1], a, o, d, u, _, v, C), { x: c, y: l } = Ut(t[2], a, o, d, u, _, v, C);
...
var Xt = new d(), Zt = class {
	constructor(e) {
		this.shapePrimitives = [], this._currentPoly = null, this._bounds = new _(), this._graphicsPath2D = e, this.signed = e.checkForHoles;
	}
	moveTo(e, t) {
	...
	arcToSvg(e, t, n, r, i, a, o) {
		...
		return qt(s, this._currentPoly.lastX, this._currentPoly.lastY, a, o, e, t, n, r, i), this;
	}
	...
	circle(e, t, n, r) {
		return this.drawShape(new w(e, t, n), r), this;
	}
	poly(e, t, n) {
		let r = new O(e);
	...
	roundShape(e, t, n = !1, r) {
		return e.length < 3 ? this : (n ? Yt(this, e, t, r) : Jt(this, e, t), this.closePath());
	}
	...
	ellipse(e, t, n, r, i) {
		return this.drawShape(new T(e, t, n, r), i), this;
	}
	roundRect(e, t, n, r, i, a) {
		return this.drawShape(new A(e, t, n, r, i), a), this;
	}
	drawShape(e, t) {
	...
	startPoly(e, t) {
		...
		return n && this.endPoly(), n = new O(), n.points.push(e, t), this._currentPoly = n, this;
	}
	endPoly(e = !1) {
	...
	_ensurePoly(e = !0) {
		if (!this._currentPoly && (this._currentPoly = new O(), e)) {
	...
	get bounds() {
		...
		for (let n = 0; n < t.length; n++) {
			let r = t[n], i = r.shape.getBounds(Xt);
	...
	constructor(e, t = !1) {
		this.instructions = [], this.uid = a("graphicsPath"), this._dirty = !0, this.checkForHoles = t, typeof e == "string" ? St(e, this) : this.instructions = e?.slice() ?? [];
	}
	get shapePath() {
		return this._shapePath ||= new Zt(this), this._dirty && (this._dirty = !1, this._shapePath.buildPath()), this._shapePath;
	}
	addPath(e, t) {
	...
	bezierCurveToShort(e, t, n, r, i) {
		let a = this.instructions[this.instructions.length - 1], o = this.getLastPoint(c.shared), s = 0, l = 0;
		if (!a || a.action !== "bezierCurveTo") s = o.x, l = o.y;
		else {
			s = a.data[2], l = a.data[3];
			let e = o.x, t = o.y;
			s = e + (e - s), l = t + (t - l);
		}
		return this.instructions.push({
	...
	quadraticCurveToShort(e, t, n) {
		let r = this.instructions[this.instructions.length - 1], i = this.getLastPoint(c.shared), a = 0, o = 0;
	...
	transform(e) {
		...
		let t = e.a, n = e.b, r = e.c, i = e.d, a = e.tx, o = e.ty, c = 0, l = 0, u = 0, d = 0, f = 0, p = 0, m = 0, h = 0;
		for (let g = 0; g < this.instructions.length; g++) {
			let _ = this.instructions[g], v = _.data;
			switch (_.action) {
				case "moveTo":
				case "lineTo":
					c = v[0], l = v[1], v[0] = t * c + r * l + a, v[1] = n * c + i * l + o;
					break;
				case "bezierCurveTo":
					u = v[0], d = v[1], f = v[2], p = v[3], c = v[4], l = v[5], v[0] = t * u + r * d + a, v[1] = n * u + i * d + o, v[2] = t * f + r * p + a, v[3] = n * f + i * p + o, v[4] = t * c + r * l + a, v[5] = n * c + i * l + o;
					break;
				case "quadraticCurveTo":
					u = v[0], d = v[1], c = v[2], l = v[3], v[0] = t * u + r * d + a, v[1] = n * u + i * d + o, v[2] = t * c + r * l + a, v[3] = n * c + i * l + o;
					break;
				case "arcToSvg":
					c = v[5], l = v[6], m = v[0], h = v[1], v[0] = t * m + r * h, v[1] = n * m + i * h, v[5] = t * c + r * l + a, v[6] = n * c + i * l + o;
					break;
				case "circle":
					v[4] = Z(v[3], e);
					break;
				...
				default: s("unknown transform action", _.action);
			}
		}
		...
		for (let e = 0; e < r.children.length; e++) {
			...
			switch (n.nodeName.toLowerCase()) {
				case "lineargradient":
					t.defs[n.id] = $t(n);
					break;
				case "radialgradient": t.defs[n.id] = en(n);
			}
		}
	}
}
function $t(e) {
	let t = new R(Q(e, "x1", 0), Q(e, "y1", 0), Q(e, "x2", 1), Q(e, "y2", 0), (e.getAttribute("gradientUnits") || "objectBoundingBox") === "objectBoundingBox" ? "local" : "global");
	for (let n = 0; n < e.children.length; n++) {
		let r = e.children[n], a = Q(r, "offset", 0), o = i.shared.setValue(r.getAttribute("stop-color")).toNumber();
		t.addColorStop(a, o);
	}
	return t;
}
function en(e) {
	return s("[SVG Parser] Radial gradients are not yet supported"), new R(0, 0, 1, 0);
}
//#endregion
	...
	switch (n) {
		case "stroke":
			if (r !== "none") {
				...
				} else t.strokeStyle.color = i.shared.setValue(r).toNumber();
				t.useStroke = !0;
			}
			break;
		case "stroke-width":
		...
		case "fill":
			if (r !== "none") {
				...
				} else t.fillStyle.color = i.shared.setValue(r).toNumber();
				t.useFill = !0;
			}
			break;
		case "fill-opacity":
...
function un(e, t) {
	...
	Qt(e, n);
	let r = e.children, { fillStyle: i, strokeStyle: a } = rn(e, n);
...
function dn(e, t, n, r) {
	let i = e.children, { fillStyle: a, strokeStyle: o } = rn(e, t);
	a && n ? n = {
		...n,
		...a
	} : a && (n = a), o && r ? r = {
	...
	switch (e.nodeName.toLowerCase()) {
		case "path": {
			S = e.getAttribute("d");
			let i = e.getAttribute("fill-rule"), a = sn(S), o = i === "evenodd", s = a.length > 1;
			if (o && s) {
				let e = a.map((e) => ({
					path: e,
					area: cn(e)
				}));
				if (e.sort((e, t) => t.area - e.area), a.length > 3 || !on(e)) for (let i = 0; i < e.length; i++) {
					let a = e[i], o = i === 0;
					t.context.beginPath();
					let s = new X(void 0, !0);
					ln(a.path, s), t.context.path(s), o ? (n && t.context.fill(n), r && t.context.stroke(r)) : t.context.cut();
				}
				else for (let i = 0; i < e.length; i++) {
					let a = e[i], o = i % 2 == 1;
					t.context.beginPath();
					let s = new X(void 0, !0);
					ln(a.path, s), t.context.path(s), o ? t.context.cut() : (n && t.context.fill(n), r && t.context.stroke(r));
				}
			} else C = new X(S, !i || i === "evenodd"), t.context.path(C), n && t.context.fill(n), r && t.context.stroke(r);
			break;
		}
		case "circle":
			h = Q(e, "cx", 0), g = Q(e, "cy", 0), _ = Q(e, "r", 0), t.context.ellipse(h, g, _, _), n && t.context.fill(n), r && t.context.stroke(r);
			break;
		case "rect":
			l = Q(e, "x", 0), u = Q(e, "y", 0), w = Q(e, "width", 0), T = Q(e, "height", 0), v = Q(e, "rx", 0), y = Q(e, "ry", 0), v || y ? t.context.roundRect(l, u, w, T, v || y) : t.context.rect(l, u, w, T), n && t.context.fill(n), r && t.context.stroke(r);
			break;
		case "ellipse":
			h = Q(e, "cx", 0), g = Q(e, "cy", 0), v = Q(e, "rx", 0), y = Q(e, "ry", 0), t.context.beginPath(), t.context.ellipse(h, g, v, y), n && t.context.fill(n), r && t.context.stroke(r);
			break;
		case "line":
			d = Q(e, "x1", 0), f = Q(e, "y1", 0), p = Q(e, "x2", 0), m = Q(e, "y2", 0), t.context.beginPath(), t.context.moveTo(d, f), t.context.lineTo(p, m), r && t.context.stroke(r);
			break;
		case "polygon":
		...
		case "g":
		case "svg": break;
		default: s(`[SVG parser] <${e.nodeName}> elements unsupported`);
	}
	c && (n = null);
	for (let e = 0; e < i.length; e++) dn(i[e], t, n, r);
}
//#endregion
//#region node_modules/pixi.js/lib/scene/graphics/shared/utils/convertFillInputToFillStyle.mjs
function fn(e) {
	return i.isColorLike(e);
}
function pn(e) {
...
function gn(e, t, n) {
	let r = i.shared.setValue(t ?? 0);
	return e.color = r.toNumber(), e.alpha = r.alpha === 1 ? n.alpha : r.alpha, e.texture = h.WHITE, {
		...n,
		...e
	};
}
...
function bn(e, t) {
	let n = {
		...t,
		...e
	}, r = i.shared.setValue(n.color);
	return n.alpha *= r.alpha, n.color = r.toNumber(), n;
}
function $(e, t) {
	if (e == null) return null;
	let n = {}, r = e;
	return fn(e) ? gn(n, e, t) : hn(e) ? _n(n, e, t) : pn(e) ? vn(n, e, t) : mn(e) ? yn(n, e, t) : r.fill && pn(r.fill) ? vn(r, r.fill, t) : r.fill && mn(r.fill) ? yn(r, r.fill, t) : bn(r, t);
}
function xn(e, t) {
...
var Cn = new c(), wn = new o(), Tn = class t extends l {
	constructor() {
		super(...arguments), this._gpuData = /* @__PURE__ */ Object.create(null), this.autoGarbageCollect = !0, this._gcLastUsed = -1, this.uid = a("graphicsContext"), this.dirty = !0, this.batchMode = "auto", this.instructions = [], this.destroyed = !1, this._activePath = new X(), this._transform = new o(), this._fillStyle = { ...t.defaultFillStyle }, this._strokeStyle = { ...t.defaultStrokeStyle }, this._stateStack = [], this._tick = 0, this._bounds = new _(), this._boundsDirty = !0;
	}
	clone() {
		let e = new t();
	...
	set fillStyle(e) {
		this._fillStyle = $(e, t.defaultFillStyle);
	}
	get strokeStyle() {
		return this._strokeStyle;
	}
	set strokeStyle(e) {
		this._strokeStyle = xn(e, t.defaultStrokeStyle);
	}
	setFillStyle(e) {
		return this._fillStyle = $(e, t.defaultFillStyle), this;
	}
	setStrokeStyle(e) {
		return this._strokeStyle = $(e, t.defaultStrokeStyle), this;
	}
	texture(e, t, n, r, a, o) {
		return this.instructions.push({
			action: "texture",
			data: {
				...
				style: t || t === 0 ? i.shared.setValue(t).toNumber() : 16777215
			}
		}), this.onUpdate(), this;
	}
	beginPath() {
	...
	fill(n, r) {
		...
		return i = this._tick === 0 && a?.action === "stroke" ? a.data.path : this._activePath.clone(), i ? (n != null && (r !== void 0 && typeof n == "number" && (m(e, "GraphicsContext.fill(color, alpha) is deprecated, use GraphicsContext.fill({ color, alpha }) instead"), n = {
			color: n,
			alpha: r
		}), this._fillStyle = $(n, t.defaultFillStyle)), this.instructions.push({
			action: "fill",
			data: {
	...
	_initNextPathLocation() {
		let { x: e, y: t } = this._activePath.getLastPoint(c.shared);
		this._activePath.clear(), this._activePath.moveTo(e, t);
	}
	stroke(e) {
		let n, r = this.instructions[this.instructions.length - 1];
		return n = this._tick === 0 && r?.action === "fill" ? r.data.path : this._activePath.clone(), n ? (e != null && (this._strokeStyle = xn(e, t.defaultStrokeStyle)), this.instructions.push({
			action: "stroke",
			data: {
	...
	svg(e) {
		return this._tick++, un(e, this), this;
	}
	restore() {
	...
	setTransform(e, t, n, r, i, a) {
		return e instanceof o ? (this._transform.set(e.a, e.b, e.c, e.d, e.tx, e.ty), this) : (this._transform.set(e, t, n, r, i, a), this);
	}
	transform(e, t, n, r, i, a) {
		return e instanceof o ? (this._transform.append(e), this) : (wn.set(e, t, n, r, i, a), this._transform.append(wn), this);
	}
	translate(e, t = e) {
	...
	get bounds() {
		...
		for (let t = 0; t < this.instructions.length; t++) {
			...
			if (r === "stroke") {
				...
				t.style.join === "miter" && (i *= Sn(t.path, t.style.miterLimit));
				let a = t.path.bounds;
	...
	containsPoint(e) {
		...
		for (let r = 0; r < t.length; r++) {
			...
			for (let t = 0; t < c.length; t++) {
				let r = c[t].shape;
				if (!s || !r) continue;
				let o = c[t].transform, l = o ? o.applyInverse(e, Cn) : e;
...
var En = Tn;
//#endregion
export { ut as a, oe as c, Et as i, R as l, $ as n, lt as o, xn as r, de as s, En as t, F as u };
