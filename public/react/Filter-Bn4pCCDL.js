import { A as e, B as t, C as n, D as r, E as i, F as a, I as o, L as s, M as c, N as l, O as u, P as d, R as ee, S as te, c as ne, i as re, k as f, m as p, p as ie, u as ae, v as m, w as h, x as g, y as oe, z as _ } from "./Geometry-BFCE0DPo.js";
...
var de = {
...
}, S = i.getPool(l), C = i.getPool(h), pe = new l(), me = {
	...
	_getGlobalBoundsRecursive(e, t, n) {
		...
		if ((this.renderGroup || i) && (r = C.get().clear()), this.boundsArea) t.addRect(this.boundsArea, this.worldTransform);
		else {
		...
		if (i) {
			...
			e && r.applyMatrix(n.worldTransform.copyTo(pe).invert()), t.addBounds(r), C.return(r);
		} else this.renderGroup && (t.addBounds(r, this.relativeGroupTransform), C.return(r));
	}
};
//#endregion
...
function w(e, t, n) {
	n.clear();
	let r, i;
	return e.parent ? t ? r = e.parent.worldTransform : (i = S.get().identity(), r = E(e, i)) : r = l.IDENTITY, T(e, n, r, t), i && S.return(i), n.isValid || n.set(0, 0, 0, 0), n;
}
function T(e, t, n, r) {
	if (!e.visible || !e.measurable) return;
	let i;
	r ? i = e.worldTransform : (e.updateLocalTransform(), i = S.get(), i.appendFrom(e.localTransform, n));
	let a = t, o = !!e.effects.length;
	if (o && (t = C.get().clear()), e.boundsArea) t.addRect(e.boundsArea, i);
	else {
		let n = e.bounds;
		n && !n.isEmpty() && (t.matrix = i, t.addBounds(n));
		for (let n = 0; n < e.children.length; n++) T(e.children[n], t, i, r);
	}
	if (o) {
		for (let n = 0; n < e.effects.length; n++) e.effects[n].addBounds?.(t);
		a.addBounds(t, l.IDENTITY), C.return(t);
	}
	r || S.return(i);
}
function E(e, t) {
	let n = e.parent;
	return n && (E(n, t), n.updateLocalTransform(), t.append(n.localTransform)), t;
}
//#endregion
//#region node_modules/pixi.js/lib/scene/container/utils/multiplyColors.mjs
var D = 16777215;
function O(e, t) {
	return e === D ? t : t === D ? e : n(e, t);
}
//#endregion
...
var he = {
	...
	getGlobalTransform(e = new l(), t) {
		...
		let n = E(this, S.get().identity());
		return e.appendFrom(this.localTransform, n), S.return(n), e;
	},
	getGlobalTint(e) {
		if (e) return this.renderGroup ? k(this.renderGroup.worldColor) : this.parentRenderGroup ? k(O(this.localColor, this.parentRenderGroup.worldColor)) : this.tint;
		let t = this.localColor, n = this.parent;
		for (; n;) t = O(t, n.localColor), n = n.parent;
		return k(t);
	}
};
//#endregion
...
function A(e, t, n) {
	return t.clear(), n ||= l.IDENTITY, j(e, t, n, e, !0), t.isValid || t.set(0, 0, 0, 0), t;
}
function j(e, t, n, r, i) {
	let a;
	if (i) a = S.get(), a = n.copyTo(a);
	else {
		if (!e.visible || !e.measurable) return;
		e.updateLocalTransform();
		let t = e.localTransform;
		a = S.get(), a.appendFrom(t, n);
	}
	let o = t, s = !!e.effects.length;
	if (s && (t = C.get().clear()), e.boundsArea) t.addRect(e.boundsArea, a);
	else {
		e.renderPipeId && (t.matrix = a, t.addBounds(e.bounds));
		let n = e.children;
		for (let e = 0; e < n.length; e++) j(n[e], t, a, r, !1);
	}
	if (s) {
		for (let n = 0; n < e.effects.length; n++) e.effects[n].addLocalBounds?.(t, r);
		o.addBounds(t, l.IDENTITY), C.return(t);
	}
	S.return(a);
}
//#endregion
...
function M(e, t) {
	...
	for (let e = 0; e < n.length; e++) {
		...
		(t.data[o] !== i || t.data[o + 1] !== a) && (t.data[t.index] = i, t.data[t.index + 1] = a, t.didChange = !0), t.index = o + 2, r.children.length && M(r, t);
	}
	return t.didChange;
}
//#endregion
...
var ge = new l(), _e = {
	...
	getLocalBounds() {
		...
		return e.index = 1, e.didChange = !1, e.data[0] !== this._didViewChangeTick && (e.didChange = !0, e.data[0] = this._didViewChangeTick), M(this, e), e.didChange && A(this, e.localBounds, ge), e.localBounds;
	},
	getBounds(e, t) {
		return w(this, e, t || new h());
	}
}, ve = {
	_onRender: null,
	set onRender(e) {
	...
	sortChildren() {
		this.sortDirty && (this.sortDirty = !1, this.children.sort(be));
	}
};
function be(e, t) {
...
var xe = {
	...
	toGlobal(e, t, n = !1) {
		let r = this.getGlobalTransform(S.get(), n);
		return t = r.apply(e, t), S.return(r), t;
	},
	toLocal(e, t, n, r) {
		t && (e = t.toGlobal(e, n, r));
		let i = this.getGlobalTransform(S.get(), r);
		return n = i.applyInverse(e, n), S.return(i), n;
	}
}, Se = 0, N = new class {
	constructor(e) {
...
var P = class {
	...
	disableCacheAsTexture() {
		this.isCachedAsTexture = !1, this.texture &&= (N.returnTexture(this.texture, !0), null);
	}
	updateCacheTexture() {
...
var F = new v(null), I = new v(null), L = new v(null, 1, 1), R = new v(null), z = class n extends ee {
	constructor(e = {}) {
		super(), this.uid = c("renderable"), this._updateFlags = 15, this.renderGroup = null, this.parentRenderGroup = null, this.parentRenderGroupIndex = 0, this.didChange = !1, this.didViewUpdate = !1, this.relativeRenderGroupDepth = 0, this.children = [], this.parent = null, this.includeInBuild = !0, this.measurable = !0, this.isSimple = !0, this.parentRenderLayer = null, this.updateTick = -1, this.localTransform = new l(), this.relativeGroupTransform = new l(), this.groupTransform = this.relativeGroupTransform, this.destroyed = !1, this._position = new v(this, 0, 0), this._scale = L, this._pivot = I, this._origin = R, this._skew = F, this._cx = 1, this._sx = 0, this._cy = 0, this._sy = 1, this._rotation = 0, this.localColor = 16777215, this.localAlpha = 1, this.groupAlpha = 1, this.groupColor = 16777215, this.groupColorAlpha = 4294967295, this.localBlendMode = "inherit", this.groupBlendMode = "normal", this.localDisplayStatus = 7, this.globalDisplayStatus = 7, this._didContainerChangeTick = 0, this._didViewChangeTick = 0, this._didLocalTransformChangeId = -1, this.effects = [], Ce(this, e, {
			children: !0,
			parent: !0,
			effects: !0
	...
	enableRenderGroup() {
		...
		e?.removeChild(this), this.renderGroup = i.get(P, this), this.groupTransform = l.IDENTITY, e?.addChild(this), this._updateIsSimple();
	}
	disableRenderGroup() {
		if (!this.renderGroup) return;
		let e = this.parentRenderGroup;
	...
	get pivot() {
		return this._pivot === I && (this._pivot = new v(this, 0, 0)), this._pivot;
	}
	set pivot(e) {
		this._pivot === I && (this._pivot = new v(this, 0, 0), this._origin !== R && u("Setting both a pivot and origin on a Container is not recommended. This can lead to unexpected behavior if not handled carefully.")), typeof e == "number" ? this._pivot.set(e) : this._pivot.copyFrom(e);
	}
	get skew() {
		return this._skew === F && (this._skew = new v(this, 0, 0)), this._skew;
	}
	set skew(e) {
		this._skew === F && (this._skew = new v(this, 0, 0)), this._skew.copyFrom(e);
	}
	get scale() {
		return this._scale === L && (this._scale = new v(this, 1, 1)), this._scale;
	}
	set scale(e) {
		this._scale === L && (this._scale = new v(this, 0, 0)), typeof e == "string" && (e = parseFloat(e)), typeof e == "number" ? this._scale.set(e) : this._scale.copyFrom(e);
	}
	get origin() {
		return this._origin === R && (this._origin = new v(this, 0, 0)), this._origin;
	}
	set origin(e) {
		this._origin === R && (this._origin = new v(this, 0, 0), this._pivot !== I && u("Setting both a pivot and origin on a Container is not recommended. This can lead to unexpected behavior if not handled carefully.")), typeof e == "number" ? this._origin.set(e) : this._origin.copyFrom(e);
	}
	get width() {
...
t.mixin(z, le, me, xe, ve, _e, de, fe, ye, se, ce, he, ue);
//#endregion
//#region node_modules/pixi.js/lib/ticker/const.mjs
var B = /* @__PURE__ */ ((e) => (e[e.INTERACTION = 50] = "INTERACTION", e[e.HIGH = 25] = "HIGH", e[e.NORMAL = 0] = "NORMAL", e[e.LOW = -25] = "LOW", e[e.UTILITY = -50] = "UTILITY", e))(B || {}), V = class {
	...
	constructor() {
		this.autoStart = !1, this.deltaTime = 1, this.lastTime = -1, this.speed = 1, this.started = !1, this._requestId = null, this._maxElapsedMS = 100, this._minElapsedMS = 0, this._protected = !1, this._lastFrame = -1, this._head = new V(null, null, Infinity), this.deltaMS = 1 / e.targetFPMS, this.elapsedMS = 1 / e.targetFPMS, this._tick = (e) => {
	...
	add(e, t, n = B.NORMAL) {
		return this._addListener(new V(e, t, n));
	}
	addOnce(e, t, n = B.NORMAL) {
		return this._addListener(new V(e, t, n, !0));
	}
	_addListener(e) {
...
var Ee = class e extends U {
	...
	get visualBounds() {
		return Te(this._visualBounds, this._anchor, this._texture), this._visualBounds;
	}
	get sourceBounds() {
...
var De = {
	...
	min: 9,
	max: 10
}, G = 0, K = 1, q = 2, J = 3, Y = 4, X = 5, Z = class e {
	constructor() {
	...
	set blend(e) {
		!!(this.data & 1 << G) !== e && (this.data ^= 1 << G);
	}
	get offsets() {
		return !!(this.data & 1 << K);
	}
	set offsets(e) {
		!!(this.data & 1 << K) !== e && (this.data ^= 1 << K);
	}
	set cullMode(e) {
		if (e === "none") {
			this.culling = !1;
	...
	get culling() {
		return !!(this.data & 1 << q);
	}
	set culling(e) {
		!!(this.data & 1 << q) !== e && (this.data ^= 1 << q);
	}
	get depthTest() {
		return !!(this.data & 1 << J);
	}
	set depthTest(e) {
		!!(this.data & 1 << J) !== e && (this.data ^= 1 << J);
	}
	get depthMask() {
		return !!(this.data & 1 << X);
	}
	set depthMask(e) {
		!!(this.data & 1 << X) !== e && (this.data ^= 1 << X);
	}
	get clockwiseFrontFace() {
		return !!(this.data & 1 << Y);
	}
	set clockwiseFrontFace(e) {
		!!(this.data & 1 << Y) !== e && (this.data ^= 1 << Y);
	}
	get blendMode() {
		return this._blendMode;
	}
	set blendMode(e) {
		this.blend = e !== "none", this._blendMode = e, this._blendModeId = De[e] || 0;
	}
	get polygonOffset() {
...
var Oe = $;
//#endregion
export { b as _, U as a, z as c, A as d, k as f, S as g, C as h, Ee as i, P as l, w as m, Q as n, we as o, O as p, W as r, B as s, Oe as t, N as u, y as v };
