...
var e = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), t = /* @__PURE__ */ e(((e) => {
	...
	function fo(e) {
		co(so.current);
		var t = co(ao.current), n = xe(t, e.type);
		t !== n && (X(oo, e), X(ao, n));
	}
	function po(e) {
	...
	var Ul = function(e, t, n) {
		...
		switch (t.lanes = 0, t.tag) {
			...
			case 10:
				a: {
					if (r = t.type._context, i = t.pendingProps, o = t.memoizedProps, s = i.value, X(Ia, r._currentValue), r._currentValue = s, o !== null) if (Sr(o.value, s)) {
...
function qi({ chart: e, series: t, activeIndex: n, onIndex: r, width: i }) {
	let a = Array.isArray(e.years) ? e.years : [], o = t.filter((e) => e.kind !== "percent"), s = t.filter((e) => e.kind === "percent"), { min: c, max: l } = Y(o.flatMap((e) => e.values)), u = Y(s.flatMap((e) => e.values)), { height: d, top: p, plot: m, left: h, right: g } = Bi, _ = (i - h - g) / Math.max(1, a.length), v = Math.max(6, Math.min(_ / (o.length + 1.6), (_ - 18) / Math.max(1, o.length))), y = X(0, c, l, p, m), b = (e) => h + e * _ + _ / 2, x = Gi(a, _);
		...
		children: [
			...
			s.map((e, t) => {
				...
				return n ? /* @__PURE__ */ (0, f.jsx)("polyline", {
					...
					fill: "none",
					strokeWidth: "2",
					stroke: Ni[(o.length + t) % Ni.length]
				}, e.key) : null;
			}),
...
function Ji({ chart: e, series: t, activeIndex: n, onIndex: r, width: i }) {
	let a = Array.isArray(e.years) ? e.years : [], { min: o, max: s } = Y(t.flatMap((e) => e.values)), { height: c, top: l, plot: u, left: d, right: p } = Bi, m = (i - d - p) / Math.max(1, a.length - 1), h = (e) => d + e * m, g = Gi(a, m);
	return /* @__PURE__ */ (0, f.jsxs)("svg", {
		className: "analysis-chart-svg",
		width: i,
		height: c,
				...
				children: [
					...
					p !== null && o && s.length > 0 && /* @__PURE__ */ (0, f.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, f.jsx)("b", { children: c[v] || "" }), s.map((e, t) => /* @__PURE__ */ (0, f.jsxs)("p", { children: [
							/* @__PURE__ */ (0, f.jsx)("span", {
								className: "analysis-chart-swatch",
								style: { background: Ni[t % Ni.length] }
							}),
							/* @__PURE__ */ (0, f.jsx)("span", { children: e.label }),
							/* @__PURE__ */ (0, f.jsx)("em", { children: Ri(e.values[v] ?? null, e.kind, o.chart.currency) })
						] }, e.key))]
					})
				]
			}),
...
function aa({ markdown: e, charts: t }) {
	...
	return n.length ? /* @__PURE__ */ (0, f.jsxs)(f.Fragment, { children: [n.map((e, n) => {
		...
		return i.forEach((e) => r.add(e)), /* @__PURE__ */ (0, f.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, f.jsx)(Tn, { markdown: e.markdown }), i.length > 0 && /* @__PURE__ */ (0, f.jsx)($i, {
				payload: t,
				chartIds: i,
				heading: "관련 시각화",
...
async function ua(e) {
	let t = e;
	for (; te(t.status);) await ca(1e3), t = await U(`/api/jobs/${encodeURIComponent(t.id)}`);
...
function Aa() {
	let e = fn("companyAnalysis"), [t, n] = (0, d.useState)([]), [r, i] = (0, d.useState)(null), [a, o] = (0, d.useState)(() => Oa()), [s, c] = (0, d.useState)(""), { resolution: l, pending: u, picked: p, setPicked: m, effective: h } = Mi(s), g = p || (l?.status === "confident" ? l.match : null), _ = !!(g && !g.cik && (g.market === "EUROPE" || g.market === "JP")), v = _ ? "out-of-scope" : p ? "picked" : u ? "pending" : l?.status || "idle", y = (() => {
	...
	}, [te, w]), re = Ea(r || {}), ie = da(re, r?.headline || ma(r || {})), ae = r?.sources || [], oe = xa(r);
	return r ? /* @__PURE__ */ (0, f.jsxs)("div", {
		...
		children: [M && /* @__PURE__ */ (0, f.jsx)("p", {
			...
			noteIdentity: {
				id: Wn("company", fa(r) || r.headline || "company"),
				...
				children: [
					/* @__PURE__ */ (0, f.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, f.jsx)("h3", {
							...
							Wo(t.researchQuestions),
							/* @__PURE__ */ (0, f.jsx)("h4", { children: "반증 조건" }),
							Wo(t.falsificationTriggers)
						] }) : /* @__PURE__ */ (0, f.jsx)(yo, {})]
					}),
					/* @__PURE__ */ (0, f.jsxs)("section", {
						className: "topicrpt-provenance-panel",
					...
					/* @__PURE__ */ (0, f.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, f.jsx)("h3", {
							...
							Wo(e.quality.warnings, "경고 없음"),
							/* @__PURE__ */ (0, f.jsx)("h4", { children: "보완 제안" }),
							Wo(e.quality.suggestedFixes, "제안 없음")
						] }) : /* @__PURE__ */ (0, f.jsx)(yo, {})]
					}),
					/* @__PURE__ */ (0, f.jsxs)("section", {
						className: "topicrpt-provenance-panel topicrpt-provenance-wide",
...
async function jo(e, t) {
	...
	for (; te(n.status);) {
		...
		await To(1e3, t), n = await U(`/api/jobs/${encodeURIComponent(n.id)}`, { signal: t });
	}
...
function Go({ envelope: e, executionMode: t, cliAdapter: n, onExecutionMode: r, onCliAdapter: i, onContinue: a, onEdit: o, degradedConfirming: s, onConfirmDegraded: c, onCancelDegraded: l }) {
					...
					/* @__PURE__ */ (0, f.jsxs)("div", {
						...
						children: [
							...
							p.analysisAxes.length ? /* @__PURE__ */ (0, f.jsx)("ul", {
								...
								children: p.analysisAxes.map((e) => /* @__PURE__ */ (0, f.jsxs)("li", { children: [/* @__PURE__ */ (0, f.jsx)("strong", { children: e.label }), Wo(e.questions)] }, e.key))
							}) : /* @__PURE__ */ (0, f.jsx)("span", {
								className: "topicrpt-empty-value",
								children: "분석 축 없음"
							})
...
function Ko() {
	...
	}, []), we = (0, d.useCallback)((e) => e === ge.current, []), Te = (0, d.useCallback)(async (e) => {
		R(!0);
		try {
			...
			if (e instanceof DOMException && e.name === "AbortError") return;
			B(Ho("readiness", e)), ee("readiness"), ne(Vo(e));
			let t = Vo(e);
	...
	let Ee = (0, d.useCallback)(() => {
		be.current = !0, i(null), p(!1), B(""), ee(null), ne(""), zo();
	}, []);
	(0, d.useEffect)(() => {
		o || u || !be.current || (be.current = !1, window.requestAnimationFrame(() => {
		...
		async function n(n) {
			...
			try {
				...
				i(null), B(Ho("report", n)), ee("report"), ne(Vo(n)), O("recoverable-error");
			} finally {
				!e.signal.aborted && ge.current === t && R(!1);
			}
		}
	...
	let De = async (e) => {
		...
		if (!t || t.length > 500) {
			B(Ho("validation", /* @__PURE__ */ Error("question_invalid"))), ee("validation"), ne("question_invalid"), O("recoverable-error");
			return;
		}
		let n = Ce();
		...
		try {
			...
			B(Ho("plan", e)), ee("plan"), ne(Vo(e)), ie(Vo(e) === "no_index" || Vo(e) === "index_unavailable" ? "no-index" : Vo(e) === "rss_unavailable" ? "rss" : null), O("recoverable-error"), oe("");
		}
	}, Oe = async (e) => {
		let t = Ce();
		...
		try {
			let e = await W("/api/topic-reports", a, { signal: t.signal }), r = ko(e) ? e.job : Oo(e) ? e : null;
			...
			if (!we(t.id)) return;
			n((e) => [c, ...e.filter((e) => e.id !== c.id)]), i(c), O("report"), oe("딥 리서치를 생성하고 자동 저장했습니다."), zo(c.id), G("deep-research", {
				surface: "topic_report_reader",
				viewId: "topicrpt",
				reportKind: "topic_report",
				reportId: c.id || "",
			...
			B(Ho("generation", e)), ee(e instanceof H && (e.code === "evidence_confirmation_required" || e.code === "resolution_changed") ? "degraded" : "generation"), ne(Vo(e)), O("recoverable-error"), oe("");
		}
	}, ke = () => {
		if (k) {
		...
		try {
			...
			if (e instanceof DOMException && e.name === "AbortError" || !we(t.id)) return;
			B(Ho("degraded", e)), ee("degraded"), ne(Vo(e)), O("recoverable-error"), oe("");
		}
	};
	async function je(e) {
		if (!(!e.id || !window.confirm(`${No(e)} 보고서를 삭제할까요?`))) {
			...
			try {
				...
				if (!t.ok) throw Error(`삭제 실패: ${t.status}`);
				r?.id === e.id && zo(), n((t) => t.filter((t) => t.id !== e.id)), oe("저장된 딥 리서치를 삭제했습니다.");
			} catch (e) {
				B(e instanceof Error ? e.message : "보고서 삭제에 실패했습니다."), ee("report"), ne(Vo(e));
			} finally {
				ce("");
			}
		}
	...
	let Pe = (0, d.useMemo)(() => {
		let e = Lo(fe);
		return e ? t.filter((t) => Lo([
			No(t),
			Po(t),
			t.topicKey,
			t.engine,
			t.engineDetail,
			Fo(t.generatedAt || t.date)
		].filter(Boolean).join(" ")).includes(e)) : t;
	}, [fe, t]), Fe = (0, d.useMemo)(() => {
		let e = (e) => String(e.generatedAt || e.date || ""), t = [...Pe].sort((t, n) => e(n).localeCompare(e(t)));
		if (me === "recent") return t.length ? [{
			key: `최근 리서치 ${Math.min(t.length, Ro)}건`,
			rows: t.slice(0, Ro)
		}] : [];
		let n = /* @__PURE__ */ new Map();
		for (let e of t) {
			let t = me === "month" ? Io(e.generatedAt || e.date) : Po(e);
	...
	}, [Pe, me]), Ie = Mo(r?.markdown || "", r ? No(r) : "딥 리서치"), Le = oo(r?.marketStateResolution), Re = (0, d.useCallback)((e) => {
		...
		children: [
			...
			/* @__PURE__ */ (0, f.jsxs)(Kn, {
					...
					/* @__PURE__ */ (0, f.jsx)(_n, {
						...
						children: /* @__PURE__ */ (0, f.jsx)(vn, {
							...
							onClick: () => it({
								...
								reportId: r.id || "",
								topic: No(r),
								message: `${Ie.title}의 핵심 결론, 반대 근거, 더 발전시킬 분석 방향을 정리해줘.`,
								autoSubmit: !0
							}),
							children: "Agent에게 묻기"
						})
				...
				children: [
					...
					/* @__PURE__ */ (0, f.jsx)(Tn, { markdown: Ie.body || r.markdown || "" }),
					/* @__PURE__ */ (0, f.jsx)(bo, { report: r })
				]
			})
		]
	});
	let ze = D === "plan-loading" || D === "generation" || L || T, Be = D === "recoverable-error" && z;
	return /* @__PURE__ */ (0, f.jsxs)("div", {
		className: "react-deep-research-route",
		"data-deep-research-route": !0,
		children: [
			...
			D === "plan-review" && k && /* @__PURE__ */ (0, f.jsx)(Go, {
				envelope: k,
				executionMode: j,
				cliAdapter: N,
				onExecutionMode: M,
			...
			/* @__PURE__ */ (0, f.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, f.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, f.jsxs)("div", { children: [/* @__PURE__ */ (0, f.jsx)("p", {
						...
						"aria-live": "polite",
						children: `${Pe.length}건${fe ? " · 검색 결과" : ""}`
					})]
				}), Fe.length ? Fe.map((e) => /* @__PURE__ */ (0, f.jsxs)("section", {
					className: "report-feed-group",
					children: [/* @__PURE__ */ (0, f.jsxs)("div", {
						className: "report-feed-group-head",
						children: [/* @__PURE__ */ (0, f.jsx)("span", {
					...
					children: fe ? "검색 결과가 없습니다." : "저장된 딥 리서치가 없습니다. 질문을 입력해 실행 계획을 미리보세요."
				})]
			})
		]
	});
...
function Zo(e) {
	let t = String(e || "").replace(/\s+/g, " ").trim(), n = Xo(t);
	return {
		lead: n[0] || t,
...
function rs({ driver: e }) {
	let t = qo[e.confidence] || e.confidence || "보통", n = e.interpretation, r = e.marketImpact || e.interpretation, i = e.evidenceSummary || e.whyItMatters || e.rationale, a = e.nextMemoryCheck || e.whatToWatch || e.nextCheckpoint, o = [
		i ? {
			label: "근거 요약",
			value: i
		} : null,
			...
			/* @__PURE__ */ (0, f.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, f.jsx)("h3", { children: e.title }), /* @__PURE__ */ (0, f.jsx)("div", {
					...
					children: e.directionLabel && /* @__PURE__ */ (0, f.jsx)("span", {
						className: `market-direction-chip direction-${$o(e)}`,
						children: es(e)
					})
				})]
			}),
...
function cs({ stateRef: e }) {
	let t = e?.freshnessReason === "age_exceeded" ? "만료" : e ? is[e.status] : "확인 불가";
	return /* @__PURE__ */ (0, f.jsxs)("dl", {
		...
		children: [
			...
			/* @__PURE__ */ (0, f.jsxs)("div", { children: [/* @__PURE__ */ (0, f.jsx)("dt", { children: "경과" }), /* @__PURE__ */ (0, f.jsx)("dd", { children: ss(e) })] }),
			/* @__PURE__ */ (0, f.jsxs)("div", {
				"data-qa": "market-state-source",
				children: [/* @__PURE__ */ (0, f.jsx)("dt", { children: "출처" }), /* @__PURE__ */ (0, f.jsx)("dd", { children: e ? as[e.sourceKind] : "응답 검증 실패" })]
			}),
			e ? /* @__PURE__ */ (0, f.jsxs)("div", { children: [/* @__PURE__ */ (0, f.jsx)("dt", { children: "범위" }), /* @__PURE__ */ (0, f.jsx)("dd", { children: e.scope })] }) : null
		]
	});
}
function ls({ stateRef: e }) {
	let t = e.freshnessReason === "age_exceeded", n = e.freshnessReason === "new_relevant_evidence" ? "새 외부 자료가 들어왔습니다." : os[e.freshnessReason] || "최신성을 다시 확인해야 합니다.", r = e.freshnessReason === "new_relevant_evidence" ? Qo(e.relevantEvidenceWatermark || void 0) : "";
	return /* @__PURE__ */ (0, f.jsxs)("div", {
...
function us({ state: e, stateRef: t, error: n, drivers: r }) {
	let i = e === "fallback" ? "참고용 내러티브만 있습니다" : "아직 생성된 시장 상태가 없습니다", a = n ? `시장 상태 응답을 사용할 수 없습니다: ${n}` : os[t?.freshnessReason || ""] || "현재 상태를 검증할 수 없습니다. 업데이트 후 다시 확인하세요.";
	return /* @__PURE__ */ (0, f.jsxs)("section", {
...
function ds({ payload: e, selectedMarket: t = "overall", loading: n = !1, updating: r = !1, updateDisabled: i = !1, error: a = "", onSelectMarket: o, onUpdate: s, onReload: c }) {
	let l = ao(e), u = l?.status || "empty", d = e?.marketViews || {}, p = Jo.filter((e) => e === "overall" || !!d[e]), m = p.includes(t) ? t : "overall", h = m === "overall" ? d.overall || e : d[m] || e, g = h?.drivers ?? [], _ = h?.plainConclusion || h?.summary || "", v = h?.reasonSummary || h?.sourceSummary || h?.stance || "", y = Zo(v), b = u === "current" || u === "stale", x = h?.briefs?.length ? h.briefs : [
		{
			label: "현재 판단",
			value: _
		},
	...
	return /* @__PURE__ */ (0, f.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, f.jsx)(cs, { stateRef: l }),
			u === "stale" && l ? /* @__PURE__ */ (0, f.jsx)(ls, { stateRef: l }) : null,
			...
			b ? /* @__PURE__ */ (0, f.jsxs)(f.Fragment, { children: [
				u === "current" ? /* @__PURE__ */ (0, f.jsx)("p", {
					...
					children: os[l?.freshnessReason || "within_window"]
				}) : null,
				/* @__PURE__ */ (0, f.jsxs)("div", {
				...
				/* @__PURE__ */ (0, f.jsx)("div", {
					...
					children: g.map((e, t) => /* @__PURE__ */ (0, f.jsx)(rs, { driver: e }, e.id || t))
				}),
				h && ((h.counterEvidence?.length || 0) > 0 || (h.uncertainties?.length || 0) > 0) ? /* @__PURE__ */ (0, f.jsxs)("div", {
					...
					children: [h.counterEvidence?.length ? /* @__PURE__ */ (0, f.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, f.jsx)("h3", { children: "반대 근거" }), /* @__PURE__ */ (0, f.jsx)(ns, { items: h.counterEvidence })]
					}) : null, h.uncertainties?.length ? /* @__PURE__ */ (0, f.jsxs)("section", {
						"data-qa": "market-state-uncertainties",
						children: [/* @__PURE__ */ (0, f.jsx)("h3", { children: "불확실성" }), /* @__PURE__ */ (0, f.jsx)(ns, { items: h.uncertainties })]
					}) : null]
				}) : null,
...
function fs({ onUpdate: e, updating: t = !1, updateDisabled: n = !1, onContext: r } = {}) {
...
var ps = "folio.marketMemory.activeJob.v1", ms = /^job_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/, hs = /* @__PURE__ */ new Set([
	"queued",
	"running",
	"cancel_requested",
	"committing",
	...
	"failed_restart",
	"failed_commit_recovery"
]), gs = "market_memory_update", _s = "LLM CLI 시장 메모리 업데이트";
function vs() {
	try {
...
function bs(e, t) {
	...
	let n = e;
	return n.id === t && hs.has(n.status);
}
function xs(e) {
	if (!e || typeof e != "object" || Array.isArray(e)) return !1;
	let t = e;
	return !ys(t.id) || !hs.has(t.status) || !te(t.status) ? !1 : t.taskType === gs || t.taskType === void 0 && t.label === _s;
}
function Ss(e = vs()) {
	try {
		e?.removeItem(ps);
...
function Cs(e = vs()) {
	...
	return t ? ys(t) ? t : (Ss(e), null) : null;
}
function ws(e, t = vs()) {
	if (!ys(e) || !t) return !1;
	try {
		return t.setItem(ps, e), t.getItem(ps) === e;
	} catch {
		return !1;
	}
}
async function Ts(e, t = vs()) {
	let n = Cs(t);
...
async function As() {
	return W("/api/memory/update", { date: Ds() });
}
function js() {
	...
	function h(e) {
		...
		Ss(), o(`시장 메모리를 업데이트했습니다. ${Os(e)}`), u(null), t((e) => e + 1);
	}
	(0, d.useEffect)(() => {
		let e = !0;
		return (async () => {
			let t = await Ts((e) => U(`/api/jobs/${encodeURIComponent(e)}`));
			if (t.kind === "none" && (t = await Es(() => U("/api/jobs"))), e) if (t.kind === "active") {
				u(t.job), i(!0), o("이전에 시작한 서버 작업에 자동으로 다시 연결했습니다.");
				try {
					await g(t.job);
				} catch (t) {
					if (!e) return;
					t instanceof ct ? (Ss(), u(null), c(t.message), o("")) : t instanceof DOMException && t.name === "AbortError" || (c(t instanceof Error ? t.message : "작업 상태 확인에 실패했습니다."), o(""));
				} finally {
					e && i(!1);
				}
	...
	async function _() {
		...
		try {
			...
			let e = await As();
			ks(e) ? (ws(e.id), u(e), await g(e)) : h(e);
		} catch (e) {
			e instanceof ct ? (Ss(), u(null), c(e.message), o("")) : e instanceof DOMException && e.name === "AbortError" || (c(e instanceof Error ? e.message : "시장 메모리 업데이트에 실패했습니다."), o(""));
		} finally {
			i(!1);
		}
	}
	async function v() {
		if (l) {
			...
			try {
				...
				e instanceof ct ? (Ss(), u(null), c(e.message), o("")) : e instanceof DOMException && e.name === "AbortError" || (c(e instanceof Error ? e.message : "작업 상태 확인에 실패했습니다."), o(""));
			} finally {
				i(!1);
			}
		}
...
function Rs({ current: e, onApply: t, onClose: n }) {
	let [r, i] = (0, d.useState)([]), [a, o] = (0, d.useState)(0), [s, c] = (0, d.useState)(""), [l, u] = (0, d.useState)([]), [p, m] = (0, d.useState)(null), h = r[a] || null, g = l[a] || Is, _ = (e) => u((t) => t.map((t, n) => n === a ? e : t)), v = p != null && p.ready === !1, [y, b] = (0, d.useState)("local"), [x, S] = (0, d.useState)(!1), [C, w] = (0, d.useState)(null), [T, E] = (0, d.useState)([]), [D, O] = (0, d.useState)(!1), [k, A] = (0, d.useState)(""), j = (0, d.useRef)(null), M = (0, d.useRef)(null);
	(0, d.useEffect)(() => {
		let e = !0;
		...
		if (r.length) {
			...
			try {
				...
				for (let [i, a] of r.entries()) {
					let r = await N(a, l[i] || Is), o = await fetch(`/api/portfolio/import-image/preview?mode=${y}&consent=${x ? "true" : "false"}`, {
						method: "POST",
						headers: { "Content-Type": "image/png" },
						body: r
					}), s = await o.json();
					if (!o.ok) throw Error(`${a.name}: ${Ps(String(s.detail || ""))}`);
					n = s.engine || n;
			...
			children: [
				...
				v && /* @__PURE__ */ (0, f.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, f.jsx)("strong", { children: "로컬 인식을 쓸 수 없습니다" }), /* @__PURE__ */ (0, f.jsxs)("span", { children: [
						Fs[String(p?.reason || "")] || "로컬 OCR 준비 상태를 확인하지 못했습니다.",
						" ",
					...
					children: [
						/* @__PURE__ */ (0, f.jsx)("input", {
							...
							onChange: (e) => {
								...
								t.length && (i(t), u(t.map(() => ({ ...Is }))), o(0), w(null), E([]), e.currentTarget.value = "");
							}
						}),
						/* @__PURE__ */ (0, f.jsx)("button", {
							type: "button",
			...
			/* @__PURE__ */ (0, f.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, f.jsxs)("section", {
					...
					children: [
						...
						/* @__PURE__ */ (0, f.jsx)(Bs, { tickers: n.map((e) => e.ticker).filter(Boolean) }),
...
function Us(e) {
	...
	let t = Hs[e.kind] || e.kind, n = e.tickers && e.tickers[0] || e.id || "";
	return n ? `${n}` : t;
}
function Ws(e) {
	if (!e) return "";
...
function Gs({ activeId: e, refreshKey: t, onSelect: n, onDeleted: r }) {
...
function Js(e) {
	let [t, n] = (0, d.useState)(""), [r, i] = (0, d.useState)(null), [a, o] = (0, d.useState)(0), [s, c] = (0, d.useState)(null), l = (0, d.useRef)(!1), u = (0, d.useCallback)(() => o((e) => e + 1), []), f = (0, d.useCallback)(async (e = {}) => {
		...
		let a = r.messages || [];
		return a.length ? a.map(qs) : [{
			...e,
			createdAt: (/* @__PURE__ */ new Date()).toISOString()
		}];
	}, [e]), m = (0, d.useCallback)(async () => {
		if (l.current || (l.current = !0, window.localStorage.getItem(Ks))) return;
		...
		try {
			...
			window.localStorage.setItem(Ks, (/* @__PURE__ */ new Date()).toISOString()), Tt(), window.localStorage.removeItem(mt), u();
		} catch {
			l.current = !1;
		}
...
var Ys = /* @__PURE__ */ new Set([
	...
	variant: "welcome",
	createdAt: (/* @__PURE__ */ new Date()).toISOString()
}, Zs = "<svg viewBox=\"0 0 24 24\" aria-hidden=\"true\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M19.503 0H4.496A4.496 4.496 0 000 4.496v15.007A4.496 4.496 0 004.496 24h15.007A4.496 4.496 0 0024 19.503V4.496A4.496 4.496 0 0019.503 0z\" fill=\"#fff\"></path><path d=\"M9.064 3.344a4.578 4.578 0 012.285-.312c1 .115 1.891.54 2.673 1.275.01.01.024.017.037.021a.09.09 0 00.043 0 4.55 4.55 0 013.046.275l.047.022.116.057a4.581 4.581 0 012.188 2.399c.209.51.313 1.041.315 1.595a4.24 4.24 0 01-.134 1.223.123.123 0 00.03.115c.594.607.988 1.33 1.183 2.17.289 1.425-.007 2.71-.887 3.854l-.136.166a4.548 4.548 0 01-2.201 1.388.123.123 0 00-.081.076c-.191.551-.383 1.023-.74 1.494-.9 1.187-2.222 1.846-3.711 1.838-1.187-.006-2.239-.44-3.157-1.302a.107.107 0 00-.105-.024c-.388.125-.78.143-1.204.138a4.441 4.441 0 01-1.945-.466 4.544 4.544 0 01-1.61-1.335c-.152-.202-.303-.392-.414-.617a5.81 5.81 0 01-.37-.961 4.582 4.582 0 01-.014-2.298.124.124 0 00.006-.056.085.085 0 00-.027-.048 4.467 4.467 0 01-1.034-1.651 3.896 3.896 0 01-.251-1.192 5.189 5.189 0 01.141-1.6c.337-1.112.982-1.985 1.933-2.618.212-.141.413-.251.601-.33.215-.089.43-.164.646-.227a.098.098 0 00.065-.066 4.51 4.51 0 01.829-1.615 4.535 4.535 0 011.837-1.388zm3.482 10.565a.637.637 0 000 1.272h3.636a.637.637 0 100-1.272h-3.636zM8.462 9.23a.637.637 0 00-1.106.631l1.272 2.224-1.266 2.136a.636.636 0 101.095.649l1.454-2.455a.636.636 0 00.005-.64L8.462 9.23z\" fill=\"url(#folio-react-codex-gradient)\"></path><defs><linearGradient gradientUnits=\"userSpaceOnUse\" id=\"folio-react-codex-gradient\" x1=\"12\" x2=\"12\" y1=\"3\" y2=\"21\"><stop stop-color=\"#B1A7FF\"></stop><stop offset=\".5\" stop-color=\"#7A9DFF\"></stop><stop offset=\"1\" stop-color=\"#3941FF\"></stop></linearGradient></defs></svg>", Qs = "<svg viewBox=\"0 0 24 24\" aria-hidden=\"true\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M9.064 3.344a4.578 4.578 0 012.285-.312c1 .115 1.891.54 2.673 1.275.01.01.024.017.037.021a.09.09 0 00.043 0 4.55 4.55 0 013.046.275l.047.022.116.057a4.581 4.581 0 012.188 2.399c.209.51.313 1.041.315 1.595a4.24 4.24 0 01-.134 1.223.123.123 0 00.03.115c.594.607.988 1.33 1.183 2.17.289 1.425-.007 2.71-.887 3.854l-.136.166a4.548 4.548 0 01-2.201 1.388.123.123 0 00-.081.076c-.191.551-.383 1.023-.74 1.494-.9 1.187-2.222 1.846-3.711 1.838-1.187-.006-2.239-.44-3.157-1.302a.107.107 0 00-.105-.024c-.388.125-.78.143-1.204.138a4.441 4.441 0 01-1.945-.466 4.544 4.544 0 01-1.61-1.335c-.152-.202-.303-.392-.414-.617a5.81 5.81 0 01-.37-.961 4.582 4.582 0 01-.014-2.298.124.124 0 00.006-.056.085.085 0 00-.027-.048 4.467 4.467 0 01-1.034-1.651 3.896 3.896 0 01-.251-1.192 5.189 5.189 0 01.141-1.6c.337-1.112.982-1.985 1.933-2.618.212-.141.413-.251.601-.33.215-.089.43-.164.646-.227a.098.098 0 00.065-.066 4.51 4.51 0 01.829-1.615 4.535 4.535 0 011.837-1.388zm3.482 10.565a.637.637 0 000 1.272h3.636a.637.637 0 100-1.272h-3.636zM8.462 9.23a.637.637 0 00-1.106.631l1.272 2.224-1.266 2.136a.636.636 0 101.095.649l1.454-2.455a.636.636 0 00.005-.64L8.462 9.23z\" fill=\"currentColor\"/></svg>", $s = "M4.709 15.955l4.72-2.647.08-.23-.08-.128H9.2l-.79-.048-2.698-.073-2.339-.097-2.266-.122-.571-.121L0 11.784l.055-.352.48-.321.686.06 1.52.103 2.278.158 1.652.097 2.449.255h.389l.055-.157-.134-.098-.103-.097-2.358-1.596-2.552-1.688-1.336-.972-.724-.491-.364-.462-.158-1.008.656-.722.881.06.225.061.893.686 1.908 1.476 2.491 1.833.365.304.145-.103.019-.073-.164-.274-1.355-2.446-1.446-2.49-.644-1.032-.17-.619a2.97 2.97 0 01-.104-.729L6.283.134 6.696 0l.996.134.42.364.62 1.414 1.002 2.229 1.555 3.03.456.898.243.832.091.255h.158V9.01l.128-1.706.237-2.095.23-2.695.08-.76.376-.91.747-.492.584.28.48.685-.067.444-.286 1.851-.559 2.903-.364 1.942h.212l.243-.242.985-1.306 1.652-2.064.73-.82.85-.904.547-.431h1.033l.76 1.129-.34 1.166-1.064 1.347-.881 1.142-1.264 1.7-.79 1.36.073.11.188-.02 2.856-.606 1.543-.28 1.841-.315.833.388.091.395-.328.807-1.969.486-2.309.462-3.439.813-.042.03.049.061 1.549.146.662.036h1.622l3.02.225.79.522.474.638-.079.485-1.215.62-1.64-.389-3.829-.91-1.312-.329h-.182v.11l1.093 1.068 2.006 1.81 2.509 2.33.127.578-.322.455-.34-.049-2.205-1.657-.851-.747-1.926-1.62h-.128v.17l.444.649 2.345 3.521.122 1.08-.17.353-.608.213-.668-.122-1.374-1.925-1.415-2.167-1.143-1.943-.14.08-.674 7.254-.316.37-.729.28-.607-.461-.322-.747.322-1.476.389-1.924.315-1.53.286-1.9.17-.632-.012-.042-.14.018-1.434 1.967-2.18 2.945-1.726 1.845-.414.164-.717-.37.067-.662.401-.589 2.388-3.036 1.44-1.882.93-1.086-.006-.158h-.055L4.132 18.56l-1.13.146-.487-.456.061-.746.231-.243 1.908-1.312-.006.006z", ec = `<svg viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="${$s}" fill="#D97757" fill-rule="nonzero"></path></svg>`, tc = `<svg viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="${$s}" fill="currentColor" fill-rule="nonzero"></path></svg>`, nc = "M21.751 22.607c1.34 1.005 3.35.335 1.508-1.508C17.73 15.74 18.904 1 12.037 1 5.17 1 6.342 15.74.815 21.1c-2.01 2.009.167 2.511 1.507 1.506 5.192-3.517 4.857-9.714 9.715-9.714 4.857 0 4.522 6.197 9.714 9.715z", rc = `<svg viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="${nc}" fill="url(#folio-react-antigravity-gradient)"></path><defs><linearGradient id="folio-react-antigravity-gradient" x1="5" x2="19" y1="22" y2="2" gradientUnits="userSpaceOnUse"><stop stop-color="#3186FF"></stop><stop offset=".42" stop-color="#34A853"></stop><stop offset=".72" stop-color="#FBBC04"></stop><stop offset="1" stop-color="#EA4335"></stop></linearGradient></defs></svg>`, ic = `<svg viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="${nc}" fill="currentColor"></path></svg>`, ac = "<svg viewBox=\"0 0 24 24\" fill=\"currentColor\" aria-hidden=\"true\"><path d=\"M9 3c.4 3.9 3.1 6.6 7 7-3.9.4-6.6 3.1-7 7-.4-3.9-3.1-6.6-7-7 3.9-.4 6.6-3.1 7-7z\"/><path d=\"M17.8 13c.25 2.4 1.85 4 4.2 4.25-2.35.25-3.95 1.85-4.2 4.25-.25-2.4-1.85-4-4.2-4.25 2.35-.25 3.95-1.85 4.2-4.25z\" opacity=\".7\"/></svg>", oc = {
	codex: {
		label: "Codex",
		color: "#3941ff",
		logo: Zs,
...
function vc(e) {
	return oc[e?.provider && Ys.has(e.provider) ? e.provider : e?.selectedAdapter || ""] || oc.default;
}
function yc(e) {
	return e?.modelChoices || [];
}
...
function xc({ surface: e, open: t, onOpen: n, onClose: r }) {
	let [i, a] = (0, d.useState)(null), [o, s] = (0, d.useState)(null), [c, l] = (0, d.useState)([Xs]), [u, p] = (0, d.useState)(!1), m = Js(Xs), h = Us(m.scope || void 0), [g, y] = (0, d.useState)(""), [b, x] = (0, d.useState)(""), [S, C] = (0, d.useState)("medium"), [w, T] = (0, d.useState)(!1), [E, D] = (0, d.useState)(""), O = (0, d.useRef)(null), k = (0, d.useRef)({
		ownerSurface: e,
		patch: {}
	...
	let j = (0, d.useCallback)((e, t = !1) => {
		...
		a(e), x((e) => {
			let r = bc(n);
			return t && yc(n).some((t) => t.value === e) ? e : r;
		});
		...
		try {
			let t = e?.provider && Ys.has(e.provider) ? e.provider : "", n = t ? `?adapter=${encodeURIComponent(t)}` : "";
	...
	let P = _c(i), F = vc(i), I = yc(P), L = (0, d.useMemo)(() => ({ "--react-agent-accent": F.color }), [F.color]), R = (o?.checks || []).filter((e) => !e.ok), z = (0, d.useCallback)(async (t, n = {}) => {
		let r = t.trim();
		if (!r || w) return;
		k.current = mc(k.current, e);
		let i = gc(window.FolioAgent?.currentContext, k.current, e, n), a = sc(), o = Date.now(), s = new Date(o).toISOString(), c = P?.label || F.label, u = b || P?.model || "model";
		l((e) => [
			...e,
			{
				id: sc(),
							...
							children: [
								e.role === "assistant" && /* @__PURE__ */ (0, f.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, f.jsx)("time", { children: cc(e.createdAt) })
									]
								}),
...
function kc(e) {
	let t = [
		...
		e.end ? `${e.end} 이전` : "",
		e.source ? e.source : "",
		e.market ? wc.find((t) => t.value === e.market)?.label || e.market : "",
		e.country ? Tc[e.country] || e.country : "",
		e.language ? Ec[e.language] || e.language : ""
	].filter(Boolean);
	return t.length ? t.join(" · ") : "전체 RSS 피드";
}
function Ac(e, t) {
	let n = new URLSearchParams({
		offset: String((Math.max(1, e) - 1) * Cc),
		limit: String(Cc)
	});
...
async function Mc(e) {
	let t = e;
	for (; te(t.status);) await Dc(1e3), t = await U(`/api/jobs/${encodeURIComponent(t.id)}`);
...
function Fc() {
	let e = fn("rss"), [t, n] = (0, d.useState)(null), [r, i] = (0, d.useState)(null), [a, o] = (0, d.useState)(1), [s, c] = (0, d.useState)(Sc), [l, u] = (0, d.useState)(Sc), [p, m] = (0, d.useState)(""), [h, g] = (0, d.useState)(!1), [_, v] = (0, d.useState)(!1), [y, b] = (0, d.useState)(!1), [x, S] = (0, d.useState)(""), [C, w] = (0, d.useState)(""), T = r?.items || [], E = r?.total ?? T.length, D = Math.max(1, Math.ceil(E / Cc)), O = (0, d.useMemo)(() => r?.sources || [], [r?.sources]), k = (0, d.useMemo)(() => r?.countries || [], [r?.countries]), A = (0, d.useMemo)(() => r?.languages || [], [r?.languages]), j = (0, d.useCallback)(async (e = a, t = s) => {
		g(!0), S("");
		try {
			let n = await U(`/api/rss/items?${Ac(e, t).toString()}`);
	...
	async function L() {
		...
		try {
			let e = await Mc(await W("/api/rssarchive/import", {})), t = Number.isFinite(Number(e.result?.added)) ? ` 신규 ${e.result?.added}개` : "";
	...
	return /* @__PURE__ */ (0, f.jsxs)("div", {
		...
		children: [
					...
					children: [
						/* @__PURE__ */ (0, f.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, f.jsx)("span", { children: "시장" }), /* @__PURE__ */ (0, f.jsx)("select", {
								...
								children: wc.map((e) => /* @__PURE__ */ (0, f.jsx)("option", {
									value: e.value,
									children: e.label
								}, e.value || "all-market"))
							})]
			...
			/* @__PURE__ */ (0, f.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, f.jsx)("strong", { children: kc(s) }), /* @__PURE__ */ (0, f.jsx)("span", { children: E > 0 ? `${E}개 · ${R}/${D}` : "0개" })]
			}),
			...
			/* @__PURE__ */ (0, f.jsx)("section", {
				...
				children: T.length ? T.map((e, t) => {
					let n = Nc(e, t), r = String(e.description || "").trim(), i = jc(e);
					return /* @__PURE__ */ (0, f.jsxs)("article", {
							...
							children: [
								...
								/* @__PURE__ */ (0, f.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, f.jsx)("span", { children: Oc(e) })
									]
								}),
...
var Ic = "folio.homePreference.v1", Lc = "folio.agentCharacter.v1", Rc = "folio.motionPreference.v1", zc = "folio:ui-preferences-updated", Bc = {
	home: {
		mode: "home",
		choiceSeen: !0
	},
...
function Wc(e) {
	typeof window > "u" || window.dispatchEvent(new CustomEvent(zc, { detail: e }));
}
function Gc(e) {
	return Uc(Ic, e.home), Uc(Lc, e.character), Uc(Rc, e.motion), Wc(e), e;
}
function Kc() {
	if (typeof window < "u") try {
		window.localStorage.removeItem(Ic), window.localStorage.removeItem(Lc), window.localStorage.removeItem(Rc);
	} catch {}
...
function Jc() {
	let [e, t] = (0, d.useState)(() => Hc());
	(0, d.useEffect)(() => {
		let e = (e) => {
			let n = e.detail;
			t(n || Hc());
		}, n = () => t(Hc());
		return window.addEventListener(zc, e), window.addEventListener("storage", n), () => {
			window.removeEventListener(zc, e), window.removeEventListener("storage", n);
		};
	}, []);
	function n(e) {
		t(e), Gc(e);
...
function Zc() {
	return {
		preference: Yc(window.FolioTheme?.preference) ? window.FolioTheme.preference : "system",
		resolved: Xc(window.FolioTheme?.resolved) ? window.FolioTheme.resolved : window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"
	};
}
function Qc() {
	...
	return (0, d.useEffect)(() => {
		let e = (e) => {
			let n = e?.detail;
			if (n && Yc(n.preference) && Xc(n.resolved)) {
				t(n);
				return;
			}
			t(Zc());
...
function dl() {
	let e = Qc(), t = Jc(), [n, r] = (0, d.useState)("integrations"), [i, a] = (0, d.useState)(null), [o, s] = (0, d.useState)(null), [c, l] = (0, d.useState)({}), [u, p] = (0, d.useState)({}), [m, h] = (0, d.useState)(null), [g, _] = (0, d.useState)("openai"), [v, y] = (0, d.useState)(""), [b, x] = (0, d.useState)(""), [S, C] = (0, d.useState)(!0), [w, T] = (0, d.useState)("cli"), [E, D] = (0, d.useState)("codex"), [O, k] = (0, d.useState)(""), [A, j] = (0, d.useState)({
		fred: "",
		bok: "",
		dart: ""
	}), [M, N] = (0, d.useState)({
		token: "",
		dbId: ""
	}), [P, F] = (0, d.useState)(""), [I, L] = (0, d.useState)({}), [R, z] = (0, d.useState)(""), [B, V] = (0, d.useState)(""), [ee, H] = (0, d.useState)(""), te = i?.llm?.providers || {}, ne = te[g] || {}, re = rl[g], ie = ne.modelChoices || [], ae = o?.adapters || [], oe = (ae.find((e) => e.id === E) || ae[0])?.modelChoices || [], se = (0, d.useCallback)(async (e = !1) => {
		H(""), V("load");
		try {
			...
			k(m.some((e) => e.value === f?.model) ? String(f?.model || "") : m[0]?.value || ""), window.dispatchEvent(new CustomEvent("folio:agent-settings-updated", { detail: n })), l(ll(r)), p(i), F(i.vaultPath || ""), G("settings", {
				surface: "settings",
				viewId: "settings",
				reportKind: "",
				reportId: ""
	...
	async function he() {
		...
		try {
			let e = await W("/api/automation/settings", ll(c));
			l(ll(e)), z("자동화 설정을 저장했습니다.");
		} catch (e) {
								...
								children: w === "cli" ? /* @__PURE__ */ (0, f.jsxs)(f.Fragment, { children: [/* @__PURE__ */ (0, f.jsxs)("div", {
									...
									/* @__PURE__ */ (0, f.jsxs)("label", {
										...
										children: [/* @__PURE__ */ (0, f.jsx)("span", { children: "API 제공자" }), /* @__PURE__ */ (0, f.jsxs)("select", {
											value: g,
											onChange: (e) => _(il(e.currentTarget.value)),
											children: [
												/* @__PURE__ */ (0, f.jsx)("option", {
													value: "openai",
													children: "GPT / OpenAI"
									...
									/* @__PURE__ */ (0, f.jsx)("div", {
										...
										children: ge.map(({ providerId: e, row: t, label: n, className: r, detail: i }) => /* @__PURE__ */ (0, f.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, f.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, f.jsxs)("div", {
													className: "cli-provider-head",
													children: [/* @__PURE__ */ (0, f.jsx)("strong", { children: t.label || rl[e].name }), /* @__PURE__ */ (0, f.jsx)("span", {
							...
							/* @__PURE__ */ (0, f.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, f.jsxs)("label", {
									...
									children: [/* @__PURE__ */ (0, f.jsx)("span", { children: "FRED 상태" }), /* @__PURE__ */ (0, f.jsx)("p", {
										className: "section-subtitle",
										children: al(i?.fred?.hasApiKey, i?.fred?.apiKeyMasked, "딥 리서치 미국 경제지표용 FRED API 키가 없습니다.", "FRED API 키")
									})]
								})]
							}),
							/* @__PURE__ */ (0, f.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, f.jsxs)("label", {
									...
									children: [/* @__PURE__ */ (0, f.jsx)("span", { children: "BOK 상태" }), /* @__PURE__ */ (0, f.jsx)("p", {
										className: "section-subtitle",
										children: al(i?.bok?.hasApiKey, i?.bok?.apiKeyMasked, "딥 리서치 한국 경제지표용 BOK API 키가 없습니다.", "BOK API 키")
									})]
								})]
							}),
							/* @__PURE__ */ (0, f.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, f.jsxs)("label", {
									...
									children: [/* @__PURE__ */ (0, f.jsx)("span", { children: "DART 상태" }), /* @__PURE__ */ (0, f.jsx)("p", {
										className: "section-subtitle",
										children: al(i?.dart?.hasApiKey, i?.dart?.apiKeyMasked, "국내 기업 분석용 DART API 키가 없습니다.", "DART API 키")
									})]
								})]
							}),
							/* @__PURE__ */ (0, f.jsx)("div", {
								...
								children: [
									/* @__PURE__ */ (0, f.jsxs)("section", {
										...
										children: [
											...
											/* @__PURE__ */ (0, f.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, f.jsx)("span", { children: "기사 전문 저장 (무료 공개 본문만, 로컬 보관용)" }), /* @__PURE__ */ (0, f.jsx)(cl, {
													ariaLabel: "기사 전문 저장",
									...
									/* @__PURE__ */ (0, f.jsxs)("section", {
										...
										children: [
											...
											/* @__PURE__ */ (0, f.jsxs)("div", {
												className: "automation-inline-switch",
												children: [/* @__PURE__ */ (0, f.jsx)("span", { children: "RSS 수집 직후에도 정리" }), /* @__PURE__ */ (0, f.jsx)(cl, {
									...
									/* @__PURE__ */ (0, f.jsxs)("section", {
										...
										children: [
												...
												children: [
													...
													/* @__PURE__ */ (0, f.jsxs)("label", {
														...
														children: [/* @__PURE__ */ (0, f.jsx)("span", { children: "브리핑 유형" }), /* @__PURE__ */ (0, f.jsx)("select", {
															...
															children: Object.entries(ul).map(([e, t]) => /* @__PURE__ */ (0, f.jsx)("option", {
																value: e,
																children: t
															}, e))
														})]
											...
											/* @__PURE__ */ (0, f.jsxs)("div", {
												className: "automation-inline-switch",
												children: [/* @__PURE__ */ (0, f.jsx)("span", { children: "브리핑 전 RSS/Memory 실행" }), /* @__PURE__ */ (0, f.jsx)(cl, {
...
function wl() {
	let { resolved: e } = Qc(), [t, n] = (0, d.useState)([]), [r, i] = (0, d.useState)([]), [a, o] = (0, d.useState)(""), [s, c] = (0, d.useState)(() => Sl()), [l, u] = (0, d.useState)(null), [p, m] = (0, d.useState)(!1), [h, g] = (0, d.useState)(!1), [_, v] = (0, d.useState)(!1), [y, b] = (0, d.useState)(""), [x, S] = (0, d.useState)(""), C = (0, d.useRef)(null), w = (0, d.useCallback)(async (e) => {
		if (!e.length) {
			i([]);
			return;
		}
		...
		m(!0), b("");
		try {
			let e = await U("/api/watchlist"), t = pl(Array.isArray(e) ? e : []);
	...
	async function E(e, t) {
		v(!0), b("");
		try {
			let r = await W("/api/watchlist", { items: e }), i = pl(Array.isArray(r) ? r : []);
			n(i), await w(i), t && S(t);
		} catch (e) {
	...
	async function P(e) {
		await E(t.filter((t) => t !== e), "워치리스트에서 삭제했습니다."), s === e && xl();
	}
	let F = (0, d.useMemo)(() => vl(l?.news || []), [l]), I = gl(l, s);
				...
				children: [
					/* @__PURE__ */ (0, f.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, f.jsxs)("div", { children: [
							...
							children: [/* @__PURE__ */ (0, f.jsx)(fl, { item: s }), /* @__PURE__ */ (0, f.jsx)("button", {
								className: "icon-btn",
								type: "button",
								"aria-label": "닫기",
								"data-tooltip": "닫기",
							...
							children: F.map((e, t) => /* @__PURE__ */ (0, f.jsxs)("article", {
								...
								children: [
									...
									/* @__PURE__ */ (0, f.jsx)("h4", { children: e.url ? /* @__PURE__ */ (0, f.jsx)("a", {
										...
										rel: "noopener noreferrer",
										children: yl(e)
									}) : /* @__PURE__ */ (0, f.jsx)("span", { children: yl(e) }) }),
									e.snippet && /* @__PURE__ */ (0, f.jsx)("p", { children: e.snippet })
								]
							}, `${yl(e)}-${t}`))
						}) : /* @__PURE__ */ (0, f.jsx)("p", {
			...
			/* @__PURE__ */ (0, f.jsx)("div", {
				...
				children: r.length ? r.map((e) => {
					...
					return /* @__PURE__ */ (0, f.jsxs)("article", {
						...
						onClick: () => xl(t),
						onKeyDown: (e) => {
							(e.key === "Enter" || e.key === " ") && (e.preventDefault(), xl(t));
						},
						children: [
							/* @__PURE__ */ (0, f.jsx)("span", {
							...
							/* @__PURE__ */ (0, f.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, f.jsx)("strong", {
									...
									children: ml(e)
								}), /* @__PURE__ */ (0, f.jsx)("h3", { children: hl(e) })]
							}),
							/* @__PURE__ */ (0, f.jsxs)("div", {
...
function jl() {
	return typeof window < "u" && window.matchMedia(Al).matches;
}
function Ml() {
	let e = window.location.hash || wi(qc());
...
function Fl() {
	let { hash: e, routeId: t } = Nl(), n = Ti(t), r = qc(Jc().preferences), i = Dl(), [a, o] = (0, d.useState)(() => localStorage.getItem("folio.react.navCollapsed") === "1"), s = (0, d.useRef)(!1), [c, l] = (0, d.useState)(() => {
		let e = localStorage.getItem("folio.react.agentClosed"), t = e === null || e !== "1";
		return t && jl() ? (s.current = !0, !1) : t;
	...
	(0, d.useEffect)(() => {
		...
		let e = window.matchMedia(Al), t = (e) => {
	...
	function O(e) {
		let t = Ti(e);
		return t.id === "home" ? /* @__PURE__ */ (0, f.jsx)(un, {}) : t.id === "dashboard" ? /* @__PURE__ */ (0, f.jsx)(Qa, {}) : t.id === "briefing" ? /* @__PURE__ */ (0, f.jsx)(yi, {}) : t.id === "rss" ? /* @__PURE__ */ (0, f.jsx)(Fc, {}) : t.id === "market-memory" ? /* @__PURE__ */ (0, f.jsx)(js, {}) : t.id === "analysis" ? /* @__PURE__ */ (0, f.jsx)(Aa, {}) : t.id === "deep-research" ? /* @__PURE__ */ (0, f.jsx)(Ko, {}) : t.id === "watchlist" ? /* @__PURE__ */ (0, f.jsx)(wl, {}) : t.id === "portfolio" ? /* @__PURE__ */ (0, f.jsx)(Vs, {}) : t.id === "settings" ? /* @__PURE__ */ (0, f.jsx)(dl, {}) : null;
	}
	return /* @__PURE__ */ (0, f.jsxs)("div", {
			...
			/* @__PURE__ */ (0, f.jsxs)("aside", {
				...
				children: [/* @__PURE__ */ (0, f.jsx)("button", {
					...
					children: [/* @__PURE__ */ (0, f.jsx)("div", {
						...
						children: "Navigate"
					}), Ol.map((e) => /* @__PURE__ */ (0, f.jsxs)("section", {
...
function Il() {
	return /* @__PURE__ */ (0, f.jsx)(Fl, {});
}
//#endregion
//#region src/main.tsx
var Ll = { "market-state": () => /* @__PURE__ */ (0, f.jsx)(fs, {}) };
function Rl() {
	document.querySelectorAll("[data-react-island]").forEach((e) => {
		let t = Ll[e.dataset.reactIsland || ""];
...
function zl() {
	...
	return e ? e.dataset.reactMounted === "1" || (e.dataset.reactMounted = "1", (0, u.createRoot)(e).render(/* @__PURE__ */ (0, f.jsx)(d.StrictMode, { children: /* @__PURE__ */ (0, f.jsx)(Il, {}) })), !0) : !1;
}
function Bl() {
	zl(), Rl();
}
