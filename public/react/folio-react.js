...
function Gl({ schedules: e, watched: t, runsById: n, onChange: r }) {
			...
			e.map((o) => {
				...
				return /* @__PURE__ */ (0, G.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, G.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, G.jsx)("select", {
									...
									children: Object.entries(ql).map(([e, t]) => /* @__PURE__ */ (0, G.jsx)("option", {
										value: e,
										children: t
									}, e))
								}),
						...
						/* @__PURE__ */ (0, G.jsx)(Kl, { run: n[o.id] })
					]
				}, o.id);
			}),
								...
								children: [
									...
									/* @__PURE__ */ (0, G.jsxs)("section", {
										...
										children: [
											...
											/* @__PURE__ */ (0, G.jsx)(Kl, { run: be.marketMemory })
										]
									}),
									/* @__PURE__ */ (0, G.jsxs)("section", {
										className: "automation-card",
...
function tu(e) {
	return e.companyName || e.name || e.item || eu(e);
}
function nu(e, t = "") {
...
var su = /^(?:co|inc|ltd|corp|llc|plc|ag|nv|sa|se|kk|gmbh|s\.?a\.?s|co\.?,?\s*ltd)\.?$/i;
function cu(e, t) {
	let n = String(e || "").trim();
	return n ? t ? [n] : n.split(/[,;\n]/).map((e) => e.trim()).filter(Boolean).filter((e) => !su.test(e)) : [];
}
function lu(e) {
...
function fu() {
	let { resolved: e } = wl(), [t, n] = (0, l.useState)([]), [r, i] = (0, l.useState)([]), [a, o] = (0, l.useState)(""), [s, c] = (0, l.useState)(() => uu()), [u, d] = (0, l.useState)(null), [f, p] = (0, l.useState)(!1), [m, h] = (0, l.useState)(!1), [g, _] = (0, l.useState)(!1), [v, y] = (0, l.useState)(""), [b, x] = (0, l.useState)(""), S = (0, l.useRef)(null), C = (0, l.useCallback)(async (e) => {
		if (!e.length) {
			i([]);
			return;
		}
		...
		p(!0), y("");
		try {
			let e = await B("/api/watchlist"), t = $l(Array.isArray(e) ? e : []);
	...
	async function T(e, t) {
		_(!0), y("");
		try {
			let r = await V("/api/watchlist", { items: e }), i = $l(Array.isArray(r) ? r : []);
			n(i), await C(i), t && x(t);
		} catch (e) {
	...
	async function P(e) {
		await T(t.filter((t) => t !== e), "워치리스트에서 삭제했습니다."), s === e && lu();
	}
	let F = (0, l.useMemo)(() => iu(u?.news || []), [u]), I = nu(u, s);
				...
				children: [
					/* @__PURE__ */ (0, G.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, G.jsxs)("div", { children: [
							...
							children: [/* @__PURE__ */ (0, G.jsx)(Ql, { item: s }), /* @__PURE__ */ (0, G.jsx)("button", {
								className: "btn btn--icon",
								type: "button",
								"aria-label": "닫기",
								"data-tooltip": "닫기",
							...
							children: F.map((e, t) => /* @__PURE__ */ (0, G.jsxs)("article", {
								...
								children: [
									...
									/* @__PURE__ */ (0, G.jsx)("h4", { children: e.url ? /* @__PURE__ */ (0, G.jsx)("a", {
										...
										rel: "noopener noreferrer",
										children: au(e)
									}) : /* @__PURE__ */ (0, G.jsx)("span", { children: au(e) }) }),
									e.snippet && /* @__PURE__ */ (0, G.jsx)("p", { children: e.snippet })
								]
							}, `${au(e)}-${t}`))
						}) : /* @__PURE__ */ (0, G.jsx)("p", {
			...
			/* @__PURE__ */ (0, G.jsx)("div", {
				...
				children: r.length ? r.map((e) => {
					...
					return /* @__PURE__ */ (0, G.jsxs)("article", {
						...
						onClick: () => lu(t),
						onKeyDown: (e) => {
							(e.key === "Enter" || e.key === " ") && (e.preventDefault(), lu(t));
						},
						children: [
							/* @__PURE__ */ (0, G.jsx)("span", {
							...
							/* @__PURE__ */ (0, G.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, G.jsx)("strong", {
									...
									children: eu(e)
								}), /* @__PURE__ */ (0, G.jsx)("h3", { children: tu(e) })]
							}),
							/* @__PURE__ */ (0, G.jsxs)("div", {
...
function gu() {
	let e = wl(), [t, n] = (0, l.useState)(!1), r = (0, l.useRef)(null), i = (0, l.useRef)(null), a = (0, l.useRef)([]), o = e.preference === "system" ? `시스템 (${mu[e.resolved]})` : mu[e.preference];
	(0, l.useEffect)(() => {
		if (!t) return;
		let e = (e) => {
		...
		if (!t) return;
		let n = Math.max(0, pu.indexOf(e.preference));
		a.current[n]?.focus();
	}, [t, e.preference]);
	let s = (e, t) => {
		let n = (e + t + pu.length) % pu.length;
		a.current[n]?.focus();
	};
	return /* @__PURE__ */ (0, G.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, G.jsx)("button", {
			...
			"data-tooltip-pos": "bottom",
			onClick: () => n((e) => !e),
			children: /* @__PURE__ */ (0, G.jsx)(hu, { preference: e.preference })
		}), t && /* @__PURE__ */ (0, G.jsx)("div", {
			className: "theme-menu-list",
			role: "menu",
			"aria-label": "화면 테마",
			children: pu.map((t, r) => /* @__PURE__ */ (0, G.jsxs)("button", {
				type: "button",
				role: "menuitemradio",
				...
				children: [/* @__PURE__ */ (0, G.jsx)(hu, { preference: t }), mu[t]]
			}, t))
		})]
	});
}
...
function bu() {
	return typeof window < "u" && window.matchMedia(yu).matches;
}
function xu() {
...
function wu() {
	let { hash: e, routeId: t } = Su(), n = Ai(t), r = yl(bl().preferences), [i, a] = (0, l.useState)(() => localStorage.getItem("folio.react.navCollapsed") === "1"), o = (0, l.useRef)(!1), [s, c] = (0, l.useState)(() => {
		let e = localStorage.getItem("folio.react.agentClosed"), t = e === null || e !== "1";
		return t && bu() ? (o.current = !0, !1) : t;
	}), [u, d] = (0, l.useState)(() => /* @__PURE__ */ new Set([t])), [f, p] = (0, l.useState)(() => ({ [t]: xu() })), [m, h] = (0, l.useState)(""), [g, _] = (0, l.useState)(!1), v = (0, l.useRef)(null), y = (0, l.useRef)(t), b = (0, l.useRef)(!1), x = (0, l.useRef)({}), S = n.id !== "home", C = S && s ? " is-agent-open" : " is-agent-closed";
	(0, l.useEffect)(() => {
		nt(n.id, {
			surface: `react_${n.id}`,
			viewId: n.id
		...
		let e = window.matchMedia(yu), t = (e) => {
			...
			/* @__PURE__ */ (0, G.jsxs)("aside", {
				...
				children: [/* @__PURE__ */ (0, G.jsx)("button", {
					...
					children: [/* @__PURE__ */ (0, G.jsx)("div", {
						...
						children: "Navigate"
					}), _u.map((e) => /* @__PURE__ */ (0, G.jsxs)("section", {
...
function Mu({ onFinish: e }) {
	...
	}, j = Tu.indexOf(n), M = Du.find((e) => e.id === f);
	return /* @__PURE__ */ (0, G.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, G.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, G.jsx)("div", {
					...
					"aria-label": "진행 단계",
					"aria-valuemin": 1,
					"aria-valuemax": Tu.length,
					"aria-valuenow": j + 1,
					style: { "--welcome-fill": `${(j + 1) / Tu.length * 100}%` }
				}),
				/* @__PURE__ */ (0, G.jsxs)("section", {
					...
					children: [
						/* @__PURE__ */ (0, G.jsxs)("p", {
							...
							children: [/* @__PURE__ */ (0, G.jsx)(ju, { step: n }), Au[n]]
						}),
						n === "welcome" && /* @__PURE__ */ (0, G.jsxs)(G.Fragment, { children: [
							...
							/* @__PURE__ */ (0, G.jsx)("div", {
								...
								role: "group",
								"aria-label": "화면 테마",
								children: Eu.map((e) => /* @__PURE__ */ (0, G.jsx)("button", {
									type: "button",
...
function Nu() {
	...
	}, []), /* @__PURE__ */ (0, G.jsxs)(G.Fragment, { children: [/* @__PURE__ */ (0, G.jsx)(wu, {}), e && /* @__PURE__ */ (0, G.jsx)(Mu, { onFinish: () => t(!1) })] });
}
//#endregion
//#region src/main.tsx
var Pu = { "market-state": () => /* @__PURE__ */ (0, G.jsx)(js, {}) };
function Fu() {
	document.querySelectorAll("[data-react-island]").forEach((e) => {
		let t = Pu[e.dataset.reactIsland || ""];
...
function Iu() {
	...
	return e ? e.dataset.reactMounted === "1" || (e.dataset.reactMounted = "1", (0, u.createRoot)(e).render(/* @__PURE__ */ (0, G.jsx)(l.StrictMode, { children: /* @__PURE__ */ (0, G.jsx)(Nu, {}) })), !0) : !1;
}
function Lu() {
	Iu(), Fu();
}
document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", Lu) : Lu();
//#endregion
