...
function Hi() {
	...
	async function M(e) {
		...
		if (t) {
			...
			try {
				...
				await j(), D("기업 분석 보고서를 생성하고 자동 저장했습니다."), r(i), i.id && zi(i.id);
			} catch (e) {
	...
	async function P(e) {
		if (e.id && window.confirm(`${Di(e)} 보고서를 삭제할까요?`)) {
			...
			try {
				...
				n?.id === e.id && zi(), await j(), D("저장된 기업 분석 보고서를 삭제했습니다.");
			} catch (e) {
	...
	}, [L, m]), z = Ri(n || {}), B = wi(z, n?.headline || Di(n || {})), V = n?.sources || [], H = Pi(n);
				...
				children: [/* @__PURE__ */ (0, x.jsx)("h4", { children: "참고자료" }), /* @__PURE__ */ (0, x.jsx)("div", {
					...
					children: V.map((e, t) => /* @__PURE__ */ (0, x.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, x.jsx)("span", { children: Li(e) }), e.url ? /* @__PURE__ */ (0, x.jsx)("a", {
							...
							children: Z(e)
						}) : /* @__PURE__ */ (0, x.jsx)("span", { children: Z(e) })]
					}, `${Z(e)}-${t}`))
				})]
			})]
		})]
...
function no({ selectedRef: e, onSelectedRef: t, onBusyChange: n, onOpenDetail: r, disabled: i }) {
	...
	let W = () => {
		...
		V && (_("edit"), y(V.id), C(V.revision), T(Ya(V)), F(null), N(""));
	}, K = async () => {
		let e = Ja(w);
				...
				children: [
					/* @__PURE__ */ (0, x.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, x.jsx)("h3", {
							...
							Do(t.researchQuestions),
							/* @__PURE__ */ (0, x.jsx)("h4", { children: "반증 조건" }),
							Do(t.falsificationTriggers)
						] }) : /* @__PURE__ */ (0, x.jsx)(io, {})]
					}),
					/* @__PURE__ */ (0, x.jsxs)("section", {
						className: "topicrpt-provenance-panel",
					...
					/* @__PURE__ */ (0, x.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, x.jsx)("h3", {
							...
							Do(e.quality.warnings, "경고 없음"),
							/* @__PURE__ */ (0, x.jsx)("h4", { children: "보완 제안" }),
							Do(e.quality.suggestedFixes, "제안 없음")
						] }) : /* @__PURE__ */ (0, x.jsx)(io, {})]
					}),
					/* @__PURE__ */ (0, x.jsxs)("section", {
						className: "topicrpt-provenance-panel topicrpt-provenance-wide",
...
function Oo({ envelope: e, executionMode: t, cliAdapter: n, onExecutionMode: r, onCliAdapter: i, onContinue: a, onEdit: o, degradedConfirming: s, onConfirmDegraded: c, onCancelDegraded: l }) {
					...
					/* @__PURE__ */ (0, x.jsxs)("div", {
						...
						children: [
							...
							f.analysisAxes.length ? /* @__PURE__ */ (0, x.jsx)("ul", {
								...
								children: f.analysisAxes.map((e) => /* @__PURE__ */ (0, x.jsxs)("li", { children: [/* @__PURE__ */ (0, x.jsx)("strong", { children: e.label }), Do(e.questions)] }, e.key))
							}) : /* @__PURE__ */ (0, x.jsx)("span", {
								className: "topicrpt-empty-value",
								children: "분석 축 없음"
							})
...
function ko() {
	let [e, t] = (0, b.useState)(0), [n, r] = (0, b.useState)([]), [i, a] = (0, b.useState)(null), s = (0, b.useMemo)(() => yn(window.location.hash), []), [u, f] = (0, b.useState)(s.kind === "report" ? s.id : ""), [p, m] = (0, b.useState)(s.kind === "collection" ? s.id : ""), [h, g] = (0, b.useState)(s.malformed), [_, v] = (0, b.useState)(""), [y, S] = (0, b.useState)(""), [C, w] = (0, b.useState)("include_current"), [T, E] = (0, b.useState)("AUTO"), [D, k] = (0, b.useState)(null), [A, j] = (0, b.useState)(!1), [M, N] = (0, b.useState)("readiness"), [P, F] = (0, b.useState)(null), [I, L] = (0, b.useState)("direct"), [R, z] = (0, b.useState)("auto"), [B, V] = (0, b.useState)(!1), [H, U] = (0, b.useState)(!1), [W, G] = (0, b.useState)(""), [K, q] = (0, b.useState)(null), [ee, te] = (0, b.useState)(""), [ne, re] = (0, b.useState)(null), [ie, ae] = (0, b.useState)(""), [oe, se] = (0, b.useState)(""), [ce, le] = (0, b.useState)(0), ue = (0, b.useRef)(0), fe = (0, b.useRef)(null), pe = (0, b.useRef)(null), me = (0, b.useRef)(""), he = (0, b.useRef)(!1), ge = so[0].key, _e = _, ve = (0, b.useCallback)(() => {
		...
		try {
			...
			if (e instanceof DOMException && e.name === "AbortError") return;
			G(To("readiness", e)), q("readiness"), te(wo(e));
			let t = wo(e);
	...
	let xe = (0, b.useCallback)(() => {
		he.current = !0, a(null), g(!1), G(""), q(null), te(""), So();
	}, []);
	(0, b.useEffect)(() => {
		...
		async function n(n) {
			...
			try {
				...
				a(null), G(To("report", n)), q("report"), te(wo(n)), N("recoverable-error");
			} finally {
	...
	let Se = async (e) => {
		...
		if (!t || t.length > 500) {
			G(To("validation", /* @__PURE__ */ Error("question_invalid"))), q("validation"), te("question_invalid"), N("recoverable-error");
			return;
		}
		let n = ve();
		...
		try {
			...
			G(To("plan", e)), q("plan"), te(wo(e)), re(wo(e) === "no_index" || wo(e) === "index_unavailable" ? "no-index" : wo(e) === "rss_unavailable" ? "rss" : null), N("recoverable-error"), ae("");
		}
	}, Ce = async (e) => {
		let n = ve();
		...
		try {
			...
			if (!ye(n.id)) return;
			r((e) => [d, ...e.filter((e) => e.id !== d.id)]), a(d), N("report"), ae("딥 리서치를 생성하고 자동 저장했습니다."), So(d.id), Te("deep-research", {
				surface: "topic_report_reader",
				viewId: "topicrpt",
				reportKind: "topic_report",
				reportId: d.id || "",
			...
			G(To("generation", e)), q(e instanceof c && (e.code === "evidence_confirmation_required" || e.code === "resolution_changed") ? "degraded" : "generation"), te(wo(e)), N("recoverable-error"), ae("");
		}
	}, we = () => {
		if (P) {
		...
		try {
			...
			G(To("degraded", e)), q("degraded"), te(wo(e)), N("recoverable-error"), ae("");
		}
	};
	async function Oe(e) {
		if (!(!e.id || !window.confirm(`${yo(e)} 보고서를 삭제할까요?`))) {
			...
			try {
				...
				if (!t.ok) throw Error(`삭제 실패: ${t.status}`);
				i?.id === e.id && So(), r((t) => t.filter((t) => t.id !== e.id)), ae("저장된 딥 리서치를 삭제했습니다.");
			} catch (e) {
				G(e instanceof Error ? e.message : "보고서 삭제에 실패했습니다."), q("report"), te(wo(e));
			} finally {
				se("");
			}
		}
	...
	}, [n]), Ne = vo(i?.markdown || "", i ? yo(i) : "딥 리서치"), Pe = Xi(i?.marketStateResolution), Fe = (0, b.useCallback)((e) => {
	...
	return /* @__PURE__ */ (0, x.jsxs)("div", {
		...
		children: [
			...
			M === "plan-review" && P && /* @__PURE__ */ (0, x.jsx)(Oo, {
				envelope: P,
				executionMode: I,
				cliAdapter: R,
				onExecutionMode: L,
...
var Ao = "folio.marketMemory.activeJob.v1", jo = /^job_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/, Mo = /* @__PURE__ */ new Set([
	"queued",
	"running",
	"cancel_requested",
	"committing",
	...
	"failed_restart",
	"failed_commit_recovery"
]), No = "market_memory_update", Po = "LLM CLI 시장 메모리 업데이트";
function Fo() {
	try {
...
function Io(e) {
	return typeof e == "string" && jo.test(e);
}
function Lo(e, t) {
	if (!e || typeof e != "object" || Array.isArray(e)) return !1;
	let n = e;
	return n.id === t && Mo.has(n.status);
}
function Ro(e) {
	if (!e || typeof e != "object" || Array.isArray(e)) return !1;
	let t = e;
	return !Io(t.id) || !Mo.has(t.status) || !f(t.status) ? !1 : t.taskType === No || t.taskType === void 0 && t.label === Po;
}
function zo(e = Fo()) {
	try {
		e?.removeItem(Ao);
...
function Bo(e = Fo()) {
	...
	return t ? Io(t) ? t : (zo(e), null) : null;
}
function Vo(e, t = Fo()) {
	if (!Io(e) || !t) return !1;
	try {
		return t.setItem(Ao, e), t.getItem(Ao) === e;
	} catch {
		return !1;
	}
}
...
async function qo() {
	return o("/api/memory/update", { date: Wo() });
}
function Jo() {
	...
	function p(e) {
		...
		zo(), a(`시장 메모리를 업데이트했습니다. ${Go(e)}`), u(null), t((e) => e + 1);
	}
	(0, b.useEffect)(() => {
		let e = !0;
		return (async () => {
			let t = await Ho((e) => l(`/api/jobs/${encodeURIComponent(e)}`));
			if (t.kind === "none" && (t = await Uo(() => l("/api/jobs"))), e) if (t.kind === "active") {
				u(t.job), r(!0), a("이전에 시작한 서버 작업에 자동으로 다시 연결했습니다.");
				try {
					await m(t.job);
				} catch (t) {
					if (!e) return;
					t instanceof Ne ? (zo(), u(null), s(t.message), a("")) : t instanceof DOMException && t.name === "AbortError" || (s(t instanceof Error ? t.message : "작업 상태 확인에 실패했습니다."), a(""));
				} finally {
					e && r(!1);
				}
	...
	async function h() {
		...
		try {
			...
			let e = await qo();
			Ko(e) ? (Vo(e.id), u(e), await m(e)) : p(e);
		} catch (e) {
			e instanceof Ne ? (zo(), u(null), s(e.message), a("")) : e instanceof DOMException && e.name === "AbortError" || (s(e instanceof Error ? e.message : "시장 메모리 업데이트에 실패했습니다."), a(""));
		} finally {
			r(!1);
		}
	}
	async function g() {
		if (c) {
			...
			try {
				...
				e instanceof Ne ? (zo(), u(null), s(e.message), a("")) : e instanceof DOMException && e.name === "AbortError" || (s(e instanceof Error ? e.message : "작업 상태 확인에 실패했습니다."), a(""));
			} finally {
				r(!1);
			}
		}
...
function Yo({ positions: e, onChange: t }) {
	function n(n, r, i) {
		t(e.map((e, t) => t === n ? {
			...e,
			[r]: i
...
function Zo({ current: e, onApply: t, onClose: n }) {
			...
			/* @__PURE__ */ (0, x.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, x.jsxs)("section", {
					...
					children: [
						...
						/* @__PURE__ */ (0, x.jsx)(Qo, { tickers: n.map((e) => e.ticker).filter(Boolean) }),
						/* @__PURE__ */ (0, x.jsx)("small", { children: "상담 내용은 보고서 근거로 사용되지 않습니다." })
					]
				})]
			}),
			i && /* @__PURE__ */ (0, x.jsx)(Zo, {
				current: n,
				onApply: (e) => {
...
var es = /* @__PURE__ */ new Set([
	...
	variant: "welcome",
	createdAt: (/* @__PURE__ */ new Date()).toISOString()
}, ns = "<svg viewBox=\"0 0 24 24\" aria-hidden=\"true\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M19.503 0H4.496A4.496 4.496 0 000 4.496v15.007A4.496 4.496 0 004.496 24h15.007A4.496 4.496 0 0024 19.503V4.496A4.496 4.496 0 0019.503 0z\" fill=\"#fff\"></path><path d=\"M9.064 3.344a4.578 4.578 0 012.285-.312c1 .115 1.891.54 2.673 1.275.01.01.024.017.037.021a.09.09 0 00.043 0 4.55 4.55 0 013.046.275l.047.022.116.057a4.581 4.581 0 012.188 2.399c.209.51.313 1.041.315 1.595a4.24 4.24 0 01-.134 1.223.123.123 0 00.03.115c.594.607.988 1.33 1.183 2.17.289 1.425-.007 2.71-.887 3.854l-.136.166a4.548 4.548 0 01-2.201 1.388.123.123 0 00-.081.076c-.191.551-.383 1.023-.74 1.494-.9 1.187-2.222 1.846-3.711 1.838-1.187-.006-2.239-.44-3.157-1.302a.107.107 0 00-.105-.024c-.388.125-.78.143-1.204.138a4.441 4.441 0 01-1.945-.466 4.544 4.544 0 01-1.61-1.335c-.152-.202-.303-.392-.414-.617a5.81 5.81 0 01-.37-.961 4.582 4.582 0 01-.014-2.298.124.124 0 00.006-.056.085.085 0 00-.027-.048 4.467 4.467 0 01-1.034-1.651 3.896 3.896 0 01-.251-1.192 5.189 5.189 0 01.141-1.6c.337-1.112.982-1.985 1.933-2.618.212-.141.413-.251.601-.33.215-.089.43-.164.646-.227a.098.098 0 00.065-.066 4.51 4.51 0 01.829-1.615 4.535 4.535 0 011.837-1.388zm3.482 10.565a.637.637 0 000 1.272h3.636a.637.637 0 100-1.272h-3.636zM8.462 9.23a.637.637 0 00-1.106.631l1.272 2.224-1.266 2.136a.636.636 0 101.095.649l1.454-2.455a.636.636 0 00.005-.64L8.462 9.23z\" fill=\"url(#folio-react-codex-gradient)\"></path><defs><linearGradient gradientUnits=\"userSpaceOnUse\" id=\"folio-react-codex-gradient\" x1=\"12\" x2=\"12\" y1=\"3\" y2=\"21\"><stop stop-color=\"#B1A7FF\"></stop><stop offset=\".5\" stop-color=\"#7A9DFF\"></stop><stop offset=\"1\" stop-color=\"#3941FF\"></stop></linearGradient></defs></svg>", rs = "<svg viewBox=\"0 0 24 24\" aria-hidden=\"true\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M9.064 3.344a4.578 4.578 0 012.285-.312c1 .115 1.891.54 2.673 1.275.01.01.024.017.037.021a.09.09 0 00.043 0 4.55 4.55 0 013.046.275l.047.022.116.057a4.581 4.581 0 012.188 2.399c.209.51.313 1.041.315 1.595a4.24 4.24 0 01-.134 1.223.123.123 0 00.03.115c.594.607.988 1.33 1.183 2.17.289 1.425-.007 2.71-.887 3.854l-.136.166a4.548 4.548 0 01-2.201 1.388.123.123 0 00-.081.076c-.191.551-.383 1.023-.74 1.494-.9 1.187-2.222 1.846-3.711 1.838-1.187-.006-2.239-.44-3.157-1.302a.107.107 0 00-.105-.024c-.388.125-.78.143-1.204.138a4.441 4.441 0 01-1.945-.466 4.544 4.544 0 01-1.61-1.335c-.152-.202-.303-.392-.414-.617a5.81 5.81 0 01-.37-.961 4.582 4.582 0 01-.014-2.298.124.124 0 00.006-.056.085.085 0 00-.027-.048 4.467 4.467 0 01-1.034-1.651 3.896 3.896 0 01-.251-1.192 5.189 5.189 0 01.141-1.6c.337-1.112.982-1.985 1.933-2.618.212-.141.413-.251.601-.33.215-.089.43-.164.646-.227a.098.098 0 00.065-.066 4.51 4.51 0 01.829-1.615 4.535 4.535 0 011.837-1.388zm3.482 10.565a.637.637 0 000 1.272h3.636a.637.637 0 100-1.272h-3.636zM8.462 9.23a.637.637 0 00-1.106.631l1.272 2.224-1.266 2.136a.636.636 0 101.095.649l1.454-2.455a.636.636 0 00.005-.64L8.462 9.23z\" fill=\"currentColor\"/></svg>", is = "M4.709 15.955l4.72-2.647.08-.23-.08-.128H9.2l-.79-.048-2.698-.073-2.339-.097-2.266-.122-.571-.121L0 11.784l.055-.352.48-.321.686.06 1.52.103 2.278.158 1.652.097 2.449.255h.389l.055-.157-.134-.098-.103-.097-2.358-1.596-2.552-1.688-1.336-.972-.724-.491-.364-.462-.158-1.008.656-.722.881.06.225.061.893.686 1.908 1.476 2.491 1.833.365.304.145-.103.019-.073-.164-.274-1.355-2.446-1.446-2.49-.644-1.032-.17-.619a2.97 2.97 0 01-.104-.729L6.283.134 6.696 0l.996.134.42.364.62 1.414 1.002 2.229 1.555 3.03.456.898.243.832.091.255h.158V9.01l.128-1.706.237-2.095.23-2.695.08-.76.376-.91.747-.492.584.28.48.685-.067.444-.286 1.851-.559 2.903-.364 1.942h.212l.243-.242.985-1.306 1.652-2.064.73-.82.85-.904.547-.431h1.033l.76 1.129-.34 1.166-1.064 1.347-.881 1.142-1.264 1.7-.79 1.36.073.11.188-.02 2.856-.606 1.543-.28 1.841-.315.833.388.091.395-.328.807-1.969.486-2.309.462-3.439.813-.042.03.049.061 1.549.146.662.036h1.622l3.02.225.79.522.474.638-.079.485-1.215.62-1.64-.389-3.829-.91-1.312-.329h-.182v.11l1.093 1.068 2.006 1.81 2.509 2.33.127.578-.322.455-.34-.049-2.205-1.657-.851-.747-1.926-1.62h-.128v.17l.444.649 2.345 3.521.122 1.08-.17.353-.608.213-.668-.122-1.374-1.925-1.415-2.167-1.143-1.943-.14.08-.674 7.254-.316.37-.729.28-.607-.461-.322-.747.322-1.476.389-1.924.315-1.53.286-1.9.17-.632-.012-.042-.14.018-1.434 1.967-2.18 2.945-1.726 1.845-.414.164-.717-.37.067-.662.401-.589 2.388-3.036 1.44-1.882.93-1.086-.006-.158h-.055L4.132 18.56l-1.13.146-.487-.456.061-.746.231-.243 1.908-1.312-.006.006z", as = `<svg viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="${is}" fill="#D97757" fill-rule="nonzero"></path></svg>`, os = `<svg viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="${is}" fill="currentColor" fill-rule="nonzero"></path></svg>`, ss = "M21.751 22.607c1.34 1.005 3.35.335 1.508-1.508C17.73 15.74 18.904 1 12.037 1 5.17 1 6.342 15.74.815 21.1c-2.01 2.009.167 2.511 1.507 1.506 5.192-3.517 4.857-9.714 9.715-9.714 4.857 0 4.522 6.197 9.714 9.715z", cs = `<svg viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="${ss}" fill="url(#folio-react-antigravity-gradient)"></path><defs><linearGradient id="folio-react-antigravity-gradient" x1="5" x2="19" y1="22" y2="2" gradientUnits="userSpaceOnUse"><stop stop-color="#3186FF"></stop><stop offset=".42" stop-color="#34A853"></stop><stop offset=".72" stop-color="#FBBC04"></stop><stop offset="1" stop-color="#EA4335"></stop></linearGradient></defs></svg>`, ls = `<svg viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="${ss}" fill="currentColor"></path></svg>`, us = "<svg viewBox=\"0 0 24 24\" fill=\"currentColor\" aria-hidden=\"true\"><path d=\"M9 3c.4 3.9 3.1 6.6 7 7-3.9.4-6.6 3.1-7 7-.4-3.9-3.1-6.6-7-7 3.9-.4 6.6-3.1 7-7z\"/><path d=\"M17.8 13c.25 2.4 1.85 4 4.2 4.25-2.35.25-3.95 1.85-4.2 4.25-.25-2.4-1.85-4-4.2-4.25 2.35-.25 3.95-1.85 4.2-4.25z\" opacity=\".7\"/></svg>", ds = {
	codex: {
		label: "Codex",
		color: "#3941ff",
		logo: ns,
...
function Cs(e) {
	let t = e?.provider && es.has(e.provider) ? e.provider : e?.selectedAdapter || "";
	return e?.adapters?.find((e) => e.id === t) || null;
}
function ws(e) {
	return ds[e?.provider && es.has(e.provider) ? e.provider : e?.selectedAdapter || ""] || ds.default;
}
function Ts(e) {
	return e?.modelChoices || [];
}
...
function Ds({ surface: e, open: t, onOpen: n, onClose: r }) {
	let [i, a] = (0, b.useState)(null), [s, c] = (0, b.useState)(null), [u, d] = (0, b.useState)([ts]), [f, p] = (0, b.useState)(""), [m, h] = (0, b.useState)(""), [g, _] = (0, b.useState)("medium"), [v, y] = (0, b.useState)(!1), [S, C] = (0, b.useState)(""), w = (0, b.useRef)(null), T = (0, b.useRef)({
		ownerSurface: e,
		patch: {}
	...
	let k = (0, b.useCallback)((e, t = !1) => {
		...
		a(e), h((e) => {
			let r = Es(n);
			return t && Ts(n).some((t) => t.value === e) ? e : r;
		});
		...
		try {
			let t = e?.provider && es.has(e.provider) ? e.provider : "", n = t ? `?adapter=${encodeURIComponent(t)}` : "";
	...
	let M = Cs(i), N = ws(i), P = Ts(M), F = (0, b.useMemo)(() => ({ "--react-agent-accent": N.color }), [N.color]), I = (s?.checks || []).filter((e) => !e.ok), L = (0, b.useCallback)(async (t, n = {}) => {
		let r = t.trim();
		if (!r || v) return;
		T.current = bs(T.current, e);
		let i = Ss(window.FolioAgent?.currentContext, T.current, e, n), a = fs(), s = Date.now(), c = new Date(s).toISOString(), l = M?.label || N.label, u = m || M?.model || "model";
		d((e) => [
			...e,
			{
				id: fs(),
							...
							children: [
								e.role === "assistant" && /* @__PURE__ */ (0, x.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, x.jsx)("time", { children: ps(e.createdAt) })
									]
								}),
...
function Fs(e) {
	let t = [
		...
		e.end ? `${e.end} 이전` : "",
		e.source ? e.source : "",
		e.market ? As.find((t) => t.value === e.market)?.label || e.market : "",
		e.country ? js[e.country] || e.country : "",
		e.language ? Ms[e.language] || e.language : ""
	].filter(Boolean);
	return t.length ? t.join(" · ") : "전체 RSS 피드";
}
function Is(e, t) {
	let n = new URLSearchParams({
		offset: String((Math.max(1, e) - 1) * ks),
		limit: String(ks)
	});
...
async function Rs(e) {
	let t = e;
	for (; f(t.status);) await Ns(1e3), t = await l(`/api/jobs/${encodeURIComponent(t.id)}`);
...
function Vs() {
	let [e, t] = (0, b.useState)(null), [n, r] = (0, b.useState)(null), [i, a] = (0, b.useState)(1), [s, c] = (0, b.useState)(Os), [u, d] = (0, b.useState)(Os), [f, p] = (0, b.useState)(""), [m, h] = (0, b.useState)(!1), [g, _] = (0, b.useState)(!1), [v, y] = (0, b.useState)(!1), [S, C] = (0, b.useState)(""), [w, T] = (0, b.useState)(""), E = n?.items || [], D = n?.total ?? E.length, O = Math.max(1, Math.ceil(D / ks)), k = (0, b.useMemo)(() => n?.sources || [], [n?.sources]), A = (0, b.useMemo)(() => n?.countries || [], [n?.countries]), j = (0, b.useMemo)(() => n?.languages || [], [n?.languages]), M = (0, b.useCallback)(async (e = i, t = s) => {
		h(!0), C("");
		try {
			let n = Is(e, t), i = await l(`/api/rss/items?${n.toString()}`);
	...
	async function L() {
		...
		try {
			let e = await Rs(await o("/api/rssarchive/import", {})), t = Number.isFinite(Number(e.result?.added)) ? ` 신규 ${e.result?.added}개` : "";
	...
	return /* @__PURE__ */ (0, x.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, x.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, x.jsx)("strong", { children: Fs(s) }), /* @__PURE__ */ (0, x.jsx)("span", { children: D > 0 ? `${D}개 · ${R}/${O}` : "0개" })]
			}),
			S && /* @__PURE__ */ (0, x.jsx)("p", {
				className: "react-dashboard-error",
				children: S
							...
							children: [
								...
								/* @__PURE__ */ (0, x.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, x.jsx)("span", { children: Ps(e) })
									]
								}),
...
var Hs = "folio.homePreference.v1", Us = "folio.agentCharacter.v1", Ws = "folio.motionPreference.v1", Gs = "folio:ui-preferences-updated", Ks = {
	home: {
		mode: "home",
		choiceSeen: !0
	},
...
function Ys() {
	let e = Js(qs(Hs)), t = Js(qs(Us)), n = qs(Ws);
	return {
		home: {
...
function Zs(e) {
	typeof window > "u" || window.dispatchEvent(new CustomEvent(Gs, { detail: e }));
}
function Qs(e) {
	return Xs(Hs, e.home), Xs(Us, e.character), Xs(Ws, e.motion), Zs(e), e;
}
function $s() {
	if (typeof window < "u") try {
		window.localStorage.removeItem(Hs), window.localStorage.removeItem(Us), window.localStorage.removeItem(Ws);
	} catch {}
	let e = structuredClone(Ks);
	return Zs(e), e;
}
function ec(e = Ys()) {
	return "home";
...
function tc() {
	let [e, t] = (0, b.useState)(() => Ys());
	(0, b.useEffect)(() => {
		let e = (e) => {
			let n = e.detail;
			t(n || Ys());
		}, n = () => t(Ys());
		return window.addEventListener(Gs, e), window.addEventListener("storage", n), () => {
			window.removeEventListener(Gs, e), window.removeEventListener("storage", n);
		};
	}, []);
	function n(e) {
		t(e), Qs(e);
...
function dc({ checked: e, onChange: t, label: n, ariaLabel: r, compact: i = !1 }) {
...
function fc() {
	let e = p(), t = tc(), [n, r] = (0, b.useState)("integrations"), [i, a] = (0, b.useState)(null), [s, c] = (0, b.useState)(null), [u, d] = (0, b.useState)({}), [f, m] = (0, b.useState)({}), [h, g] = (0, b.useState)(null), [_, v] = (0, b.useState)("openai"), [y, S] = (0, b.useState)(""), [C, w] = (0, b.useState)(""), [T, E] = (0, b.useState)(!0), [D, O] = (0, b.useState)("cli"), [k, A] = (0, b.useState)("codex"), [j, M] = (0, b.useState)(""), [N, P] = (0, b.useState)({
		fred: "",
		bok: "",
		dart: ""
	}), [F, I] = (0, b.useState)({
		token: "",
		dbId: ""
	}), [L, R] = (0, b.useState)(""), [z, B] = (0, b.useState)({}), [V, H] = (0, b.useState)(""), [U, W] = (0, b.useState)(""), [G, K] = (0, b.useState)(""), q = i?.llm?.providers || {}, ee = q[_] || {}, te = oc[_], ne = ee.modelChoices || [], re = s?.adapters || [], ie = (re.find((e) => e.id === k) || re[0])?.modelChoices || [], ae = (0, b.useCallback)(async (e = !1) => {
		K(""), W("load");
		try {
			...
			M(h.some((e) => e.value === p?.model) ? String(p?.model || "") : h[0]?.value || ""), window.dispatchEvent(new CustomEvent("folio:agent-settings-updated", { detail: n })), d(Q(r)), m(i), R(i.vaultPath || ""), Te("settings", {
				surface: "settings",
				viewId: "settings",
				reportKind: "",
				reportId: ""
	...
	async function pe() {
		...
		try {
			let e = await o("/api/automation/settings", Q(u));
			d(Q(e)), H("자동화 설정을 저장했습니다.");
		} catch (e) {
								...
								children: D === "cli" ? /* @__PURE__ */ (0, x.jsxs)(x.Fragment, { children: [/* @__PURE__ */ (0, x.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, x.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, x.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, x.jsx)("strong", { children: e.label || e.id }), /* @__PURE__ */ (0, x.jsx)("span", {
													className: `cli-status-chip ${uc(e)}`,
													children: lc(e)
												})]
											}), /* @__PURE__ */ (0, x.jsx)("div", {
									...
									/* @__PURE__ */ (0, x.jsxs)("label", {
										...
										children: [/* @__PURE__ */ (0, x.jsx)("span", { children: "API 제공자" }), /* @__PURE__ */ (0, x.jsxs)("select", {
											value: _,
											onChange: (e) => v(sc(e.currentTarget.value)),
											children: [
												/* @__PURE__ */ (0, x.jsx)("option", {
													value: "openai",
													children: "GPT / OpenAI"
									...
									/* @__PURE__ */ (0, x.jsx)("div", {
										...
										children: me.map(({ providerId: e, row: t, label: n, className: r, detail: i }) => /* @__PURE__ */ (0, x.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, x.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, x.jsxs)("div", {
													className: "cli-provider-head",
													children: [/* @__PURE__ */ (0, x.jsx)("strong", { children: t.label || oc[e].name }), /* @__PURE__ */ (0, x.jsx)("span", {
							...
							/* @__PURE__ */ (0, x.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, x.jsxs)("label", {
									...
									children: [/* @__PURE__ */ (0, x.jsx)("span", { children: "FRED 상태" }), /* @__PURE__ */ (0, x.jsx)("p", {
										className: "section-subtitle",
										children: cc(i?.fred?.hasApiKey, i?.fred?.apiKeyMasked, "딥 리서치 미국 경제지표용 FRED API 키가 없습니다.", "FRED API 키")
									})]
								})]
							}),
							/* @__PURE__ */ (0, x.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, x.jsxs)("label", {
									...
									children: [/* @__PURE__ */ (0, x.jsx)("span", { children: "BOK 상태" }), /* @__PURE__ */ (0, x.jsx)("p", {
										className: "section-subtitle",
										children: cc(i?.bok?.hasApiKey, i?.bok?.apiKeyMasked, "딥 리서치 한국 경제지표용 BOK API 키가 없습니다.", "BOK API 키")
									})]
								})]
							}),
							/* @__PURE__ */ (0, x.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, x.jsxs)("label", {
									...
									children: [/* @__PURE__ */ (0, x.jsx)("span", { children: "DART 상태" }), /* @__PURE__ */ (0, x.jsx)("p", {
										className: "section-subtitle",
										children: cc(i?.dart?.hasApiKey, i?.dart?.apiKeyMasked, "국내 기업 분석용 DART API 키가 없습니다.", "DART API 키")
									})]
								})]
							}),
							/* @__PURE__ */ (0, x.jsx)("div", {
								...
								children: [
									/* @__PURE__ */ (0, x.jsxs)("section", {
										...
										children: [
											...
											/* @__PURE__ */ (0, x.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, x.jsx)("span", { children: "기사 전문 저장 (무료 공개 본문만, 로컬 보관용)" }), /* @__PURE__ */ (0, x.jsx)(dc, {
													ariaLabel: "기사 전문 저장",
									...
									/* @__PURE__ */ (0, x.jsxs)("section", {
										...
										children: [
											...
											/* @__PURE__ */ (0, x.jsxs)("div", {
												className: "automation-inline-switch",
												children: [/* @__PURE__ */ (0, x.jsx)("span", { children: "RSS 수집 직후에도 정리" }), /* @__PURE__ */ (0, x.jsx)(dc, {
									...
									/* @__PURE__ */ (0, x.jsxs)("section", {
										...
										children: [
											...
											/* @__PURE__ */ (0, x.jsxs)("div", {
												className: "automation-inline-switch",
												children: [/* @__PURE__ */ (0, x.jsx)("span", { children: "브리핑 전 RSS/Memory 실행" }), /* @__PURE__ */ (0, x.jsx)(dc, {
...
function hc({ signals: e, providers: t }) {
				...
				children: e.map((e) => /* @__PURE__ */ (0, x.jsxs)("li", { children: [
					/* @__PURE__ */ (0, x.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, x.jsx)("span", { children: e.sourceStatus === "delayed" ? "지연 수신" : mc[e.signalStatus || ""] || "확인 전" }),
							/* @__PURE__ */ (0, x.jsx)("time", { children: pc(e.providerPublishedAt) })
						]
					}),
					e.url ? /* @__PURE__ */ (0, x.jsx)("a", {
						href: e.url,
					...
					/* @__PURE__ */ (0, x.jsxs)("small", { children: ["수신 ", pc(e.receivedAt)] })
...
function yc(e) {
	return e.companyName || e.name || e.item || vc(e);
}
function bc(e, t = "") {
...
function Oc() {
	let { resolved: e } = p(), [t, n] = (0, b.useState)([]), [r, i] = (0, b.useState)([]), [a, s] = (0, b.useState)(""), [c, u] = (0, b.useState)(() => Ec()), [d, f] = (0, b.useState)(null), [m, h] = (0, b.useState)(!1), [g, _] = (0, b.useState)(!1), [v, y] = (0, b.useState)(!1), [S, C] = (0, b.useState)(""), [w, T] = (0, b.useState)(""), E = (0, b.useRef)(null), D = (0, b.useCallback)(async (e) => {
		if (!e.length) {
			i([]);
			return;
		}
		...
		h(!0), C("");
		try {
			let e = await l("/api/watchlist"), t = _c(Array.isArray(e) ? e : []);
	...
	async function k(e, t) {
		y(!0), C("");
		try {
			let r = await o("/api/watchlist", { items: e }), i = _c(Array.isArray(r) ? r : []);
			n(i), await D(i), t && T(t);
		} catch (e) {
	...
	async function M(e) {
		await k(t.filter((t) => t !== e), "워치리스트에서 삭제했습니다."), c === e && Tc();
	}
	let N = (0, b.useMemo)(() => Sc(d?.news || []), [d]), P = bc(d, c);
				...
				children: [
					/* @__PURE__ */ (0, x.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, x.jsxs)("div", { children: [
							...
							children: [/* @__PURE__ */ (0, x.jsx)(gc, { item: c }), /* @__PURE__ */ (0, x.jsx)("button", {
								className: "icon-btn",
								type: "button",
								"aria-label": "닫기",
								"data-tooltip": "닫기",
							...
							children: N.map((e, t) => /* @__PURE__ */ (0, x.jsxs)("article", {
								...
								children: [
									...
									/* @__PURE__ */ (0, x.jsx)("h4", { children: e.url ? /* @__PURE__ */ (0, x.jsx)("a", {
										...
										rel: "noopener noreferrer",
										children: Cc(e)
									}) : /* @__PURE__ */ (0, x.jsx)("span", { children: Cc(e) }) }),
									e.snippet && /* @__PURE__ */ (0, x.jsx)("p", { children: e.snippet })
								]
							}, `${Cc(e)}-${t}`))
						}) : /* @__PURE__ */ (0, x.jsx)("p", {
			...
			/* @__PURE__ */ (0, x.jsx)("div", {
				...
				children: r.length ? r.map((e) => {
					...
					return /* @__PURE__ */ (0, x.jsxs)("article", {
						...
						onClick: () => Tc(t),
						onKeyDown: (e) => {
							(e.key === "Enter" || e.key === " ") && (e.preventDefault(), Tc(t));
						},
						children: [
							/* @__PURE__ */ (0, x.jsx)("span", {
							...
							/* @__PURE__ */ (0, x.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, x.jsx)("strong", {
									...
									children: vc(e)
								}), /* @__PURE__ */ (0, x.jsx)("h3", { children: yc(e) })]
							}),
							/* @__PURE__ */ (0, x.jsxs)("div", {
...
function zc() {
	let { hash: e, routeId: t } = Lc(), n = Kr(t), r = ec(tc().preferences), i = jc(), [a, o] = (0, b.useState)(() => localStorage.getItem("folio.react.navCollapsed") === "1"), s = (0, b.useRef)(!1), [c, l] = (0, b.useState)(() => {
		let e = localStorage.getItem("folio.react.agentClosed"), t = e === null || e !== "1";
		return t && Fc() ? (s.current = !0, !1) : t;
	}), [u, d] = (0, b.useState)(() => /* @__PURE__ */ new Set([t])), [f, p] = (0, b.useState)(() => ({ [t]: Ic() })), [m, h] = (0, b.useState)(""), [g, _] = (0, b.useState)(!1), v = (0, b.useRef)(null), y = (0, b.useRef)(t), S = (0, b.useRef)(!1), C = (0, b.useRef)({}), w = n.id !== "home", T = w && c ? " is-agent-open" : " is-agent-closed";
	(0, b.useEffect)(() => {
		Oe(n.id, {
			surface: `react_${n.id}`,
			viewId: n.id
		...
		let e = window.matchMedia(Pc), t = (e) => {
	...
	function O(e) {
		let t = Kr(e);
		return t.id === "home" ? /* @__PURE__ */ (0, x.jsx)(It, {}) : t.id === "dashboard" ? /* @__PURE__ */ (0, x.jsx)(Ga, {}) : t.id === "briefing" ? /* @__PURE__ */ (0, x.jsx)(Br, {}) : t.id === "rss" ? /* @__PURE__ */ (0, x.jsx)(Vs, {}) : t.id === "market-memory" ? /* @__PURE__ */ (0, x.jsx)(Jo, {}) : t.id === "analysis" ? /* @__PURE__ */ (0, x.jsx)(Hi, {}) : t.id === "deep-research" ? /* @__PURE__ */ (0, x.jsx)(ko, {}) : t.id === "watchlist" ? /* @__PURE__ */ (0, x.jsx)(Oc, {}) : t.id === "portfolio" ? /* @__PURE__ */ (0, x.jsx)($o, {}) : t.id === "settings" ? /* @__PURE__ */ (0, x.jsx)(fc, {}) : null;
	}
	return /* @__PURE__ */ (0, x.jsxs)("div", {
			...
			/* @__PURE__ */ (0, x.jsxs)("aside", {
				...
				children: [/* @__PURE__ */ (0, x.jsx)("button", {
					...
					children: [/* @__PURE__ */ (0, x.jsx)("div", {
						...
						children: "Navigate"
					}), Mc.map((e) => /* @__PURE__ */ (0, x.jsxs)("section", {
...
function Bc() {
	return /* @__PURE__ */ (0, x.jsx)(zc, {});
}
//#endregion
//#region src/main.tsx
var $ = { "market-state": () => /* @__PURE__ */ (0, x.jsx)(ma, {}) };
function Vc() {
	document.querySelectorAll("[data-react-island]").forEach((e) => {
		let t = $[e.dataset.reactIsland || ""];
...
function Hc() {
	...
	return e ? e.dataset.reactMounted === "1" || (e.dataset.reactMounted = "1", (0, y.createRoot)(e).render(/* @__PURE__ */ (0, x.jsx)(b.StrictMode, { children: /* @__PURE__ */ (0, x.jsx)(Bc, {}) })), !0) : !1;
}
function Uc() {
	Hc(), Vc();
}
document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", Uc) : Uc();
//#endregion
