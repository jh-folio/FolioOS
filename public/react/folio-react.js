...
function el(e) {
	let t = [
		...
		e.country ? Xc[e.country] || e.country : "",
...
function ol() {
	let { isSelected: e } = gn(), t = dn("rss"), [n, r] = (0, l.useState)(null), [i, a] = (0, l.useState)(null), [o, s] = (0, l.useState)(1), [c, u] = (0, l.useState)(qc), [d, f] = (0, l.useState)(qc), [p, m] = (0, l.useState)(""), [h, g] = (0, l.useState)(!1), [_, v] = (0, l.useState)(!1), [y, b] = (0, l.useState)(!1), [x, S] = (0, l.useState)(""), [C, w] = (0, l.useState)(""), T = i?.items || [], E = i?.total ?? T.length, D = Math.max(1, Math.ceil(E / Jc)), O = (0, l.useMemo)(() => i?.sources || [], [i?.sources]), k = (0, l.useMemo)(() => i?.countries || [], [i?.countries]), A = (0, l.useMemo)(() => i?.languages || [], [i?.languages]), j = (0, l.useCallback)(async (e = o, t = c) => {
		g(!0), S("");
		try {
	...
	return /* @__PURE__ */ (0, K.jsxs)("div", {
		...
		children: [
					...
					children: [
						/* @__PURE__ */ (0, K.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, K.jsx)("span", { children: "시장" }), /* @__PURE__ */ (0, K.jsx)("select", {
								...
								children: Yc.filter((t) => !t.value || e(t.value)).map((e) => /* @__PURE__ */ (0, K.jsx)("option", {
									value: e.value,
									children: e.label
								}, e.value || "all-market"))
							})]
			...
			/* @__PURE__ */ (0, K.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, K.jsx)("strong", { children: el(c) }), /* @__PURE__ */ (0, K.jsx)("span", { children: E > 0 ? `${E}개 · ${R}/${D}` : "0개" })]
			}),
...
function zl() {
	let e = wl(), t = bl(), [n, r] = (0, l.useState)("admin"), [i, a] = (0, l.useState)(null), [o, s] = (0, l.useState)(null), [c, u] = (0, l.useState)({}), [d, f] = (0, l.useState)({}), [p, m] = (0, l.useState)({}), [h, g] = (0, l.useState)(null), [_, v] = (0, l.useState)("openai"), [y, b] = (0, l.useState)(""), [x, S] = (0, l.useState)(""), [C, w] = (0, l.useState)(!0), [T, E] = (0, l.useState)("cli"), [D, O] = (0, l.useState)("codex"), [k, A] = (0, l.useState)(""), [j, M] = (0, l.useState)({
		...
		token: "",
		dbId: ""
	}), [F, I] = (0, l.useState)(""), [L, R] = (0, l.useState)({}), [z, H] = (0, l.useState)(""), [U, W] = (0, l.useState)(""), [ee, G] = (0, l.useState)(""), te = i?.llm?.providers || {}, ne = te[_] || {}, re = kl[_], ie = ne.modelChoices || [], ae = o?.adapters || [], oe = (ae.find((e) => e.id === D) || ae[0])?.modelChoices || [], se = [
		"codex",
		"claude",
		"antigravity"
	].includes(o?.provider || "") ? String(o?.provider) : String(o?.selectedAdapter || ae[0]?.id || "codex"), ce = ae.find((e) => e.id === se) || ae[0], le = C !== (i?.agent?.enabled !== !1) || T !== (i?.agent?.mode === "api" ? "api" : "cli") || D !== se || k !== jl(ce?.model, ce?.modelChoices) || _ !== Al(i?.llm?.provider) || x !== jl(ne.model, ne.modelChoices) || y.trim() !== "", ue = !!(j.fred.trim() || j.bok.trim() || j.dart.trim()), de = !!N.token.trim() || N.dbId.trim() !== String(i?.notion?.dbId || "").trim(), fe = F.trim() !== String(p.vaultPath || "").trim(), pe = JSON.stringify(Z(c)) !== JSON.stringify(Z(d)), me = (0, l.useCallback)(async (e = !1) => {
		G(""), W("load");
		try {
			...
			A(h.some((e) => e.value === p?.model) ? String(p?.model || "") : h[0]?.value || ""), window.dispatchEvent(new CustomEvent("folio:agent-settings-updated", { detail: n })), u(Z(r)), f(Z(r)), m(i), I(i.vaultPath || ""), q("settings", {
				surface: "settings",
				viewId: "settings",
				reportKind: "",
				reportId: ""
	...
	async function ge() {
		...
		try {
			...
			g(t), H(e.deleted ? `캐시 정리 완료: ${e.deleted}개 삭제, ${e.freed_mb || 0}MB 확보` : "정리할 오래된 캐시가 없습니다. 보관 기간이 지난 파일만 지웁니다.");
		} catch (e) {
	...
	async function _e() {
		...
		try {
			...
			s(t), a(n), b(""), R((e) => {
				let t = { ...e };
				return delete t[_], t;
			}), window.dispatchEvent(new CustomEvent("folio:agent-settings-updated", { detail: t })), H(C ? `AI Agent를 ${T === "cli" ? "LLM CLI" : "LLM API"} 모드로 저장했습니다.` : "AI Agent 생성을 비활성화했습니다.");
		} catch (e) {
	...
	async function xe() {
		...
		try {
			let e = await V("/api/obsidian/settings", { vaultPath: F.trim() });
			m(e), I(e.vaultPath || F), H(e.vaultPath ? "Obsidian 경로를 저장했습니다." : "Vault 경로를 입력하세요.");
		} catch (e) {
	...
	let Ce = (0, l.useMemo)(() => Ol.map((e) => {
		let t = te[e] || {}, n = L[e], r = n?.checking;
		return {
			providerId: e,
			row: t,
				...
				children: [
					/* @__PURE__ */ (0, K.jsxs)("section", {
						...
						children: [
							...
							/* @__PURE__ */ (0, K.jsx)("fieldset", {
								...
								disabled: !C,
								children: T === "cli" ? /* @__PURE__ */ (0, K.jsxs)(K.Fragment, { children: [/* @__PURE__ */ (0, K.jsxs)("div", {
									className: "settings-grid",
									children: [/* @__PURE__ */ (0, K.jsxs)("label", {
										className: "field",
										...
										children: [/* @__PURE__ */ (0, K.jsx)("span", { children: "모델" }), /* @__PURE__ */ (0, K.jsx)("select", {
											...
											children: oe.length ? oe.map((e) => /* @__PURE__ */ (0, K.jsx)("option", {
												value: e.value,
												children: e.label
											}, e.value)) : /* @__PURE__ */ (0, K.jsx)("option", {
												value: "",
									...
									/* @__PURE__ */ (0, K.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, K.jsxs)("label", {
											className: "field",
											children: [/* @__PURE__ */ (0, K.jsxs)("span", { children: [re.name, " API Key"] }), /* @__PURE__ */ (0, K.jsx)("input", {
												value: y,
												onChange: (e) => b(e.currentTarget.value),
												type: "password",
												autoComplete: "off",
											...
											className: "field",
											children: [/* @__PURE__ */ (0, K.jsxs)("span", { children: [re.name, " Model"] }), /* @__PURE__ */ (0, K.jsx)("select", {
												value: x,
												onChange: (e) => S(e.currentTarget.value),
									...
									/* @__PURE__ */ (0, K.jsx)("div", {
										className: "cli-provider-list",
										"aria-live": "polite",
										children: Ce.map(({ providerId: e, row: t, label: n, className: r, detail: i }) => /* @__PURE__ */ (0, K.jsxs)("div", {
											className: "cli-provider-row",
											children: [/* @__PURE__ */ (0, K.jsxs)("div", {
												className: "cli-provider-main",
												children: [/* @__PURE__ */ (0, K.jsxs)("div", {
													className: "cli-provider-head",
													children: [/* @__PURE__ */ (0, K.jsx)("strong", { children: t.label || kl[e].name }), /* @__PURE__ */ (0, K.jsx)("span", {
							...
							/* @__PURE__ */ (0, K.jsxs)("div", {
								className: "filter-actions settings-actions",
								children: [
									le && !U && /* @__PURE__ */ (0, K.jsx)("span", {
										className: "settings-dirty-hint",
										children: "저장 안 된 변경"
									}),
									/* @__PURE__ */ (0, K.jsx)("button", {
										className: le && !U ? "btn btn--primary" : "btn",
										type: "button",
										onClick: _e,
										disabled: U === "agent",
					...
					/* @__PURE__ */ (0, K.jsxs)("section", {
						...
						children: [
							...
							/* @__PURE__ */ (0, K.jsxs)("div", {
								className: "filter-actions settings-actions",
								children: [ue && !U && /* @__PURE__ */ (0, K.jsx)("span", {
									className: "settings-dirty-hint",
									children: "저장 안 된 변경"
								}), /* @__PURE__ */ (0, K.jsx)("button", {
									className: ue && !U ? "btn btn--primary" : "btn",
									type: "button",
									onClick: ye,
									disabled: U === "api",
									children: "API 설정 저장"
					...
					/* @__PURE__ */ (0, K.jsxs)("section", {
						...
						children: [
							...
							/* @__PURE__ */ (0, K.jsxs)("div", {
								className: "filter-actions settings-actions",
								children: [de && !U && /* @__PURE__ */ (0, K.jsx)("span", {
									className: "settings-dirty-hint",
									children: "저장 안 된 변경"
								}), /* @__PURE__ */ (0, K.jsx)("button", {
									className: de && !U ? "btn btn--primary" : "btn",
									type: "button",
									onClick: be,
									disabled: U === "notion",
					...
					/* @__PURE__ */ (0, K.jsxs)("section", {
						...
						children: [
							...
							/* @__PURE__ */ (0, K.jsxs)("div", {
								className: "filter-actions settings-actions",
								children: [fe && !U && /* @__PURE__ */ (0, K.jsx)("span", {
									className: "settings-dirty-hint",
									children: "저장 안 된 변경"
								}), /* @__PURE__ */ (0, K.jsx)("button", {
									className: fe && !U ? "btn btn--primary" : "btn",
									type: "button",
									onClick: xe,
									disabled: U === "obsidian",
				...
				children: [
					...
					/* @__PURE__ */ (0, K.jsxs)("section", {
						...
						children: [
								...
								children: [
									/* @__PURE__ */ (0, K.jsxs)("section", {
										...
										children: [
											...
											/* @__PURE__ */ (0, K.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, K.jsx)("span", { children: "기사 전문 저장 (무료 공개 본문만, 로컬 보관용)" }), /* @__PURE__ */ (0, K.jsx)(Fl, {
													ariaLabel: "기사 전문 저장",
									...
									/* @__PURE__ */ (0, K.jsxs)("section", {
										...
										children: [
											...
											/* @__PURE__ */ (0, K.jsxs)("div", {
												className: "automation-inline-switch",
												children: [/* @__PURE__ */ (0, K.jsx)("span", { children: "RSS 수집 직후에도 정리" }), /* @__PURE__ */ (0, K.jsx)(Fl, {
									...
									/* @__PURE__ */ (0, K.jsxs)("section", {
										...
										children: [
												...
												children: [
													...
													/* @__PURE__ */ (0, K.jsxs)("label", {
														...
														children: [/* @__PURE__ */ (0, K.jsx)("span", { children: "브리핑 유형" }), /* @__PURE__ */ (0, K.jsx)("select", {
															...
															children: Object.entries(Q).map(([e, t]) => /* @__PURE__ */ (0, K.jsx)("option", {
																value: e,
																children: t
															}, e))
														})]
											...
											/* @__PURE__ */ (0, K.jsxs)("div", {
												className: "automation-inline-switch",
												children: [/* @__PURE__ */ (0, K.jsx)("span", { children: "브리핑 전 RSS/Memory 실행" }), /* @__PURE__ */ (0, K.jsx)(Fl, {
							...
							/* @__PURE__ */ (0, K.jsxs)("div", {
								className: "filter-actions settings-actions",
								children: [pe && !U && /* @__PURE__ */ (0, K.jsx)("span", {
									className: "settings-dirty-hint",
									children: "저장 안 된 변경"
								}), /* @__PURE__ */ (0, K.jsx)("button", {
									className: pe && !U ? "btn btn--primary" : "btn",
									type: "button",
									onClick: Se,
					...
					/* @__PURE__ */ (0, K.jsxs)("section", {
						...
						children: [
							...
							/* @__PURE__ */ (0, K.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, K.jsxs)("section", { children: [/* @__PURE__ */ (0, K.jsx)("span", { children: "전체 캐시" }), /* @__PURE__ */ (0, K.jsx)("strong", { children: h ? `${h.total_mb || 0} MB` : "상태 미확인" })] }), /* @__PURE__ */ (0, K.jsxs)("section", { children: [/* @__PURE__ */ (0, K.jsx)("span", { children: "정리 대상" }), /* @__PURE__ */ (0, K.jsx)("strong", { children: h ? `${h.stale_mb || 0} MB` : "상태 미확인" })] })]
							}),
							h?.stats?.length ? /* @__PURE__ */ (0, K.jsx)("div", {
								className: "cache-list",
								children: h.stats.map((e) => /* @__PURE__ */ (0, K.jsxs)("div", {
									className: "cache-row",
									children: [
...
function Ul(e) {
	return e.companyName || e.name || e.item || Hl(e);
}
function Wl(e, t = "") {
...
function Ql() {
	let { resolved: e } = wl(), [t, n] = (0, l.useState)([]), [r, i] = (0, l.useState)([]), [a, o] = (0, l.useState)(""), [s, c] = (0, l.useState)(() => Xl()), [u, d] = (0, l.useState)(null), [f, p] = (0, l.useState)(!1), [m, h] = (0, l.useState)(!1), [g, _] = (0, l.useState)(!1), [v, y] = (0, l.useState)(""), [b, x] = (0, l.useState)(""), S = (0, l.useRef)(null), C = (0, l.useCallback)(async (e) => {
		if (!e.length) {
			i([]);
			return;
		}
		...
		p(!0), y("");
		try {
			let e = await B("/api/watchlist"), t = Vl(Array.isArray(e) ? e : []);
	...
	async function T(e, t) {
		_(!0), y("");
		try {
			let r = await V("/api/watchlist", { items: e }), i = Vl(Array.isArray(r) ? r : []);
			n(i), await C(i), t && x(t);
		} catch (e) {
	...
	async function N(e) {
		await T(t.filter((t) => t !== e), "워치리스트에서 삭제했습니다."), s === e && Yl();
	}
	let P = (0, l.useMemo)(() => Kl(u?.news || []), [u]), F = Wl(u, s);
				...
				children: [
					/* @__PURE__ */ (0, K.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, K.jsxs)("div", { children: [
							...
							children: [/* @__PURE__ */ (0, K.jsx)(Bl, { item: s }), /* @__PURE__ */ (0, K.jsx)("button", {
								className: "btn btn--icon",
								type: "button",
								"aria-label": "닫기",
								"data-tooltip": "닫기",
							...
							children: P.map((e, t) => /* @__PURE__ */ (0, K.jsxs)("article", {
								...
								children: [
									...
									/* @__PURE__ */ (0, K.jsx)("h4", { children: e.url ? /* @__PURE__ */ (0, K.jsx)("a", {
										...
										rel: "noopener noreferrer",
										children: ql(e)
									}) : /* @__PURE__ */ (0, K.jsx)("span", { children: ql(e) }) }),
									e.snippet && /* @__PURE__ */ (0, K.jsx)("p", { children: e.snippet })
								]
							}, `${ql(e)}-${t}`))
						}) : /* @__PURE__ */ (0, K.jsx)("p", {
			...
			/* @__PURE__ */ (0, K.jsx)("div", {
				...
				children: r.length ? r.map((e) => {
					...
					return /* @__PURE__ */ (0, K.jsxs)("article", {
						...
						onClick: () => Yl(t),
						onKeyDown: (e) => {
							(e.key === "Enter" || e.key === " ") && (e.preventDefault(), Yl(t));
						},
						children: [
							/* @__PURE__ */ (0, K.jsx)("span", {
							...
							/* @__PURE__ */ (0, K.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, K.jsx)("strong", {
									...
									children: Hl(e)
								}), /* @__PURE__ */ (0, K.jsx)("h3", { children: Ul(e) })]
							}),
							/* @__PURE__ */ (0, K.jsxs)("div", {
...
function au() {
	return typeof window < "u" && window.matchMedia(iu).matches;
}
function ou() {
...
function lu() {
	let { hash: e, routeId: t } = su(), n = ki(t), r = yl(bl().preferences), i = tu(), [a, o] = (0, l.useState)(() => localStorage.getItem("folio.react.navCollapsed") === "1"), s = (0, l.useRef)(!1), [c, u] = (0, l.useState)(() => {
		let e = localStorage.getItem("folio.react.agentClosed"), t = e === null || e !== "1";
		return t && au() ? (s.current = !0, !1) : t;
	}), [d, f] = (0, l.useState)(() => /* @__PURE__ */ new Set([t])), [p, m] = (0, l.useState)(() => ({ [t]: ou() })), [h, g] = (0, l.useState)(""), [_, v] = (0, l.useState)(!1), y = (0, l.useRef)(null), b = (0, l.useRef)(t), x = (0, l.useRef)(!1), S = (0, l.useRef)({}), C = n.id !== "home", w = C && c ? " is-agent-open" : " is-agent-closed";
	(0, l.useEffect)(() => {
		tt(n.id, {
			surface: `react_${n.id}`,
			viewId: n.id
		...
		let e = window.matchMedia(iu), t = (e) => {
			...
			/* @__PURE__ */ (0, K.jsxs)("aside", {
				...
				children: [/* @__PURE__ */ (0, K.jsx)("button", {
					...
					children: [/* @__PURE__ */ (0, K.jsx)("div", {
						...
						children: "Navigate"
					}), nu.map((e) => /* @__PURE__ */ (0, K.jsxs)("section", {
...
function _u({ onFinish: e }) {
	...
	}, j = uu.indexOf(n), M = fu.find((e) => e.id === f);
	return /* @__PURE__ */ (0, K.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, K.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, K.jsx)("div", {
					...
					"aria-label": "진행 단계",
					"aria-valuemin": 1,
					"aria-valuemax": uu.length,
					"aria-valuenow": j + 1,
					style: { "--welcome-fill": `${(j + 1) / uu.length * 100}%` }
				}),
				/* @__PURE__ */ (0, K.jsxs)("section", {
					...
					children: [
						/* @__PURE__ */ (0, K.jsxs)("p", {
							...
							children: [/* @__PURE__ */ (0, K.jsx)(gu, { step: n }), hu[n]]
						}),
						...
						n === "engine" && /* @__PURE__ */ (0, K.jsxs)(K.Fragment, { children: [
							...
							u === "api" && /* @__PURE__ */ (0, K.jsxs)(K.Fragment, { children: [
								/* @__PURE__ */ (0, K.jsx)("div", {
									...
									role: "group",
									"aria-label": "제공사",
									children: fu.map((e) => /* @__PURE__ */ (0, K.jsx)("button", {
										type: "button",
										"aria-pressed": f === e.id,
										onClick: () => p(e.id),
										children: e.label
...
function vu() {
	...
	}, []), /* @__PURE__ */ (0, K.jsxs)(K.Fragment, { children: [/* @__PURE__ */ (0, K.jsx)(lu, {}), e && /* @__PURE__ */ (0, K.jsx)(_u, { onFinish: () => t(!1) })] });
}
//#endregion
//#region src/main.tsx
var yu = { "market-state": () => /* @__PURE__ */ (0, K.jsx)(As, {}) };
function bu() {
	document.querySelectorAll("[data-react-island]").forEach((e) => {
		let t = yu[e.dataset.reactIsland || ""];
...
function xu() {
	...
	return e ? e.dataset.reactMounted === "1" || (e.dataset.reactMounted = "1", (0, u.createRoot)(e).render(/* @__PURE__ */ (0, K.jsx)(l.StrictMode, { children: /* @__PURE__ */ (0, K.jsx)(vu, {}) })), !0) : !1;
}
function Su() {
	xu(), bu();
}
document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", Su) : Su();
//#endregion
