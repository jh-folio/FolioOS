import { B as e, O as t, P as n, R as r, z as i } from "./Geometry-DGpI5VLa.js";
import { c as a, o, s, v as c } from "./Filter-DdWkiyJx.js";
...
var l = class {
	...
	_attachObserver() {
		...
		}), this._observer.observe(this._canvas)) : this._tickerAttached || o.shared.add(this.updateTranslation, this, s.HIGH);
	}
	destroy() {
...
}, d = /iPhone/i, f = /iPod/i, p = /iPad/i, m = /\biOS-universal(?:.+)Mac\b/i, h = /\bAndroid(?:.+)Mobile\b/i, g = /Android/i, _ = /(?:SD4930UR|\bSilk(?:.+)Mobile\b)/i, v = /Silk/i, y = /Windows Phone/i, b = /\bWindows(?:.+)ARM\b/i, x = /BlackBerry/i, S = /BB10/i, C = /Opera Mini/i, w = /\b(CriOS|Chrome)(?:.+)Mobile/i, T = /Mobile(?:.+)Firefox\b/i, E = function(e) {
...
function O(e) {
	...
	var i = D(n), a = {
		apple: {
			phone: i(d) && !i(y),
			ipod: i(f),
			tablet: !i(d) && (i(p) || E(t)) && !i(y),
			universal: i(m),
			device: (i(d) || i(f) || i(p) || i(m) || E(t)) && !i(y)
		},
		amazon: {
			phone: i(_),
			tablet: !i(_) && i(v),
		...
		android: {
			phone: !i(y) && i(_) || !i(y) && i(h),
			tablet: !i(y) && !i(_) && !i(h) && (i(v) || i(g)),
			device: !i(y) && (i(_) || i(v) || i(h) || i(g)) || i(/\bokhttp\b/i)
		},
		windows: {
			phone: i(y),
			tablet: i(b),
...
var k = (O.default ?? O)(globalThis.navigator), A = 9, j = 100, M = 0, N = 0, P = 2, F = 1, I = -1e3, L = -1e3, R = 2, z = class e {
	constructor(e, t = k) {
	...
	_createTouchHook() {
		...
		e.style.width = `${F}px`, e.style.height = `${F}px`, e.style.position = "absolute", e.style.top = `${I}px`, e.style.left = `${L}px`, e.style.zIndex = R.toString(), e.style.backgroundColor = "#FF0000", e.title = "select to enable accessibility for this content", e.addEventListener("focus", () => {
	...
	_activate() {
		...
		this._isActive = !0, this._div || (this._div = document.createElement("div"), this._div.style.position = "absolute", this._div.style.top = `${M}px`, this._div.style.left = `${N}px`, this._div.style.pointerEvents = "none", this._div.style.zIndex = P.toString(), this._canvasObserver = new l({
	...
	postrender() {
		...
		for (let e = this._children.length - 1; e >= 0; e--) {
			...
			t.has(e) || (n._accessibleDiv && n._accessibleDiv.parentNode && (n._accessibleDiv.parentNode.removeChild(n._accessibleDiv), this._getPool(n.accessibleType).push(n._accessibleDiv), n._accessibleDiv = null), n._accessibleActive = !1, c(this._children, e, 1));
		}
	...
	_onKeyDown(e) {
		e.keyCode !== A || !this._activateOnTab || this._activate();
	}
	_onMouseMove(e) {
...
//#endregion
//#region node_modules/pixi.js/lib/dom/init.mjs
V.extension = {
	type: [
		i.WebGLPipes,
		i.WebGPUPipes,
...
var H = new class {
	...
	addTickerListener() {
		this._tickerAdded || !this.domElement || (o.system.add(this._tickerUpdate, this, s.INTERACTION), this._tickerAdded = !0);
	}
...
G.DOM_DELTA_PIXEL = 0, G.DOM_DELTA_LINE = 1, G.DOM_DELTA_PAGE = 2;
//#endregion
//#region node_modules/pixi.js/lib/events/EventBoundary.mjs
var K = 2048, q = new n(), J = new n(), Y = class {
	constructor(e) {
	...
	hitTest(e, t) {
		H.pauseUpdate = !0;
		let n = this._isPointerMoveEvent && this.enableGlobalMoveEvents ? "hitTestMoveRecursive" : "hitTestRecursive", r = this[n](this.rootTarget, this.rootTarget.eventMode, q.set(e, t), this.hitTestFn, this.hitPruneFn);
		return r && r[0];
	}
	propagate(e, t) {
		if (!e.target) return;
	...
	propagationPath(e) {
		let t = [e];
		for (let n = 0; n < K && e !== this.rootTarget && e.parent; n++) {
	...
	hitTestMoveRecursive(e, t, n, r, i, a = !1) {
		...
		if ((e.eventMode === "dynamic" || t === "dynamic") && (H.pauseUpdate = !1), e.interactiveChildren && e.children) {
			let s = e.children;
	...
	hitPruneFn(e, t) {
		if (e.hitArea && (e.worldTransform.applyInverse(t, J), !e.hitArea.contains(J.x, J.y))) return !0;
	...
	hitTestFn(e, t) {
		return e.hitArea ? !0 : e?.containsPoint ? (e.worldTransform.applyInverse(t, J), e.containsPoint(J)) : !1;
	}
	notifyTarget(e, t) {
	...
	mapPointerMove(e) {
		...
		if (a !== n.target) {
			...
			if (!o || o === this.rootTarget.parent) {
				let e = this.clonePointerEvent(n, "pointerenter");
				for (e.eventPhase = e.AT_TARGET; e.target && e.target !== a && e.target !== this.rootTarget.parent;) e.currentTarget = e.target, this.notifyTarget(e), r && this.notifyTarget(e, "mouseenter"), e.target = e.target.parent;
				this.freeEvent(e);
			}
			this.freeEvent(i);
		}
	...
	copyPointerData(e, t) {
		e instanceof W && t instanceof W && (t.pointerId = e.pointerId, t.width = e.width, t.height = e.height, t.isPrimary = e.isPrimary, t.pointerType = e.pointerType, t.pressure = e.pressure, t.tangentialPressure = e.tangentialPressure, t.tiltX = e.tiltX, t.tiltY = e.tiltY, t.twist = e.twist);
	}
	copyMouseData(e, t) {
		e instanceof U && t instanceof U && (t.altKey = e.altKey, t.button = e.button, t.buttons = e.buttons, t.client.copyFrom(e.client), t.ctrlKey = e.ctrlKey, t.metaKey = e.metaKey, t.movement.copyFrom(e.movement), t.screen.copyFrom(e.screen), t.shiftKey = e.shiftKey, t.global.copyFrom(e.global));
	}
	copyData(e, t) {
	...
	constructor(t) {
		this.supportsTouchEvents = "ontouchstart" in globalThis, this.supportsPointerEvents = !!globalThis.PointerEvent, this.domElement = null, this.resolution = 1, this.renderer = t, this.rootBoundary = new Y(null), H.init(this), this.autoPreventDefault = !0, this._eventsAdded = !1, this._rootPointerEvent = new W(null), this._rootWheelEvent = new G(null), this.cursorStyles = {
			default: "inherit",
			pointer: "pointer"
	...
	destroy() {
		H.destroy(), this.setTargetElement(null), this.renderer = null, this._currentCursor = null;
	}
	setCursor(e) {
		e ||= "default";
		let t = !0;
	...
	_onPointerMove(e) {
		...
		this.rootBoundary.rootTarget = this.renderer.lastObjectRendered, H.pointerMoved();
		let t = this._normalizeToPointerData(e);
		for (let e = 0, n = t.length; e < n; e++) {
	...
	setTargetElement(e) {
		this._removeEvents(), this.domElement = e, H.domElement = e, this._addEvents();
	}
	_addEvents() {
	...
	_normalizeToPointerData(e) {
		...
		if (this.supportsTouchEvents && e instanceof TouchEvent) for (let n = 0, r = e.changedTouches.length; n < r; n++) {
			...
			let n = e;
			n.isPrimary === void 0 && (n.isPrimary = !0), n.width === void 0 && (n.width = 1), n.height === void 0 && (n.height = 1), n.tiltX === void 0 && (n.tiltX = 0), n.tiltY === void 0 && (n.tiltY = 0), n.pointerType === void 0 && (n.pointerType = "mouse"), n.pointerId === void 0 && (n.pointerId = X), n.pressure === void 0 && (n.pressure = .5), n.twist === void 0 && (n.twist = 0), n.tangentialPressure === void 0 && (n.tangentialPressure = 0), n.isNormalized = !0, t.push(n);
		} else t.push(e);
		return t;
	}
	...
	_bootstrapEvent(e, t) {
		return e.originalEvent = null, e.nativeEvent = t, e.pointerId = t.pointerId, e.width = t.width, e.height = t.height, e.isPrimary = t.isPrimary, e.pointerType = t.pointerType, e.pressure = t.pressure, e.tangentialPressure = t.tangentialPressure, e.tiltX = t.tiltX, e.tiltY = t.tiltY, e.twist = t.twist, this._transferMouseData(e, t), this.mapPositionToPoint(e.screen, t.clientX, t.clientY), e.global.copyFrom(e.screen), e.offset.copyFrom(e.screen), e.isTrusted = t.isTrusted, e.type === "pointerleave" && (e.type = "pointerout"), e.type.startsWith("mouse") && (e.type = e.type.replace("mouse", "pointer")), e.type.startsWith("touch") && (e.type = Z[e.type] || e.type), e;
	}
...
e.add($), e.mixin(a, {
	...
	get eventMode() {
		return this._internalEventMode ?? $.defaultEventMode;
	},
	set eventMode(e) {
	...
	dispatchEvent(e) {
		if (!(e instanceof u)) throw Error("Container cannot propagate events outside of the Federated Events API");
