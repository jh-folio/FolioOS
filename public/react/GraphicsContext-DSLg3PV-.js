import { A as e, B as t, C as n, E as r, L as i, M as a, N as o, O as s, P as c, R as l, S as u, T as d, b as f, j as p, k as m, m as h, p as g, w as _, z as v } from "./Geometry-BFCE0DPo.js";
import { r as y } from "./canvasUtils-BTqx9q1Z.js";
import { h as b, n as x, t as S } from "./GCManagedHash-CBZAeQ_B.js";
import { t as C } from "./getTextureBatchBindGroup-CwG9Mz6G.js";
...
var T = class e {
	...
	containsPolygon(e) {
		let t = this.getBounds(D), n = e.getBounds(O);
	...
	strokeContains(e, t, n, r = .5) {
		...
		for (let n = 0; n < c; n += 2) {
			...
			if (w(e, t, r, i, c, l) <= (Math.sign((c - r) * (t - i) - (l - i) * (e - r)) < 0 ? o : a)) return !0;
		}
		return !1;
	}
	getBounds(e) {
	...
	strokeContains(e, t, n, r = .5) {
		...
		return (e >= i - l && e <= i + u || e >= h - u && e <= h + l) && t >= f && t <= f + m || (t >= a - l && t <= a + u || t >= g - u && t <= g + l) && e >= d && e <= d + p ? !0 : e < d && t < f && A(e, t, d, f, c, u, l) || e > h - c && t < f && A(e, t, h - c, f, c, u, l) || e > h - c && t > g - c && A(e, t, h - c, g - c, c, u, l) || e < d && t > g - c && A(e, t, d, g - c, c, u, l);
	}
	toString() {
...
function L(e, t, n, r, i, a) {
	...
	let m = i, h = e.length / 2, g = e.length, _ = m.length / 2, v = s.width / 2, y = v * v, b = s.miterLimit * s.miterLimit, x = e[0], S = e[1], C = e[2], w = e[3], T = 0, E = 0, D = -(S - w), O = x - C, k = 0, A = 0, j = Math.sqrt(D * D + O * O);
	D /= j, O /= j, D *= v, O *= v;
	let L = l, R = (1 - L) * 2, z = L * 2;
	f || (s.cap === "round" ? g += I(x - D * (R - z) * .5, S - O * (R - z) * .5, x - D * R, S - O * R, x + D * z, S + O * z, m, !0) + 2 : s.cap === "square" && (g += F(x, S, D, O, R, z, !0, m))), m.push(x - D * R, S - O * R), m.push(x + D * z, S + O * z);
	for (let t = 1; t < h - 1; ++t) {
		x = e[(t - 1) * 2], S = e[(t - 1) * 2 + 1], C = e[t * 2], w = e[t * 2 + 1], T = e[(t + 1) * 2], E = e[(t + 1) * 2 + 1], D = -(S - w), O = x - C, j = Math.sqrt(D * D + O * O), D /= j, O /= j, D *= v, O *= v, k = -(w - E), A = C - T, j = Math.sqrt(k * k + A * A), k /= j, A /= j, k *= v, A *= v;
		let n = C - x, r = S - w, i = C - T, a = E - w, o = n * i + r * a, c = r * i - a * n, l = c < 0;
		if (Math.abs(c) < .001 * Math.abs(o)) {
			m.push(C - D * R, w - O * R), m.push(C + D * z, w + O * z), o >= 0 && (s.join === "round" ? g += I(C, w, C - D * R, w - O * R, C - k * R, w - A * R, m, !1) + 4 : g += 2, m.push(C - k * z, w - A * z), m.push(C + k * R, w + A * R));
			continue;
		}
		let u = (-D + x) * (-O + w) - (-D + C) * (-O + S), d = (-k + T) * (-A + w) - (-k + C) * (-A + E), f = (n * d - i * u) / c, p = (a * u - r * d) / c, h = (f - C) * (f - C) + (p - w) * (p - w), _ = C + (f - C) * R, M = w + (p - w) * R, N = C - (f - C) * z, P = w - (p - w) * z, F = Math.min(n * n + r * r, i * i + a * a), L = l ? R : z;
		h <= F + L * L * y ? s.join === "bevel" || h / y > b ? (l ? (m.push(_, M), m.push(C + D * z, w + O * z), m.push(_, M), m.push(C + k * z, w + A * z)) : (m.push(C - D * R, w - O * R), m.push(N, P), m.push(C - k * R, w - A * R), m.push(N, P)), g += 2) : s.join === "round" ? l ? (m.push(_, M), m.push(C + D * z, w + O * z), g += I(C, w, C + D * z, w + O * z, C + k * z, w + A * z, m, !0) + 4, m.push(_, M), m.push(C + k * z, w + A * z)) : (m.push(C - D * R, w - O * R), m.push(N, P), g += I(C, w, C - D * R, w - O * R, C - k * R, w - A * R, m, !1) + 4, m.push(C - k * R, w - A * R), m.push(N, P)) : (m.push(_, M), m.push(N, P)) : (m.push(C - D * R, w - O * R), m.push(C + D * z, w + O * z), s.join === "round" ? l ? g += I(C, w, C + D * z, w + O * z, C + k * z, w + A * z, m, !0) + 2 : g += I(C, w, C - D * R, w - O * R, C - k * R, w - A * R, m, !1) + 2 : s.join === "miter" && h / y <= b && (l ? (m.push(N, P), m.push(N, P)) : (m.push(_, M), m.push(_, M)), g += 2), m.push(C - k * R, w - A * R), m.push(C + k * z, w + A * z), g += 2);
	}
	x = e[(h - 2) * 2], S = e[(h - 2) * 2 + 1], C = e[(h - 1) * 2], w = e[(h - 1) * 2 + 1], D = -(S - w), O = x - C, j = Math.sqrt(D * D + O * O), D /= j, O /= j, D *= v, O *= v, m.push(C - D * R, w - O * R), m.push(C + D * z, w + O * z), f || (s.cap === "round" ? g += I(C - D * (R - z) * .5, w - O * (R - z) * .5, C - D * R, w - O * R, C + D * z, w + O * z, m, !1) + 2 : s.cap === "square" && (g += F(C, w, D, O, R, z, !1, m)));
	let B = N * N;
	for (let e = _; e < g + _ - 2; ++e) x = m[e * 2], S = m[e * 2 + 1], C = m[(e + 1) * 2], w = m[(e + 1) * 2 + 1], T = m[(e + 2) * 2], E = m[(e + 2) * 2 + 1], !(Math.abs(x * (w - E) + C * (E - S) + T * (S - w)) < B) && a.push(e, e + 1, e + 2);
}
//#endregion
...
var R = [{
	...
	buildLinearGradient() {
		...
		let c = this.colorStops.length ? this.colorStops : R, l = this._textureSize, { canvas: u, context: d } = te(l, 1), f = s ? d.createLinearGradient(this._textureSize, 0, 0, 0) : d.createLinearGradient(0, 0, this._textureSize, 0);
		ee(f, c), d.fillStyle = f, d.fillRect(0, 0, l, 1), this.texture = new h({ source: new y({
			resource: u,
	...
	buildRadialGradient() {
		if (this.texture) return;
		let e = this.colorStops.length ? this.colorStops : R, t = this._textureSize, { canvas: n, context: r } = te(t, t), { x: i, y: a } = this.center, { x: s, y: c } = this.outerCenter, l = this.innerRadius, u = this.outerRadius, d = s - u, f = c - u, p = t / (u * 2), m = (i - d) * p, g = (a - f) * p, _ = r.createRadialGradient(m, g, l * p, (s - d) * p, (c - f) * p, u * p);
		ee(_, e), r.fillStyle = e[e.length - 1].color, r.fillRect(0, 0, t, t), r.fillStyle = _, r.translate(m, g), r.rotate(this.rotation), r.scale(1, this.scale), r.translate(-m, -g), r.fillRect(0, 0, t, t), this.texture = new h({ source: new y({
			resource: n,
			addressMode: this._wrapMode
		}) });
		let v = new o();
...
function ne(e) {
	...
	return (typeof t == "number" || e[1]) && (m("8.5.2", "use options object instead"), t = {
		...
		textureSpace: e[4],
		textureSize: e[5] ?? B.defaultLinearOptions.textureSize
	}), t;
}
//#endregion
...
var ie = {
	...
	constructor(e, t) {
		...
		let r = n.repetition;
		r && (this.texture.source.style.addressModeU = ie[r].addressModeU, this.texture.source.style.addressModeV = ie[r].addressModeV);
	}
	setTransform(e) {
		if (e) {
...
function oe(e, t, n, r, i, a, o, s = null) {
	let c = 0;
	n *= t, i *= a;
...
var le = new o(), V = class {
	...
	get transform() {
		return this.renderable?.groupTransform || le;
	}
	copyTo(e) {
...
function be(e, t, n, r) {
	...
	return !(t.fill instanceof B) && a.addressMode === "clamp-to-edge" && (a.addressMode = "repeat", a.update()), r && i.append(ve.copyFrom(r).invert()), i;
}
//#endregion
//#region node_modules/pixi.js/lib/scene/graphics/shared/utils/buildContextBatches.mjs
var U = {};
t.handleByMap(v.ShapeBuilder, U), t.add(ge, he, _e, H, ue, de);
var xe = new d(), Se = new o();
function Ce(e, t) {
	...
	for (let t = 0; t < e.instructions.length; t++) {
		...
		if (i.action === "texture") we(i.data, r, n);
		else if (i.action === "fill" || i.action === "stroke") {
			let e = i.action === "stroke", t = i.data.path.shapePath, a = i.data.style, o = i.data.hole;
			e && o && Te(o.shapePath, a, !0, r, n), o && (t.shapePrimitives[t.shapePrimitives.length - 1].holes = o.shapePath.shapePrimitives), Te(t, a, e, r, n);
		}
	}
}
function we(e, t, n) {
	let i = [], a = U.rectangle, o = xe;
	...
	s && ce(i, s), a.triangulate(i, c, 2, f, u, d);
...
function Te(e, t, n, i, a) {
	...
	e.shapePrimitives.forEach(({ shape: e, transform: l, holes: u }) => {
		...
		if (l && ce(d, l), n) {
			...
			r.pixelLine ? (fe(d, n, o, c), g = "line-list") : L(d, r, !1, n, o, c);
		} else if (u) {
			let e = [], t = d.slice();
			Ee(u).forEach((n) => {
		...
		if (v !== h.WHITE) {
			let n = be(Se, t, e, l);
			oe(o, 2, m, s, _, 2, o.length / 2 - m, n);
		} else se(s, _, 2, o.length / 2 - m);
		let y = r.get(V);
...
var W = {
	...
	v: 1,
	z: 0
}, De = /([astvzqmhlc])([^astvzqmhlc]*)/gi, Oe = /-?[0-9]*\.?[0-9]+(?:e[-+]?\d+)?/gi;
function ke(e) {
	let t = [];
	return e.replace(De, (e, n, r) => {
		let i = n.toLowerCase(), a = n, o = Ae(r);
		for (i === "m" && o.length > 2 && (t.push([a, ...o.splice(0, 2)]), i = "l", a = a === "m" ? "l" : "L");;) {
			if (o.length === W[i]) return t.push([a, ...o]), "";
			if (o.length < W[i]) throw Error("malformed path data");
			t.push([a, ...o.splice(0, W[i])]);
		}
	}), t;
}
function Ae(e) {
...
var Me = class {
	...
	_initContextRenderData(e) {
		let t = r.get(Ne, { maxTextures: this._renderer.limits.maxBatchableTextures }), n = e._gpuData[this._renderer.uid], { batches: i, geometryData: a } = n;
		n.graphicsData = t;
		...
		for (let e = 0; e < u.length; e++) {
			let t = u[e];
			t.bindGroup = C(t.textures.textures, t.textures.count, this._renderer.limits.maxBatchableTextures);
		}
		return t;
	}
	_initContext(e) {
...
G.extension = {
	...
	name: "graphicsContext"
}, G.defaultOptions = { bezierSmoothness: .5 };
var K = G, Pe = 8, q = 1.1920929e-7, Fe = 1;
function Ie(e, t, n, r, i, a, o, s, c, l) {
	let u = (Fe - Math.min(.99, Math.max(0, l ?? K.defaultOptions.bezierSmoothness))) / 1;
	return u *= u, Le(t, n, r, i, a, o, s, c, e, u), e;
}
function Le(e, t, n, r, i, a, o, s, c, l) {
	J(e, t, n, r, i, a, o, s, c, l, 0), c.push(o, s);
}
function J(e, t, n, r, i, a, o, s, c, l, u) {
	...
	J(e, t, d, f, _, v, x, S, c, l, u + 1), J(x, S, y, b, h, g, o, s, c, l, u + 1);
}
//#endregion
//#region node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildAdaptiveQuadratic.mjs
var Re = 8, ze = 1.1920929e-7, Be = 1;
function Ve(e, t, n, r, i, a, o, s) {
	let c = (Be - Math.min(.99, Math.max(0, s ?? K.defaultOptions.bezierSmoothness))) / 1;
	return c *= c, He(t, n, r, i, a, o, e, c), e;
}
function He(e, t, n, r, i, a, o, s) {
	Ue(o, e, t, n, r, i, a, s, 0), o.push(i, a);
}
function Ue(e, t, n, r, i, a, o, s, c) {
	...
	Ue(e, t, n, l, u, p, m, s, c + 1), Ue(e, p, m, d, f, a, o, s, c + 1);
}
//#endregion
...
}, Xe = (e, t, n, r, i, a, o, s, c, l, u, d, f) => {
	let p = i ** 2, m = a ** 2, h = u ** 2, g = d ** 2, _ = p * m - p * g - m * h;
	_ < 0 && (_ = 0), _ /= p * g + m * h, _ = Math.sqrt(_) * (o === s ? -1 : 1);
	let v = _ * i / a * d, y = _ * -a / i * u, b = l * v - c * y + (e + n) / 2, x = c * v + l * y + (t + r) / 2, S = (u - v) / i, C = (d - y) / a, w = (-u - v) / i, T = (-d - y) / a, E = Ye(1, 0, S, C), D = Ye(S, C, w, T);
	s === 0 && D > 0 && (D -= Y), s === 1 && D < 0 && (D += Y), f.centerX = b, f.centerY = x, f.ang1 = E, f.ang2 = D;
};
function Ze(e, t, n, r, i, a, o, s = 0, c = 0, l = 0) {
	if (a === 0 || o === 0) return;
	let u = Math.sin(s * Y / 360), d = Math.cos(s * Y / 360), f = d * (t - r) / 2 + u * (n - i) / 2, p = -u * (t - r) / 2 + d * (n - i) / 2;
	if (f === 0 && p === 0) return;
	a = Math.abs(a), o = Math.abs(o);
	let m = f ** 2 / a ** 2 + p ** 2 / o ** 2;
	m > 1 && (a *= Math.sqrt(m), o *= Math.sqrt(m)), Xe(t, n, r, i, a, o, c, l, u, d, f, p, Ke);
	let { ang1: h, ang2: g } = Ke, { centerX: _, centerY: v } = Ke, y = Math.abs(g) / (Y / 4);
	...
	for (let t = 0; t < b; t++) {
		let t = Je(h, g), { x: n, y: r } = qe(t[0], a, o, d, u, _, v, C), { x: i, y: s } = qe(t[1], a, o, d, u, _, v, C), { x: c, y: l } = qe(t[2], a, o, d, u, _, v, C);
		Ie(e, x, S, n, r, i, s, c, l), x = c, S = l, h += g;
	}
}
//#endregion
...
var et = new d(), tt = class {
	...
	arc(e, t, n, r, i, a) {
		...
		return We(o, e, t, n, r, i, a), this;
	}
	arcTo(e, t, n, r, i) {
		this._ensurePoly();
		let a = this._currentPoly.points;
		return Ge(a, e, t, n, r, i), this;
	}
	arcToSvg(e, t, n, r, i, a, o) {
		let s = this._currentPoly.points;
		return Ze(s, this._currentPoly.lastX, this._currentPoly.lastY, a, o, e, t, n, r, i), this;
	}
	bezierCurveTo(e, t, n, r, i, a, o) {
		this._ensurePoly();
		let s = this._currentPoly;
		return Ie(this._currentPoly.points, s.lastX, s.lastY, e, t, n, r, i, a, o), this;
	}
	quadraticCurveTo(e, t, n, r, i) {
		this._ensurePoly();
		let a = this._currentPoly;
		return Ve(this._currentPoly.points, a.lastX, a.lastY, e, t, n, r, i), this;
	}
	closePath() {
		...
		if (e.checkForHoles && n.length - r > 1) {
			...
			for (let t = r; t < n.length; t++) {
				...
				if (r.shape.type === "polygon") {
					...
					a && a.containsPolygon(i) ? (e.holes ||= [], e.holes.push(r), n.copyWithin(t, t + 1), n.length--, t--) : e = r;
				}
			}
		}
		return this;
	...
	circle(e, t, n, r) {
		return this.drawShape(new T(e, t, n), r), this;
	}
	poly(e, t, n) {
		let r = new k(e);
	...
	roundShape(e, t, n = !1, r) {
		return e.length < 3 ? this : (n ? $e(this, e, t, r) : Qe(this, e, t), this.closePath());
	}
	...
	ellipse(e, t, n, r, i) {
		return this.drawShape(new E(e, t, n, r), i), this;
	}
	roundRect(e, t, n, r, i, a) {
		return this.drawShape(new j(e, t, n, r, i), a), this;
	}
	drawShape(e, t) {
	...
	startPoly(e, t) {
		...
		return n && this.endPoly(), n = new k(), n.points.push(e, t), this._currentPoly = n, this;
	}
	endPoly(e = !1) {
	...
	_ensurePoly(e = !0) {
		if (!this._currentPoly && (this._currentPoly = new k(), e)) {
	...
	get bounds() {
		...
		for (let n = 0; n < t.length; n++) {
			let r = t[n], i = r.shape.getBounds(et);
	...
	constructor(e, t = !1) {
		this.instructions = [], this.uid = a("graphicsPath"), this._dirty = !0, this.checkForHoles = t, typeof e == "string" ? je(e, this) : this.instructions = e?.slice() ?? [];
	}
	get shapePath() {
		return this._shapePath ||= new tt(this), this._dirty && (this._dirty = !1, this._shapePath.buildPath()), this._shapePath;
	}
	addPath(e, t) {
	...
	transform(e) {
		...
		for (let g = 0; g < this.instructions.length; g++) {
			...
			switch (_.action) {
				...
				default:
					s("unknown transform action", _.action);
					break;
			}
		}
...
function rt(e) {
	let t = new B(Q(e, "x1", 0), Q(e, "y1", 0), Q(e, "x2", 1), Q(e, "y2", 0), (e.getAttribute("gradientUnits") || "objectBoundingBox") === "objectBoundingBox" ? "local" : "global");
...
function it(e) {
	return s("[SVG Parser] Radial gradients are not yet supported"), new B(0, 0, 1, 0);
}
//#endregion
...
function pt(e, t) {
	...
	nt(e, n);
	let r = e.children, { fillStyle: i, strokeStyle: a } = st(e, n);
	for (let e = 0; e < r.length; e++) {
		let t = r[e];
		t.nodeName.toLowerCase() !== "defs" && mt(t, n, i, a);
	}
	return t;
}
function mt(e, t, n, r) {
	let i = e.children, { fillStyle: a, strokeStyle: o } = st(e, t);
	a && n ? n = {
		...n,
		...a
	} : a && (n = a), o && r ? r = {
	...
	switch (e.nodeName.toLowerCase()) {
		case "path": {
			S = e.getAttribute("d");
			let i = e.getAttribute("fill-rule"), a = ut(S), o = i === "evenodd", s = a.length > 1;
			if (o && s) {
				let e = a.map((e) => ({
					path: e,
					area: dt(e)
				}));
				if (e.sort((e, t) => t.area - e.area), a.length > 3 || !lt(e)) for (let i = 0; i < e.length; i++) {
					let a = e[i], o = i === 0;
					t.context.beginPath();
					let s = new X(void 0, !0);
					ft(a.path, s), t.context.path(s), o ? (n && t.context.fill(n), r && t.context.stroke(r)) : t.context.cut();
				}
				else for (let i = 0; i < e.length; i++) {
					let a = e[i], o = i % 2 == 1;
					t.context.beginPath();
					let s = new X(void 0, !0);
					ft(a.path, s), t.context.path(s), o ? t.context.cut() : (n && t.context.fill(n), r && t.context.stroke(r));
				}
			} else C = new X(S, i ? i === "evenodd" : !0), t.context.path(C), n && t.context.fill(n), r && t.context.stroke(r);
			break;
		}
		case "circle":
		...
		case "svg": break;
		default:
			s(`[SVG parser] <${e.nodeName}> elements unsupported`);
			break;
	}
	c && (n = null);
	for (let e = 0; e < i.length; e++) mt(i[e], t, n, r);
}
//#endregion
...
function $(e, t) {
	...
	let n = {}, r = e;
	return ht(e) ? yt(n, e, t) : vt(e) ? bt(n, e, t) : gt(e) ? xt(n, e, t) : _t(e) ? St(n, e, t) : r.fill && gt(r.fill) ? xt(r, r.fill, t) : r.fill && _t(r.fill) ? St(r, r.fill, t) : Ct(r, t);
}
function wt(e, t) {
...
var Et = new c(), Dt = new o(), Ot = class t extends l {
	constructor() {
	...
	set strokeStyle(e) {
		this._strokeStyle = wt(e, t.defaultStrokeStyle);
	}
	setFillStyle(e) {
	...
	stroke(e) {
		...
		return n = this._tick === 0 && r?.action === "fill" ? r.data.path : this._activePath.clone(), n ? (e != null && (this._strokeStyle = wt(e, t.defaultStrokeStyle)), this.instructions.push({
			action: "stroke",
			data: {
	...
	svg(e) {
		return this._tick++, pt(e, this), this;
	}
	restore() {
	...
	transform(e, t, n, r, i, a) {
		return e instanceof o ? (this._transform.append(e), this) : (Dt.set(e, t, n, r, i, a), this._transform.append(Dt), this);
	}
	translate(e, t = e) {
	...
	get bounds() {
		...
		for (let t = 0; t < this.instructions.length; t++) {
			...
			if (r === "stroke") {
				...
				t.style.join === "miter" && (i *= Tt(t.path, t.style.miterLimit));
				let a = t.path.bounds;
	...
	containsPoint(e) {
		...
		for (let r = 0; r < t.length; r++) {
			...
			for (let t = 0; t < c.length; t++) {
				let r = c[t].shape;
				if (!s || !r) continue;
				let o = c[t].transform, l = o ? o.applyInverse(e, Et) : e;
...
var kt = Ot;
//#endregion
export { U as a, ae as c, K as i, B as l, $ as n, be as o, wt as r, V as s, kt as t, L as u };
