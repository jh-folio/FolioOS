import { A as e, B as t, D as n, E as r, L as i, M as a, N as o, O as s, P as c, R as l, T as u, a as d, c as f, h as p, k as m, m as h, o as g, p as _, s as ee, u as te, v, w as y, y as ne, z as b } from "./Geometry-DGpI5VLa.js";
import { _ as re, c as x, d as ie, i as ae, l as oe, m as se, n as ce, o as S, p as le, r as C, t as ue, u as w } from "./Filter-DdWkiyJx.js";
import { n as de, p as T } from "./GCManagedHash-DosM8O0d.js";
...
var k = class {
	...
	_addRenderableDirect(e, t) {
		this._renderer.renderPipes.batch.break(t), e._batchableRenderGroup &&= (r.return(e._batchableRenderGroup), null), t.add(e);
	}
	_addRenderableCacheAsTexture(e, t) {
		let n = e._batchableRenderGroup ??= r.get(D);
	...
	_executeCacheAsTexture(e) {
		if (e.textureNeedsUpdate) {
			...
			let t = new o().translate(-e._textureBounds.x, -e._textureBounds.y);
			...
			}), O(e, this._renderer.renderPipes), this._renderer.renderTarget.finishRenderPass(), this._renderer.renderTarget.pop(), this._renderer.globalUniforms.pop();
		}
	...
	_executeDirect(e) {
		...
		}), O(e, this._renderer.renderPipes), this._renderer.globalUniforms.pop();
	}
};
k.extension = {
	type: [
...
var j = class e {
	constructor(e, t) {
		this.state = ce.for2d(), this._batchersByInstructionSet = /* @__PURE__ */ Object.create(null), this._activeBatches = /* @__PURE__ */ Object.create(null), this.renderer = e, this._adaptor = t, this._adaptor.init?.(this);
	}
	...
	buildStart(e) {
		...
		t || (t = this._batchersByInstructionSet[e.uid] = /* @__PURE__ */ Object.create(null), t.default || (t.default = new de({ maxTextures: this.renderer.limits.maxBatchableTextures }))), this._activeBatches = t, this._activeBatch = this._activeBatches.default;
...
var fe = "in vec2 vMaskCoord;\nin vec2 vTextureCoord;\n\nuniform sampler2D uTexture;\nuniform sampler2D uMaskTexture;\n\nuniform float uAlpha;\nuniform vec4 uMaskClamp;\nuniform float uInverse;\nuniform float uChannel;\n\nout vec4 finalColor;\n\nvoid main(void)\n{\n    float clip = step(3.5,\n        step(uMaskClamp.x, vMaskCoord.x) +\n        step(uMaskClamp.y, vMaskCoord.y) +\n        step(vMaskCoord.x, uMaskClamp.z) +\n        step(vMaskCoord.y, uMaskClamp.w));\n\n    // TODO look into why this is needed\n    float npmAlpha = uAlpha;\n    vec4 original = texture(uTexture, vTextureCoord);\n    vec4 masky = texture(uMaskTexture, vMaskCoord);\n\n    float a;\n    if (uChannel == 1.0) {\n        a = masky.a * npmAlpha * clip;\n    } else {\n        float alphaMul = 1.0 - npmAlpha * (1.0 - masky.a);\n        a = alphaMul * masky.r * npmAlpha * clip;\n    }\n\n    if (uInverse == 1.0) {\n        a = 1.0 - a;\n    }\n\n    finalColor = original * a;\n}\n", pe = "in vec2 aPosition;\n\nout vec2 vTextureCoord;\nout vec2 vMaskCoord;\n\n\nuniform vec4 uInputSize;\nuniform vec4 uOutputFrame;\nuniform vec4 uOutputTexture;\nuniform mat3 uFilterMatrix;\n\nvec4 filterVertexPosition(  vec2 aPosition )\n{\n    vec2 position = aPosition * uOutputFrame.zw + uOutputFrame.xy;\n       \n    position.x = position.x * (2.0 / uOutputTexture.x) - 1.0;\n    position.y = position.y * (2.0*uOutputTexture.z / uOutputTexture.y) - uOutputTexture.z;\n\n    return vec4(position, 0.0, 1.0);\n}\n\nvec2 filterTextureCoord(  vec2 aPosition )\n{\n    return aPosition * (uOutputFrame.zw * uInputSize.zw);\n}\n\nvec2 getFilterCoord( vec2 aPosition )\n{\n    return  ( uFilterMatrix * vec3( filterTextureCoord(aPosition), 1.0)  ).xy;\n}   \n\nvoid main(void)\n{\n    gl_Position = filterVertexPosition(aPosition);\n    vTextureCoord = filterTextureCoord(aPosition);\n    vMaskCoord = getFilterCoord(aPosition);\n}\n", me = "struct GlobalFilterUniforms {\n  uInputSize:vec4<f32>,\n  uInputPixel:vec4<f32>,\n  uInputClamp:vec4<f32>,\n  uOutputFrame:vec4<f32>,\n  uGlobalFrame:vec4<f32>,\n  uOutputTexture:vec4<f32>,\n};\n\nstruct MaskUniforms {\n  uFilterMatrix:mat3x3<f32>,\n  uMaskClamp:vec4<f32>,\n  uAlpha:f32,\n  uInverse:f32,\n  uChannel:f32,\n};\n\n@group(0) @binding(0) var<uniform> gfu: GlobalFilterUniforms;\n@group(0) @binding(1) var uTexture: texture_2d<f32>;\n@group(0) @binding(2) var uSampler : sampler;\n\n@group(1) @binding(0) var<uniform> filterUniforms : MaskUniforms;\n@group(1) @binding(1) var uMaskTexture: texture_2d<f32>;\n\nstruct VSOutput {\n    @builtin(position) position: vec4<f32>,\n    @location(0) uv : vec2<f32>,\n    @location(1) filterUv : vec2<f32>,\n};\n\nfn filterVertexPosition(aPosition:vec2<f32>) -> vec4<f32>\n{\n    var position = aPosition * gfu.uOutputFrame.zw + gfu.uOutputFrame.xy;\n\n    position.x = position.x * (2.0 / gfu.uOutputTexture.x) - 1.0;\n    position.y = position.y * (2.0*gfu.uOutputTexture.z / gfu.uOutputTexture.y) - gfu.uOutputTexture.z;\n\n    return vec4(position, 0.0, 1.0);\n}\n\nfn filterTextureCoord( aPosition:vec2<f32> ) -> vec2<f32>\n{\n    return aPosition * (gfu.uOutputFrame.zw * gfu.uInputSize.zw);\n}\n\nfn globalTextureCoord( aPosition:vec2<f32> ) -> vec2<f32>\n{\n  return  (aPosition.xy / gfu.uGlobalFrame.zw) + (gfu.uGlobalFrame.xy / gfu.uGlobalFrame.zw);\n}\n\nfn getFilterCoord(aPosition:vec2<f32> ) -> vec2<f32>\n{\n  return ( filterUniforms.uFilterMatrix * vec3( filterTextureCoord(aPosition), 1.0)  ).xy;\n}\n\nfn getSize() -> vec2<f32>\n{\n  return gfu.uGlobalFrame.zw;\n}\n\n@vertex\nfn mainVertex(\n  @location(0) aPosition : vec2<f32>,\n) -> VSOutput {\n  return VSOutput(\n   filterVertexPosition(aPosition),\n   filterTextureCoord(aPosition),\n   getFilterCoord(aPosition)\n  );\n}\n\n@fragment\nfn mainFragment(\n  @location(0) uv: vec2<f32>,\n  @location(1) filterUv: vec2<f32>,\n  @builtin(position) position: vec4<f32>\n) -> @location(0) vec4<f32> {\n\n    var maskClamp = filterUniforms.uMaskClamp;\n    var uAlpha = filterUniforms.uAlpha;\n\n    var clip = step(3.5,\n      step(maskClamp.x, filterUv.x) +\n      step(maskClamp.y, filterUv.y) +\n      step(filterUv.x, maskClamp.z) +\n      step(filterUv.y, maskClamp.w));\n\n    var mask = textureSample(uMaskTexture, uSampler, filterUv);\n    var source = textureSample(uTexture, uSampler, uv);\n\n    var a: f32;\n    if (filterUniforms.uChannel == 1.0) {\n        a = mask.a * uAlpha * clip;\n    } else {\n        var alphaMul = 1.0 - uAlpha * (1.0 - mask.a);\n        a = alphaMul * mask.r * uAlpha * clip;\n    }\n\n    if (filterUniforms.uInverse == 1.0) {\n        a = 1.0 - a;\n    }\n\n    return source * a;\n}\n", he = class extends ue {
...
}, ge = new y(), _e = class extends re {
	constructor() {
		super(), this.filters = [new he({
			sprite: new ae(h.EMPTY),
			inverse: !1,
			resolution: "inherit",
			antialias: "inherit"
		})];
	...
	execute(e) {
		...
		if (e.action === "pushMaskBegin") {
			let i = r.get(_e);
			if (i.inverse = e.inverse, i.channel = e.mask.channel, n) {
				e.mask.mask.measurable = !0;
				let n = se(e.mask.mask, !0, ge);
				e.mask.mask.measurable = !1, n.ceil();
				let r = t.renderTarget.renderTarget.colorTexture.source, a = w.getOptimalTexture(n.width, n.height, r._resolution, r.antialias);
			...
			n && (t.type === g.WEBGL && t.renderTarget.finishRenderPass(), t.renderTarget.pop(), t.globalUniforms.pop()), t.filter.push({
				renderPipeId: "filter",
				action: "pushFilter",
			...
			n && w.returnTexture(e.filterTexture), r.return(e.filterEffect);
		}
	}
	destroy() {
...
var I = class {
	...
	setBlendMode(e, t, n) {
		let r = e instanceof oe;
		if (this._activeBlendMode === t) {
			this._isAdvanced && e && !r && this._renderableList?.push(e);
			return;
		}
		this._isAdvanced && this._endAdvancedBlendMode(n), this._activeBlendMode = t, e && (this._isAdvanced = !!F[t], this._isAdvanced && this._beginAdvancedBlendMode(e, n));
	}
	_beginAdvancedBlendMode(e, t) {
		this._renderer.renderPipes.batch.break(t);
		let n = this._activeBlendMode;
		if (!F[n]) {
			s(`Unable to assign BlendMode: '${n}'. You may want to include: import 'pixi.js/advanced-blend-modes'`);
			return;
		}
		let r = this._ensureFilterEffect(n), i = e instanceof oe, a = {
			renderPipeId: "filter",
			action: "pushFilter",
			filterEffect: r,
	...
	_ensureFilterEffect(e) {
		...
		return t || (t = this._filterHash[e] = new re(), t.filters = [new F[e]()]), t;
	}
...
var L = [];
t.handleByNamedList(b.Environment, L);
async function ve(e) {
	if (!e) for (let e = 0; e < L.length; e++) {
		let t = L[e];
		if (t.value.test()) {
			await t.value.load();
			return;
...
function ye() {
	...
	try {
		R = Function("param1", "param2", "param3", "return param1[param2] === param3;")({ a: "b" }, "a", "b") === !0;
	} catch {
		R = !1;
	}
	return R;
...
var z = /* @__PURE__ */ ((e) => (e[e.NONE = 0] = "NONE", e[e.COLOR = 16384] = "COLOR", e[e.STENCIL = 1024] = "STENCIL", e[e.DEPTH = 256] = "DEPTH", e[e.COLOR_DEPTH = 16640] = "COLOR_DEPTH", e[e.COLOR_STENCIL = 17408] = "COLOR_STENCIL", e[e.DEPTH_STENCIL = 1280] = "DEPTH_STENCIL", e[e.ALL = 17664] = "ALL", e))(z || {}), be = class {
	constructor(e) {
	...
	"postrender",
	"prerender"
], Se = class t extends l {
	constructor(e) {
		super(), this.tick = 0, this.uid = a("renderer"), this.runners = /* @__PURE__ */ Object.create(null), this.renderPipes = /* @__PURE__ */ Object.create(null), this._initOptions = {}, this._systemsHash = /* @__PURE__ */ Object.create(null), this.type = e.type, this.name = e.name, this.config = e;
		let t = [...xe, ...this.config.runners ?? []];
		this._addRunners(...t), this._unsafeEvalCheck();
	}
	async init(e = {}) {
		await ve(e.skipExtensionImports === !0 || e.manageImports === !1), this._addSystems(this.config.systems), this._addPipes(this.config.renderPipes, this.config.renderPipeAdaptors);
		for (let t in this._systemsHash) e = {
		...
		e = {
			...t.defaultOptions,
			...e
		}, this._roundPixels = +!!e.roundPixels;
	...
	render(t, n) {
		this.tick++;
		let r = t;
		if (r instanceof x && (r = { container: r }, n && (m(e, "passing a second argument is deprecated, please use render options instead"), r.target = n.renderTexture)), r.target || (r.target = this.view.renderTarget), r.target === this.view.renderTarget && (this._lastObjectRendered = r.container, r.clearColor ?? (r.clearColor = this.background.colorRgba), r.clear ?? (r.clear = this.background.clearBeforeRender)), r.clearColor) {
			let e = Array.isArray(r.clearColor) && r.clearColor.length === 4;
			r.clearColor = e ? r.clearColor : i.shared.setValue(r.clearColor).toArray();
		}
	...
	clear(e = {}) {
		let t = this;
		e.target ||= t.renderTarget.renderTarget, e.clearColor ||= this.background.colorRgba, e.clear ??= z.ALL;
		let { clear: n, clearColor: r, target: a, mipLevel: o, layer: s } = e;
		i.shared.setValue(r ?? this.background.colorRgba), t.renderTarget.clear(a, n, i.shared.toArray(), o ?? 0, s ?? 0);
	}
	get resolution() {
	...
	destroy(e = !1) {
		this.runners.destroy.items.reverse(), this.runners.destroy.emit(e), (e === !0 || typeof e == "object" && e.releaseGlobalResources) && n.release(), Object.values(this.runners).forEach((e) => {
			e.destroy();
	...
	_unsafeEvalCheck() {
		if (!ye()) throw Error("Current environment does not allow unsafe-eval, please use pixi.js/unsafe-eval module to enable support.");
	}
	resetState() {
...
function V(e, t = !1) {
	...
	for (let t in n) {
		...
		for (let t = 0; t < s; t++) {
			let n = o[t];
			n.parentRenderGroup === e && n.relativeRenderGroupDepth === i && De(n, r, 0);
		}
		B(o, s), a.index = 0;
	}
	if (t) for (let n = 0; n < e.renderGroupChildren.length; n++) V(e.renderGroupChildren[n], t);
}
function Ee(e) {
	let t = e.root, n;
	if (e.renderGroupParent) {
		let r = e.renderGroupParent;
		e.worldTransform.appendFrom(t.relativeGroupTransform, r.worldTransform), e.worldColor = le(t.groupColor, r.worldColor), n = t.groupAlpha * r.worldAlpha;
...
function De(e, t, n) {
	...
	let i = e.parent;
	if (i && !i.renderGroup ? (n |= e._updateFlags, e.relativeGroupTransform.appendFrom(r, i.relativeGroupTransform), n & Te && Oe(e, i, n)) : (n = e._updateFlags, e.relativeGroupTransform.copyFrom(r), n & Te && Oe(e, we, n)), !e.renderGroup) {
		let r = e.children, i = r.length;
		for (let e = 0; e < i; e++) De(r[e], t, n);
...
function Oe(e, t, n) {
	if (n & 1) {
		e.groupColor = le(e.localColor, t.groupColor);
...
var Ae = new o(), je = class {
	...
	render({ container: e, transform: t }) {
		...
		}), O(e.renderGroup, o), o.uniformBatch && o.uniformBatch.renderEnd(), t && e.renderGroup.localTransform.copyFrom(a), e.parent = n, e.renderGroup.renderGroupParent = r;
	}
	destroy() {
		this._renderer = null;
	}
	_updateCachedRenderGroups(e, t) {
		...
		if (e.invalidateMatrices(), e.isCachedAsTexture) {
			if (e.textureNeedsUpdate) {
				...
				t.ceil(), e.texture && w.returnTexture(e.texture, !0);
				let s = w.getOptimalTexture(t.width, t.height, r, i);
				s._source.style = new ne({ scaleMode: a }), e.texture = s, e._textureBounds ||= new y(), e._textureBounds.copyFrom(t), o !== e.texture && e.renderGroupParent && (e.renderGroupParent.structureDidChange = !0);
			}
		} else e.texture &&= (w.returnTexture(e.texture, !0), null);
	}
	_updateRenderGroups(e) {
		let t = this._renderer, n = t.renderPipes;
		if (e.runOnRender(t), e.instructionSet.renderPipes = n, e.structureDidChange ? B(e.childrenRenderablesToUpdate.list, 0) : ke(e, n), V(e), e.structureDidChange ? (e.structureDidChange = !1, this._buildInstructions(e, t)) : this._updateRenderables(e), e.childrenRenderablesToUpdate.index = 0, t.renderPipes.batch.upload(e.instructionSet), !(e.isCachedAsTexture && !e.textureNeedsUpdate)) for (let t = 0; t < e.renderGroupChildren.length; t++) this._updateRenderGroups(e.renderGroupChildren[t]);
	}
...
var H = "8.19.0", Me = class {
	static init() {
		globalThis.__PIXI_APP_INIT__?.(this, H);
	}
	static destroy() {}
};
Me.extension = b.Application;
var Ne = class {
	constructor(e) {
		this._renderer = e;
	}
	init() {
		globalThis.__PIXI_RENDERER_INIT__?.(this._renderer, H);
	}
	destroy() {
		this._renderer = null;
	}
...
Pe.extension = {
	type: [b.WebGLPipes, b.WebGPUPipes],
	name: "colorMask"
};
//#endregion
...
var Fe = class {
	...
	execute(e) {
		...
		e.action === "pushMaskBegin" ? (r.renderTarget.ensureDepthStencil(), r.stencil.setStencilMode(T.RENDERING_MASK_ADD, a), a++, r.colorMask.setMask(0)) : e.action === "pushMaskEnd" ? (e.inverse ? r.stencil.setStencilMode(T.INVERSE_MASK_ACTIVE, a) : r.stencil.setStencilMode(T.MASK_ACTIVE, a), r.colorMask.setMask(15)) : e.action === "popMaskBegin" ? (r.colorMask.setMask(0), a === 0 ? (r.renderTarget.clear(null, z.STENCIL), r.stencil.setStencilMode(T.DISABLED, a)) : r.stencil.setStencilMode(T.RENDERING_MASK_REMOVE, a), a--) : e.action === "popMaskEnd" && (e.inverse ? r.stencil.setStencilMode(T.INVERSE_MASK_ACTIVE, a) : r.stencil.setStencilMode(T.MASK_ACTIVE, a), r.colorMask.setMask(15)), this._maskStackHash[i] = a;
	}
	destroy() {
...
var U = class e {
	...
	set color(e) {
		i.shared.setValue(e).alpha < 1 && this._backgroundColor.alpha === 1 && s("Cannot set a transparent background on an opaque canvas. To enable transparency, set backgroundAlpha < 1 when initializing your Application."), this._backgroundColor.setValue(e);
	}
	get alpha() {
...
var Ie = U, W = {
	...
	_normalizeOptions(e, t = {}) {
		return e instanceof x || e instanceof h ? {
			target: e,
			...t
		} : {
			...t,
	...
	async base64(t) {
		...
		if (i.toDataURL !== void 0) return i.toDataURL(W[n], r);
	...
	canvas(e) {
		...
		if (t instanceof h) return n.texture.generateCanvas(t);
		let r = n.textureGenerator.generateTexture(e), i = n.texture.generateCanvas(r);
		return r.destroy(!0), i;
	}
	pixels(e) {
		e = this._normalizeOptions(e);
		let t = e.target, n = this._renderer, r = t instanceof h ? t : n.textureGenerator.generateTexture(e), i = n.texture.getPixels(r);
		return t instanceof x && r.destroy(!0), i;
	}
	texture(e) {
		return e = this._normalizeOptions(e), e.target instanceof h ? e.target : this._renderer.textureGenerator.generateTexture(e);
	}
	download(e) {
		e = this._normalizeOptions(e);
...
G.extension = {
	...
	name: "extract"
}, G.defaultImageOptions = {
	format: "png",
	quality: 1
};
var Le = G, Re = class e extends h {
	static create(t) {
	...
	generateTexture(e) {
		...
		let t = e.resolution || this._renderer.resolution, n = e.antialias || this._renderer.view.antialias, r = e.target, a = e.clearColor;
		a = a ? Array.isArray(a) && a.length === 4 ? a : i.shared.setValue(a).toArray() : Ve;
		let s = e.frame?.copyTo(ze) || ie(r, Be).rectangle, c = e.defaultAnchor && { defaultAnchor: e.defaultAnchor };
		s.width = Math.max(s.width, 1 / t) | 0, s.height = Math.max(s.height, 1 / t) | 0;
		let l = Re.create({
...
var Ge = K, Ke = class {
	...
	bind({ size: e, projectionMatrix: t, worldTransformMatrix: n, worldColor: r, offset: i }) {
		let a = this._renderer.renderTarget.renderTarget, s = this._stackIndex ? this._globalUniformDataStack[this._stackIndex - 1] : {
			projectionData: a,
			...
			resolution: e || a.size,
			worldTransformMatrix: n || s.worldTransformMatrix,
			worldColor: r || s.worldColor,
			offset: i || s.offset,
			bindGroup: null
		}, u = this._uniformsPool.pop() || this._createUniforms();
		this._activeUniforms.push(u);
		let d = u.uniforms;
		d.uProjectionMatrix = l.projectionMatrix, d.uResolution = l.resolution, d.uWorldTransformMatrix.copyFrom(l.worldTransformMatrix), d.uWorldTransformMatrix.tx -= l.offset.x, d.uWorldTransformMatrix.ty -= l.offset.y, P(l.worldColor, d.uWorldColorAlpha, 0), u.update();
		let f;
		this._renderer.renderPipes.uniformBatch ? f = this._renderer.renderPipes.uniformBatch.getUniformBindGroup(u, !1) : (f = this._bindGroupPool.pop() || new ee(), this._activeBindGroups.push(f), f.setResource(u, 0)), l.bindGroup = f, this._currentGlobalUniformData = l;
	}
	push(e) {
		this.bind(e), this._globalUniformDataStack[this._stackIndex++] = this._currentGlobalUniformData;
	}
	pop() {
		this._currentGlobalUniformData = this._globalUniformDataStack[--this._stackIndex - 1], this._renderer.type === g.WEBGL && this._currentGlobalUniformData.bindGroup.resources[0].update();
	}
	get bindGroup() {
...
var qe = 1, Je = class {
	...
	init() {
		S.system.add(this._update, this);
	}
	repeat(e, t, n = !0) {
		let r = qe++, i = 0;
	...
	destroy() {
		S.system.remove(this._update, this), this._tasks.length = 0;
	}
};
Je.extension = {
	type: [
...
function Xe(e) {
	if (!Ye) {
		if (_.get().getNavigator().userAgent.toLowerCase().indexOf("chrome") > -1) {
			let t = [
				`%c  %c  %c  %c  %c PixiJS %c v${H} (${e}) http://www.pixijs.com/
...
`,
		...
		} else globalThis.console && globalThis.console.log(`PixiJS ${H} - ${e} - http://www.pixijs.com/`);
		Ye = !0;
	}
}
//#endregion
...
var q = class {
	...
	init(e) {
		if (e.hello) {
			...
			this._renderer.type === g.WEBGL && (e += ` ${this._renderer.context.webGLVersion}`), Xe(e);
		}
	}
};
q.extension = {
...
var J = class e {
	...
	get enabled() {
		return m("8.15.0", "RenderableGCSystem.enabled is deprecated, please use the GCSystem.enabled instead."), this._renderer.gc.enabled;
	}
	set enabled(e) {
		m("8.15.0", "RenderableGCSystem.enabled is deprecated, please use the GCSystem.enabled instead."), this._renderer.gc.enabled = e;
	}
	addManagedHash(e, t) {
		m("8.15.0", "RenderableGCSystem.addManagedHash is deprecated, please use the GCSystem.addCollection instead."), this._renderer.gc.addCollection(e, t, "hash");
	}
	addManagedArray(e, t) {
		m("8.15.0", "RenderableGCSystem.addManagedArray is deprecated, please use the GCSystem.addCollection instead."), this._renderer.gc.addCollection(e, t, "array");
	}
	addRenderable(e) {
		m("8.15.0", "RenderableGCSystem.addRenderable is deprecated, please use the GCSystem instead."), this._renderer.gc.addResource(e, "renderable");
	}
	run() {
		m("8.15.0", "RenderableGCSystem.run is deprecated, please use the GCSystem instead."), this._renderer.gc.run();
	}
	destroy() {
		this._renderer = null;
	}
...
var Ze = J, Y = class e {
	...
	set checkCount(e) {
		m("8.15.0", "TextureGCSystem.run is deprecated, please use the GCSystem instead."), this._checkCount = e;
	}
	get maxIdle() {
		return this._renderer.gc.maxUnusedTime / 1e3 * 60;
	}
	set maxIdle(e) {
		m("8.15.0", "TextureGCSystem.run is deprecated, please use the GCSystem instead."), this._renderer.gc.maxUnusedTime = e / 60 * 1e3;
	}
	get checkCountMax() {
		return Math.floor(this._renderer.gc._frequency / 1e3);
	}
	set checkCountMax(e) {
		m("8.15.0", "TextureGCSystem.run is deprecated, please use the GCSystem instead.");
	}
	get active() {
		return this._renderer.gc.enabled;
	}
	set active(e) {
		m("8.15.0", "TextureGCSystem.run is deprecated, please use the GCSystem instead."), this._renderer.gc.enabled = e;
	}
	constructor(e) {
	...
	run() {
		m("8.15.0", "TextureGCSystem.run is deprecated, please use the GCSystem instead."), this._renderer.gc.run();
	}
	destroy() {
		this._renderer = null;
	}
...
var Qe = Y, $e = class e {
	constructor(t = {}) {
		if (this.uid = a("renderTarget"), this.colorTextures = [], this.dirtyId = 0, this.isRoot = !1, this._size = /* @__PURE__ */ new Float32Array(2), this._managedColorTextures = !1, t = {
			...e.defaultOptions,
			...t
		}, this.stencil = t.stencil, this.depth = t.depth, this.isRoot = t.isRoot, typeof t.colorTextures == "number") {
			this._managedColorTextures = !0;
			for (let e = 0; e < t.colorTextures; e++) this.colorTextures.push(new v({
				width: t.width,
				height: t.height,
		...
		this.colorTexture.source.on("resize", this.onSourceResize, this), (t.depthStencilTexture || this.stencil) && (t.depthStencilTexture instanceof h || t.depthStencilTexture instanceof v ? this.depthStencilTexture = t.depthStencilTexture.source : this.ensureDepthStencilTexture());
	}
	get size() {
		let e = this._size;
	...
	ensureDepthStencilTexture() {
		this.depthStencilTexture ||= new v({
			width: this.width,
			height: this.height,
...
var X = $e, Z = /* @__PURE__ */ new Map();
n.register(Z);
function Q(e, t) {
	if (!Z.has(e)) {
		let n = new h({ source: new C({
			resource: e,
			...t
		}) }), r = () => {
			Z.get(e) === n && Z.delete(e);
		};
		n.once("destroy", r), n.source.once("destroy", r), Z.set(e, n);
	}
	return Z.get(e);
}
//#endregion
...
var $ = class t {
	...
	init(n) {
		n = {
			...t.defaultOptions,
			...n
		}, n.view && (m(e, "ViewSystem.view has been renamed to ViewSystem.canvas"), n.canvas = n.view), this.screen = new u(0, 0, n.width, n.height), this.canvas = n.canvas || _.get().createCanvas(), this.antialias = !!n.antialias, this.texture = Q(this.canvas, n), this.renderTarget = new X({
			colorTextures: [this.texture],
			depth: !!n.depth,
			isRoot: !0
		}), this.texture.source.transparent = n.backgroundAlpha < 1, this.resolution = n.resolution;
	}
	resize(e, t, n) {
...
var it = class {
	constructor(e) {
		this.rootViewPort = new u(), this.viewport = new u(), this.mipLevel = 0, this.layer = 0, this.onRenderTargetChange = new be("onRenderTargetChange"), this.projectionMatrix = new o(), this.defaultClearColor = [
			0,
			0,
			0,
			0
	...
	renderStart({ target: e, clear: t, clearColor: n, frame: r, mipLevel: i, layer: a }) {
		this._renderTargetStack.length = 0, this.push(e, t, n, r, i ?? 0, a ?? 0), this.rootViewPort.copyFrom(this.viewport), this.rootRenderTarget = this.renderTarget, this.renderingToScreen = rt(this.rootRenderTarget), this.adaptor.prerender?.(this.rootRenderTarget);
	}
	postrender() {
	...
	bind(e, t = !0, n, r, i = 0, a = 0) {
		...
		if (!r && e instanceof h && (r = e.frame), r) {
		...
		return nt(this.projectionMatrix, 0, 0, u.width / l.resolution, u.height / l.resolution, !o.isRoot), this.adaptor.startRenderPass(o, t, n, u, i, a), s && this.onRenderTargetChange.emit(o), o;
	}
	clear(e, t = z.ALL, n, r = this.mipLevel, i = this.layer) {
		t && (e &&= this.getRenderTarget(e), this.adaptor.clear(e || this.renderTarget, t, n, this.viewport, r, i));
	}
	contextChange() {
		this._gpuRenderTargetHash = /* @__PURE__ */ Object.create(null);
	}
	push(e, t = z.ALL, n, r, i = 0, a = 0) {
	...
	_initRenderTarget(e) {
		let t = null;
		return C.test(e) && (e = Q(e).source), e instanceof X ? t = e : e instanceof v && (t = new X({ colorTextures: [e] }), e.source instanceof C && (t.isRoot = !0), e.once("destroy", () => {
...
//#endregion
export { Ce as a, I as c, M as d, A as f, Me as i, P as l, E as m, tt as n, z as o, k as p, et as r, ye as s, it as t, N as u };
