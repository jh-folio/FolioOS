...
var n = /* @__PURE__ */ ((e) => (e.Application = "application", e.WebGLPipes = "webgl-pipes", e.WebGLPipesAdaptor = "webgl-pipes-adaptor", e.WebGLSystem = "webgl-system", e.WebGPUPipes = "webgpu-pipes", e.WebGPUPipesAdaptor = "webgpu-pipes-adaptor", e.WebGPUSystem = "webgpu-system", e.CanvasSystem = "canvas-system", e.CanvasPipesAdaptor = "canvas-pipes-adaptor", e.CanvasPipes = "canvas-pipes", e.Asset = "asset", e.LoadParser = "load-parser", e.ResolveParser = "resolve-parser", e.CacheParser = "cache-parser", e.DetectionParser = "detection-parser", e.MaskEffect = "mask-effect", e.BlendMode = "blend-mode", e.TextureSource = "texture-source", e.TextureUploaderWebGL = "texture-uploader-webgl", e.TextureUploaderWebGPU = "texture-uploader-webgpu", e.Environment = "environment", e.ShapeBuilder = "shape-builder", e.Batcher = "batcher", e))(n || {}), r = (e) => {
	...
	var t, n, r, i;
}, ee = /^hsla?\(\s*([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s*,\s*([+-]?\d*\.?\d+)%\s*,\s*([+-]?\d*\.?\d+)%\s*(?:,\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, te = /^hsla?\(\s*([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s+([+-]?\d*\.?\d+)%\s+([+-]?\d*\.?\d+)%\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, ne = /^rgba?\(\s*([+-]?\d*\.?\d+)(%)?\s*,\s*([+-]?\d*\.?\d+)(%)?\s*,\s*([+-]?\d*\.?\d+)(%)?\s*(?:,\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, re = /^rgba?\(\s*([+-]?\d*\.?\d+)(%)?\s+([+-]?\d*\.?\d+)(%)?\s+([+-]?\d*\.?\d+)(%)?\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, ie = {
	string: [
		[function(e) {
			var t = m.exec(e);
			return t ? (e = t[1]).length <= 4 ? {
				...
				a: e.length === 4 ? l(parseInt(e[3] + e[3], 16) / 255, 2) : 1
			} : e.length === 6 || e.length === 8 ? {
				r: parseInt(e.substr(0, 2), 16),
				g: parseInt(e.substr(2, 2), 16),
				b: parseInt(e.substr(4, 2), 16),
				a: e.length === 8 ? l(parseInt(e.substr(6, 2), 16) / 255, 2) : 1
			} : null : null;
		}, "hex"],
		[function(e) {
			var t = ne.exec(e) || re.exec(e);
			return t ? t[2] !== t[4] || t[4] !== t[6] ? null : f({
		...
		[function(e) {
			var t = ee.exec(e) || te.exec(e);
			if (!t) return null;
			var n, r;
			return b(v({
				h: (n = t[1], r = t[2], r === void 0 && (r = "deg"), Number(n) * (s[r] || 1)),
				s: Number(t[3]),
				l: Number(t[4]),
	...
	object: [
		...
		[function(e) {
			...
			return !c(t) || !c(n) || !c(r) ? null : _(function(e) {
				return {
					h: d(e.h),
					s: u(e.s, 0, 100),
					v: u(e.v, 0, 100),
	...
	return typeof e == "string" ? ae(e.trim(), ie.string) : typeof e == "object" && e ? ae(e, ie.object) : [null, void 0];
}, se = function(e, t) {
	var n = x(e);
	return {
		h: n.h,
	...
	function e(e) {
		this.parsed = oe(e)[0], this.rgba = this.parsed || {
			r: 0,
			g: 0,
			b: 0,
			a: 1
	...
	return e.prototype.isValid = function() {
		...
		return l(S(this.rgba), 2);
	}, e.prototype.isDark = function() {
		return S(this.rgba) < .5;
	}, e.prototype.isLight = function() {
		return S(this.rgba) >= .5;
	}, e.prototype.toHex = function() {
		return e = p(this.rgba), t = e.r, n = e.g, r = e.b, a = (i = e.a) < 1 ? h(l(255 * i)) : "", "#" + h(t) + h(n) + h(r) + a;
		var e, t, n, r, i, a;
	}, e.prototype.toRgb = function() {
		return p(this.rgba);
	}, e.prototype.toRgbString = function() {
		return e = p(this.rgba), t = e.r, n = e.g, r = e.b, (i = e.a) < 1 ? "rgba(" + t + ", " + n + ", " + r + ", " + i + ")" : "rgb(" + t + ", " + n + ", " + r + ")";
		var e, t, n, r, i;
	}, e.prototype.toHsl = function() {
		return y(x(this.rgba));
	}, e.prototype.toHslString = function() {
		return e = y(x(this.rgba)), t = e.h, n = e.s, r = e.l, (i = e.a) < 1 ? "hsla(" + t + ", " + n + "%, " + r + "%, " + i + ")" : "hsl(" + t + ", " + n + "%, " + r + "%)";
		var e, t, n, r, i;
	}, e.prototype.toHsv = function() {
		return e = g(this.rgba), {
			h: l(e.h),
			s: l(e.s),
			v: l(e.v),
			a: l(e.a, 3)
		...
		return e === void 0 && (e = .1), w(se(this.rgba, e));
	}, e.prototype.desaturate = function(e) {
		return e === void 0 && (e = .1), w(se(this.rgba, -e));
	}, e.prototype.grayscale = function() {
		return w(se(this.rgba, -1));
	}, e.prototype.lighten = function(e) {
		return e === void 0 && (e = .1), w(ce(this.rgba, e));
	...
	e.forEach(function(e) {
		le.indexOf(e) < 0 && (e(C, ie), le.push(e));
	});
};
//#endregion
...
T.shared = new T(), T._temp = new T(), T.HEX_PATTERN = /^(#|0x)?(([a-f0-9]{3}){1,2}([a-f0-9]{2})?)$/i;
var fe = T, pe = Math.PI * 2, me = 180 / Math.PI, he = Math.PI / 180, E = class e {
	constructor(e = 0, t = 0) {
	...
	decompose(e) {
		...
		return c < 1e-5 || Math.abs(pe - c) < 1e-5 ? (e.rotation = s, e.skew.x = e.skew.y = 0) : (e.rotation = 0, e.skew.x = o, e.skew.y = s), e.scale.x = Math.sqrt(t * t + n * n), e.scale.y = Math.sqrt(r * r + i * i), e.position.x = this.tx + (a.x * t + a.y * r), e.position.y = this.ty + (a.x * n + a.y * i), e;
	}
	invert() {
...
}, ge = new O(), _e = new O(), k = { default: -1 };
function A(e = "default") {
	return k[e] === void 0 && (k[e] = -1), ++k[e];
}
//#endregion
//#region node_modules/pixi.js/lib/utils/logging/deprecation.mjs
var ve = /* @__PURE__ */ new Set(), ye = "8.0.0", be = "8.3.4", j = {
	quiet: !1,
	noColor: !1
}, M = ((e, t, n = 3) => {
	if (j.quiet || ve.has(t)) return;
	let r = (/* @__PURE__ */ Error()).stack, i = `${t}
Deprecated since v${e}`, a = typeof console.groupCollapsed == "function" && !j.noColor;
	r === void 0 ? console.warn("PixiJS Deprecation Warning: ", i) : (r = r.split("\n").splice(n).join("\n"), a ? (console.groupCollapsed("%cPixiJS Deprecation Warning: %c%s", "color:#614108;background:#fffbe6", "font-weight:normal;color:#614108;background:#fffbe6", i), console.warn(r), console.groupEnd()) : (console.warn("PixiJS Deprecation Warning: ", i), console.warn(r))), ve.add(t);
});
...
var N = 0, xe = 500;
function Se(...e) {
	N !== xe && (N++, N === xe ? console.warn("PixiJS Warning: too many warnings, no more warnings will be reported to the console by PixiJS.") : console.warn("PixiJS Warning: ", ...e));
}
//#endregion
...
var Ce = {
	...
	getPool(e) {
		return this._poolsByClass.has(e) || this._poolsByClass.set(e, new we(e)), this._poolsByClass.get(e);
	}
	stats() {
		let e = {};
...
var P = [
	...
	intersects(e, t) {
		...
		if (r <= n || a <= i) return !1;
		let o = P[0].set(e.left, e.top), s = P[1].set(e.left, e.bottom), c = P[2].set(e.right, e.top), l = P[3].set(e.right, e.bottom);
		...
		let _ = u * (o.y - c.y), v = u * (c.x - o.x), y = _ * n + v * i, b = _ * r + v * i, x = _ * n + v * a, ee = _ * r + v * a;
		return !(Math.max(y, b, x, ee) <= _ * o.x + v * o.y || Math.min(y, b, x, ee) >= _ * l.x + v * l.y);
	}
	pad(e = 0, t = e) {
	...
	constructor(e = Infinity, t = Infinity, n = -Infinity, r = -Infinity) {
		this.minX = Infinity, this.minY = Infinity, this.maxX = -Infinity, this.maxY = -Infinity, this.matrix = Ee, this.minX = e, this.minY = t, this.maxX = n, this.maxY = r;
	}
	isEmpty() {
	...
	clear() {
		return this.minX = Infinity, this.minY = Infinity, this.maxX = -Infinity, this.maxY = -Infinity, this.matrix = Ee, this;
	}
	set(e, t, n, r) {
...
var ke = class {
	constructor() {
		this.uid = A("instructionSet"), this.instructions = [], this.instructionSize = 0, this.renderables = [], this.gcTick = 0;
	}
	reset() {
...
function Pe(e) {
	let t = Ne[e];
	return t === void 0 && (Ne[e] = A("resource")), t;
}
var Fe = class e extends o {
	constructor(t = {}) {
	...
	set wrapMode(e) {
		M(ye, "TextureStyle.wrapMode is now TextureStyle.addressMode"), this.addressMode = e;
	}
	get wrapMode() {
	...
	_generateResourceId() {
		...
		return this._sharedResourceId = Pe(e), this._resourceId;
	}
	destroy() {
...
var Ie = Fe, Le = class e extends o {
	...
	destroy() {
		this.destroyed = !0, this.unload(), this.emit("destroy", this), this._style &&= (this._style.destroy(), null), this.uploadMethodId = null, this.resource = null, this.removeAllListeners();
	}
	unload() {
		this._resourceId = A("resource"), this.emit("change", this), this.emit("unload", this);
	...
	resize(e, t, n) {
		...
		return this.width = r / n, this.height = i / n, this._resolution = n, this.pixelWidth === r && this.pixelHeight === i ? !1 : (this._refreshPOT(), this.pixelWidth = r, this.pixelHeight = i, this.emit("resize", this), this._resourceId = A("resource"), this.emit("change", this), !0);
	}
	updateMipmaps() {
	...
	_refreshPOT() {
		this.isPowerOfTwo = je(this.pixelWidth) && je(this.pixelHeight);
	}
	static test(e) {
...
function Be() {
	for (let e = 0; e < 16; e++) {
		...
		Re.push(t);
		for (let n = 0; n < 16; n++) {
			let r = V(L[e] * L[n] + z[e] * R[n]), i = V(R[e] * L[n] + B[e] * R[n]), a = V(L[e] * z[n] + z[e] * B[n]), o = V(R[e] * z[n] + B[e] * B[n]);
			for (let e = 0; e < 16; e++) if (L[e] === r && R[e] === i && z[e] === a && B[e] === o) {
				t.push(e);
				break;
			}
		}
	...
	for (let e = 0; e < 16; e++) {
		let t = new O();
		t.set(L[e], R[e], z[e], B[e], 0, 0), ze.push(t);
	}
}
Be();
var H = {
	...
	inv: (e) => e & 8 ? e & 15 : -e & 7,
	add: (e, t) => Re[e][t],
	sub: (e, t) => Re[e][H.inv(t)],
	rotate180: (e) => e ^ 4,
	isVertical: (e) => (e & 3) == 2,
	byDirection: (e, t) => Math.abs(e) * 2 <= Math.abs(t) ? t >= 0 ? H.S : H.N : Math.abs(t) * 2 <= Math.abs(e) ? e > 0 ? H.E : H.W : t > 0 ? e > 0 ? H.SE : H.SW : e > 0 ? H.NE : H.NW,
	matrixAppendRotationInv: (e, t, n = 0, r = 0, i = 0, a = 0) => {
		let o = ze[H.inv(t)], s = o.a, c = o.b, l = o.c, u = o.d, d = n - Math.min(0, s * i, l * a, s * i + l * a), f = r - Math.min(0, c * i, u * a, c * i + u * a), p = e.a, m = e.b, h = e.c, g = e.d;
	...
	transformRectCoords: (e, t, n, r) => {
		...
		return n === H.E ? (r.set(i + c, a + l, o, s), r) : n === H.S ? r.set(u - a - s + c, i + l, s, o) : n === H.W ? r.set(u - i - o + c, d - a - s + l, o, s) : n === H.N ? r.set(a + c, d - i - o + l, s, o) : r.set(i + c, a + l, o, s);
	}
}, Ve = () => {}, He = class extends I {
	constructor(e) {
...
He.extension = n.TextureSource;
//#endregion
//#region node_modules/pixi.js/lib/rendering/renderers/shared/texture/TextureMatrix.mjs
var Ue = new O(), We = class {
	constructor(e, t) {
		this.mapCoord = new O(), this.uClampFrame = /* @__PURE__ */ new Float32Array(4), this.uClampOffset = /* @__PURE__ */ new Float32Array(2), this._updateID = 0, this.clampOffset = 0, t === void 0 ? this.clampMargin = e.width < 10 ? 0 : .5 : this.clampMargin = t, this.isSimple = !1, this.texture = e;
	}
	get texture() {
	...
	update() {
		...
		r && (Ue.set(n.width / r.width, 0, 0, n.height / r.height, -r.x / r.width, -r.y / r.height), this.mapCoord.append(Ue));
	...
	constructor({ source: e, label: t, frame: n, orig: r, trim: i, defaultAnchor: a, defaultBorders: o, rotate: s, dynamic: c } = {}) {
		if (super(), this.uid = A("texture"), this.uvs = {
			x0: 0,
			y0: 0,
			x1: 0,
			y1: 0,
			...
			x3: 0,
			y3: 0
		}, this.frame = new F(), this.noFrame = !1, this.dynamic = !1, this.isTexture = !0, this.label = t, this.source = e?.source ?? new I(), this.noFrame = !n, n) this.frame.copyFrom(n);
		else {
	...
	get textureMatrix() {
		return this._textureMatrix ||= new We(this), this._textureMatrix;
	}
	get width() {
	...
	updateUvs() {
		...
		if (c) {
			...
			c = H.add(c, H.NW), e.x0 = r + t * H.uX(c), e.y0 = l + n * H.uY(c), c = H.add(c, 2), e.x1 = r + t * H.uX(c), e.y1 = l + n * H.uY(c), c = H.add(c, 2), e.x2 = r + t * H.uX(c), e.y2 = l + n * H.uY(c), c = H.add(c, 2), e.x3 = r + t * H.uX(c), e.y3 = l + n * H.uY(c);
	...
	get baseTexture() {
		return M(ye, "Texture.baseTexture is now Texture.source"), this._source;
	}
};
U.EMPTY = new U({
	label: "EMPTY",
	source: new I({ label: "EMPTY" })
}), U.EMPTY.destroy = Ve, U.WHITE = new U({
	source: new He({
...
}, qe = /* @__PURE__ */ Object.create(null), Je = /* @__PURE__ */ Object.create(null);
function W(e, t) {
	let n = Je[e];
	return n === void 0 && (qe[t] === void 0 && (qe[t] = 1), Je[e] = n = qe[t]++), n;
}
//#endregion
//#region node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/getTestContext.mjs
var G;
function Ye() {
	return (!G || G?.isContextLost()) && (G = Ke.get().createCanvas().getContext("webgl", {})), G;
}
//#endregion
...
function Xe() {
	if (!K) {
		K = "mediump";
		let e = Ye();
		e && e.getShaderPrecisionFormat && (K = e.getShaderPrecisionFormat(e.FRAGMENT_SHADER, e.HIGH_FLOAT).precision ? "highp" : "mediump");
	}
	return K;
}
//#endregion
...
var et = {}, tt = {};
function nt(e, { name: t = "pixi-program" }, n = !0) {
...
var it = {
	stripVersion: rt,
	ensurePrecision: Qe,
	addProgramDefines: Ze,
	setProgramName: nt,
	insertVersion: $e
}, q = /* @__PURE__ */ Object.create(null), at = class e {
	constructor(t) {
		t = {
			...e.defaultOptions,
			...t
		...
		let n = t.fragment.indexOf("#version 300 es") !== -1, r = {
			...
			ensurePrecision: {
				...
				maxSupportedFragmentPrecision: Xe()
			},
		...
		Object.keys(it).forEach((e) => {
			let t = r[e];
			i = it[e](i, t, !0), a = it[e](a, t, !1);
		}), this.fragment = i, this.vertex = a, this.transformFeedbackVaryings = t.transformFeedbackVaryings, this._key = W(`${this.vertex}:${this.fragment}`, "gl-program");
	}
	destroy() {
		this.fragment = null, this.vertex = null, this._attributeData = null, this._uniformData = null, this._uniformBlockData = null, this.transformFeedbackVaryings = null, q[this._cacheKey] = null;
	}
	static from(t) {
		let n = `${t.vertex}:${t.fragment}`;
		return q[n] || (q[n] = new e(t), q[n]._cacheKey = n), q[n];
	}
};
at.defaultOptions = {
...
var lt = {
	...
	"vec3<bool>": "uint32x3",
	"vec4<bool>": "uint32x4"
}, ut = /@location\((\d+)\)\s+([a-zA-Z0-9_]+)\s*:\s*([a-zA-Z0-9_<>]+)(?:,|\s|\)|$)/g;
function dt(e, t) {
	let n;
	for (; (n = ut.exec(e)) !== null;) {
		let e = lt[n[3]] ?? "float32";
		t[n[2]] = {
...
function pt({ source: e, entryPoint: t }) {
	let n = {}, r = ft(e), i = r.indexOf(`fn ${t}(`);
	if (i === -1) return n;
	let a = r.indexOf("->", i);
	if (a === -1) return n;
	let o = r.substring(i, a);
	if (dt(o, n), Object.keys(n).length === 0) {
...
var Y = /* @__PURE__ */ Object.create(null), vt = class e {
	constructor(e) {
		...
		if (this.name = a, this.fragment = t, this.vertex = n, t.source === n.source) {
			...
			let e = mt(n.source), r = mt(t.source);
			this.structsAndGroups = _t(e, r);
		}
		this.layout = r ?? gt(this.structsAndGroups), this.gpuLayout = i ?? ht(this.structsAndGroups), this.autoAssignGlobalUniforms = this.layout[0]?.globalUniforms !== void 0, this.autoAssignLocalUniforms = this.layout[1]?.localUniforms !== void 0, this._generateProgramKey();
	}
	_generateProgramKey() {
		let { vertex: e, fragment: t } = this, n = e.source + t.source + e.entryPoint + t.entryPoint;
		this._layoutKey = W(n, "program");
	}
	get attributeData() {
		return this._attributeData ??= pt(this.vertex), this._attributeData;
	}
	destroy() {
		this.gpuLayout = null, this.layout = null, this.structsAndGroups = null, this.fragment = null, this.vertex = null, Y[this._cacheKey] = null;
	}
	static from(t) {
		let n = `${t.vertex.source}:${t.fragment.source}:${t.fragment.entryPoint}:${t.vertex.entryPoint}`;
		return Y[n] || (Y[n] = new e(t), Y[n]._cacheKey = n), Y[n];
	}
}, X = class {
	constructor(e) {
...
}, Z = /* @__PURE__ */ ((e) => (e[e.WEBGL = 1] = "WEBGL", e[e.WEBGPU = 2] = "WEBGPU", e[e.CANVAS = 4] = "CANVAS", e[e.BOTH = 3] = "BOTH", e))(Z || {}), yt = [
	"f32",
	"i32",
	"vec2<f32>",
	"vec3<f32>",
...
var St = class e {
	constructor(t, n) {
		this._touched = 0, this.uid = A("uniform"), this._resourceType = "uniformGroup", this._resourceId = A("resource"), this.isUniformGroup = !0, this._dirtyId = 0, this.destroyed = !1, n = {
			...e.defaultOptions,
			...n
		...
		for (let e in t) {
			let n = t[e];
			if (n.name = e, n.size = n.size ?? 1, !bt[n.type]) {
				let e = n.type.match(/^array<(\w+(?:<\w+>)?),\s*(\d+)>$/);
				if (e) {
					let [, t, r] = e;
					throw Error(`Uniform type ${n.type} is not supported. Use type: '${t}', size: ${r} instead.`);
				}
				throw Error(`Uniform type ${n.type} is not supported. Supported uniform types are: ${yt.join(", ")}`);
			}
			n.value ??= xt(n.type, n.size), r[e] = n.value;
		}
		this.uniforms = r, this._dirtyId = 1, this.ubo = n.ubo, this.isStatic = n.isStatic, this._signature = W(Object.keys(r).map((e) => `${e}-${t[e].type}`).join("-"), "uniform-group");
	}
	update() {
		this._dirtyId++;
	}
...
var Ct = St, wt = class e extends o {
	constructor(e) {
		super(), this.uid = A("shader"), this._uniformBindMap = /* @__PURE__ */ Object.create(null), this._ownedBindGroups = [], this._destroyed = !1;
		let { gpuProgram: t, glProgram: n, groups: r, resources: i, compatibleRenderers: a, groupMap: o } = e;
		this.gpuProgram = t, this.glProgram = n, a === void 0 && (a = 0, t && (a |= Z.WEBGPU), n && (a |= Z.WEBGL)), this.compatibleRenderers = a;
		let s = {};
		...
		if (!t && r && o) for (let e in o) for (let t in o[e]) {
			...
			let e = 0;
			for (let t in i) s[t] || (r[99] || (r[99] = new X(), this._ownedBindGroups.push(r[99])), s[t] = {
				group: 99,
				binding: e,
				name: t
			...
			for (let e in i) {
				let t = e, n = i[e];
				!n.source && !n._resourceType && (n = new Ct(n));
				let a = s[t];
				a && (r[a.group] || (r[a.group] = new X(), this._ownedBindGroups.push(r[a.group])), r[a.group].setResource(n, a.binding));
			}
		}
	...
	addResource(e, t, n) {
		var r, i;
		(r = this._uniformBindMap)[t] || (r[t] = {}), (i = this._uniformBindMap[t])[n] || (i[n] = e), this.groups[t] || (this.groups[t] = new X(), this._ownedBindGroups.push(this.groups[t]));
	}
	...
	static from(t) {
		...
		return n && (a = vt.from(n)), r && (o = ot.from(r)), new e({
			gpuProgram: a,
			glProgram: o,
			...i
		});
	}
}, Q = /* @__PURE__ */ ((e) => (e[e.MAP_READ = 1] = "MAP_READ", e[e.MAP_WRITE = 2] = "MAP_WRITE", e[e.COPY_SRC = 4] = "COPY_SRC", e[e.COPY_DST = 8] = "COPY_DST", e[e.INDEX = 16] = "INDEX", e[e.VERTEX = 32] = "VERTEX", e[e.UNIFORM = 64] = "UNIFORM", e[e.STORAGE = 128] = "STORAGE", e[e.INDIRECT = 256] = "INDIRECT", e[e.QUERY_RESOLVE = 512] = "QUERY_RESOLVE", e[e.STATIC = 1024] = "STATIC", e))(Q || {}), $ = class extends o {
	constructor(e) {
		let { data: t, size: n } = e, { usage: r, label: i, shrinkToFit: a } = e;
		super(), this._gpuData = /* @__PURE__ */ Object.create(null), this._gcLastUsed = -1, this.autoGarbageCollect = !0, this.uid = A("buffer"), this._resourceType = "buffer", this._resourceId = A("resource"), this._touched = 0, this._updateID = 1, this._dataInt32 = null, this.shrinkToFit = !0, this.destroyed = !1, t instanceof Array && (t = new Float32Array(t)), this._data = t, n ??= t?.byteLength;
		let o = !!t;
		this.descriptor = {
			size: n,
			usage: r,
	...
	setDataWithSize(e, t, n) {
		...
		if (this._data = e, this._dataInt32 = null, !r || r.length !== e.length) {
			!this.shrinkToFit && r && e.byteLength < r.byteLength ? n && this.emit("update", this) : (this.descriptor.size = e.byteLength, this._resourceId = A("resource"), this.emit("change", this));
			return;
		}
		n && this.emit("update", this);
	}
...
function Tt(e, t) {
	if (!(e instanceof $)) {
		...
		e instanceof Array && (t ? (e = new Uint32Array(e), n = Q.INDEX | Q.COPY_DST) : (e = new Float32Array(e), n = Q.VERTEX | Q.COPY_DST)), e = new $({
			data: e,
...
function Dt(e) {
	return (e instanceof $ || Array.isArray(e) || e.BYTES_PER_ELEMENT) && (e = { buffer: e }), e.buffer = Tt(e.buffer, !1), e;
}
var Ot = class extends o {
	constructor(e = {}) {
		super(), this._gpuData = /* @__PURE__ */ Object.create(null), this.autoGarbageCollect = !0, this._gcLastUsed = -1, this.uid = A("geometry"), this._layoutKey = 0, this.instanceCount = 1, this._bounds = new De(), this._boundsDirty = !0;
	...
	addIndex(e) {
		this.indexBuffer = Tt(e, !0), this.buffers.push(this.indexBuffer);
	}
	get bounds() {
		return this._boundsDirty ? (this._boundsDirty = !1, Et(this, "aPosition", this._bounds)) : this._bounds;
	}
	unload() {
		this.emit("unload", this);
		for (let e in this._gpuData) this._gpuData[e]?.destroy();
...
//#endregion
export { ye as A, a as B, Oe as C, Ce as D, Te as E, he as F, me as I, fe as L, A as M, O as N, Se as O, E as P, o as R, ke as S, F as T, H as _, Ct as a, Me as b, vt as c, Ye as d, W as f, He as g, We as h, wt as i, be as j, M as k, ct as l, U as m, $ as n, Z as o, Ke as p, Q as r, X as s, Ot as t, ot as u, I as v, De as w, Ae as x, Ie as y, n as z };
