import { A as e, B as t, C as n, D as r, E as i, F as a, I as o, L as s, M as c, N as l, O as u, P as d, R as ee, S as te, c as ne, i as re, k as f, m as p, p as ie, u as ae, v as m, w as h, x as g, y as oe, z as _ } from "./Geometry-DGpI5VLa.js";
...
var se = {
	...
	set cacheAsBitmap(e) {
		f("v8.6.0", "cacheAsBitmap is deprecated, use cacheAsTexture instead."), this.cacheAsTexture(e);
	}
};
//#endregion
...
var le = {
	...
	addChildAt(t, n) {
		this.allowChildren || f(e, "addChildAt: Only Containers will be allowed to add children in v8.0.0");
		let { children: r } = this;
		if (n < 0 || n > r.length) throw Error(`${t}addChildAt: The index ${n} supplied is out of bounds ${r.length}`);
		let i = t.parent === this;
		if (t.parent) {
		...
		n === r.length ? r.push(t) : r.splice(n, 0, t), t.parent = this, t.didChange = !0, t._updateFlags = 15;
		let a = this.renderGroup || this.parentRenderGroup;
		return a && a.addChild(t), this.sortableChildren && (this.sortDirty = !0), i ? t : (this.emit("childAdded", t, this, n), t.emit("added", this), t);
	},
	swapChildren(e, t) {
		if (e === t) return;
	...
	getMaskEffect(e) {
		...
		for (let t = 0; t < this._tests.length; t++) {
			let n = this._tests[t];
			if (n.test(e)) return i.get(n.maskClass, e);
		}
		return e;
	}
	returnMaskEffect(e) {
...
t.handleByList(_.MaskEffect, x._effectClasses);
//#endregion
...
var de = {
	...
	set mask(e) {
		...
		t?.mask !== e && (t && (this.removeEffect(t), x.returnMaskEffect(t), this._maskEffect = null), e != null && (this._maskEffect = x.getMaskEffect(e), this.addEffect(this._maskEffect)));
	},
	get mask() {
	...
	set filters(e) {
		...
		let t = this._filterEffect ||= new b();
		e = e;
	...
	set filterArea(e) {
		this._filterEffect ||= new b(), this._filterEffect.filterArea = e;
	},
	get filterArea() {
	...
	label: null,
	get name() {
		return f(e, "Container.name property has been removed, use Container.label instead"), this.label;
	},
	set name(t) {
		f(e, "Container.name property has been removed, use Container.label instead"), this.label = t;
	},
...
}, C = i.getPool(l), w = i.getPool(h), fe = new l(), pe = {
	getFastGlobalBounds(e, t) {
		t ||= new h(), t.clear(), this._getGlobalBoundsRecursive(!!e, t, this.parentRenderLayer), t.isValid || t.set(0, 0, 0, 0);
	...
	_getGlobalBoundsRecursive(e, t, n) {
		...
		if ((this.renderGroup || i) && (r = w.get().clear()), this.boundsArea) t.addRect(this.boundsArea, this.worldTransform);
		else {
		...
		if (i) {
			...
			e && r.applyMatrix(n.worldTransform.copyTo(fe).invert()), t.addBounds(r), w.return(r);
		} else this.renderGroup && (t.addBounds(r, this.relativeGroupTransform), w.return(r));
	}
};
//#endregion
...
function T(e, t, n) {
	n.clear();
	let r, i;
	return e.parent ? t ? r = e.parent.worldTransform : (i = C.get().identity(), r = D(e, i)) : r = l.IDENTITY, E(e, n, r, t), i && C.return(i), n.isValid || n.set(0, 0, 0, 0), n;
}
function E(e, t, n, r) {
	if (!e.visible || !e.measurable) return;
	let i;
	r ? i = e.worldTransform : (e.updateLocalTransform(), i = C.get(), i.appendFrom(e.localTransform, n));
	let a = t, o = !!e.effects.length;
	if (o && (t = w.get().clear()), e.boundsArea) t.addRect(e.boundsArea, i);
	else {
		let n = e.bounds;
		n && !n.isEmpty() && (t.matrix = i, t.addBounds(n));
		for (let n = 0; n < e.children.length; n++) E(e.children[n], t, i, r);
	}
	if (o) {
		for (let n = 0; n < e.effects.length; n++) e.effects[n].addBounds?.(t);
		a.addBounds(t, l.IDENTITY), w.return(t);
	}
	r || C.return(i);
}
function D(e, t) {
	let n = e.parent;
	return n && (D(n, t), n.updateLocalTransform(), t.append(n.localTransform)), t;
}
//#endregion
//#region node_modules/pixi.js/lib/scene/container/utils/multiplyColors.mjs
var O = 16777215;
function k(e, t) {
	return e === O ? t : t === O ? e : n(e, t);
}
//#endregion
...
var me = {
	...
	getGlobalTransform(e = new l(), t) {
		...
		let n = D(this, C.get().identity());
		return e.appendFrom(this.localTransform, n), C.return(n), e;
	},
	getGlobalTint(e) {
		if (e) return this.renderGroup ? A(this.renderGroup.worldColor) : this.parentRenderGroup ? A(k(this.localColor, this.parentRenderGroup.worldColor)) : this.tint;
		let t = this.localColor, n = this.parent;
		for (; n;) t = k(t, n.localColor), n = n.parent;
		return A(t);
	}
};
//#endregion
...
function j(e, t, n) {
	return t.clear(), n ||= l.IDENTITY, M(e, t, n, e, !0), t.isValid || t.set(0, 0, 0, 0), t;
}
function M(e, t, n, r, i) {
	let a;
	if (i) a = C.get(), a = n.copyTo(a);
	else {
		if (!e.visible || !e.measurable) return;
		e.updateLocalTransform();
		let t = e.localTransform;
		a = C.get(), a.appendFrom(t, n);
	}
	let o = t, s = !!e.effects.length;
	if (s && (t = w.get().clear()), e.boundsArea) t.addRect(e.boundsArea, a);
	else {
		e.renderPipeId && (t.matrix = a, t.addBounds(e.bounds));
		let n = e.children;
		for (let e = 0; e < n.length; e++) M(n[e], t, a, r, !1);
	}
	if (s) {
		for (let n = 0; n < e.effects.length; n++) e.effects[n].addLocalBounds?.(t, r);
		o.addBounds(t, l.IDENTITY), w.return(t);
	}
	C.return(a);
}
//#endregion
...
function N(e, t) {
	...
	for (let e = 0; e < n.length; e++) {
		...
		(t.data[o] !== i || t.data[o + 1] !== a) && (t.data[t.index] = i, t.data[t.index + 1] = a, t.didChange = !0), t.index = o + 2, r.children.length && N(r, t);
	}
	return t.didChange;
}
//#endregion
...
var P = new l(), F = {
	...
	getLocalBounds() {
		...
		return e.index = 1, e.didChange = !1, e.data[0] !== this._didViewChangeTick && (e.didChange = !0, e.data[0] = this._didViewChangeTick), N(this, e), e.didChange && j(this, e.localBounds, P), e.localBounds;
	},
	getBounds(e, t) {
		return T(this, e, t || new h());
	}
}, I = {
	_onRender: null,
	set onRender(e) {
...
var he = {
	getGlobalPosition(e = new d(), t = !1) {
		return this.parent ? this.parent.toGlobal(this._position, e, t) : (e.x = this._position.x, e.y = this._position.y), e;
	},
	toGlobal(e, t, n = !1) {
		let r = this.getGlobalTransform(C.get(), n);
		return t = r.apply(e, t), C.return(r), t;
	},
	toLocal(e, t, n, r) {
		t && (e = t.toGlobal(e, n, r));
		let i = this.getGlobalTransform(C.get(), r);
		return n = i.applyInverse(e, n), C.return(i), n;
	}
}, ge = 0, z = new class {
	constructor(e) {
		this._poolKeyHash = /* @__PURE__ */ Object.create(null), this._texturePool = {}, this.textureOptions = e || {}, this.enableFullScreen = !1, this.textureStyle = new oe(this.textureOptions);
	}
	createTexture(e, t, n, r) {
		...
		return new p({
			source: i,
			label: `texturePool_${ge++}`
		});
	}
	getOptimalTexture(e, t, n = 1, r, i = !1) {
		let a = Math.ceil(e * n - 1e-6), o = Math.ceil(t * n - 1e-6);
		a = g(a), o = g(o);
		let s = +!!r, c = +!!i, l = (a << 17) + (o << 2) + (c << 1) + s;
		this._texturePool[l] || (this._texturePool[l] = []);
		let u = this._texturePool[l].pop();
		return u ||= this.createTexture(a, o, r, i), u.source._resolution = n, u.source.width = a / n, u.source.height = o / n, u.source.pixelWidth = a, u.source.pixelHeight = o, u.frame.x = 0, u.frame.y = 0, u.frame.width = e, u.frame.height = t, u.updateUvs(), this._poolKeyHash[u.uid] = l, u;
	}
...
var B = class {
	constructor() {
		this.renderPipeId = "renderGroup", this.root = null, this.canBundle = !1, this.renderGroupParent = null, this.renderGroupChildren = [], this.worldTransform = new l(), this.worldColorAlpha = 4294967295, this.worldColor = 16777215, this.worldAlpha = 1, this.childrenToUpdate = /* @__PURE__ */ Object.create(null), this.updateTick = 0, this.gcTick = 0, this.childrenRenderablesToUpdate = {
			list: [],
			index: 0
		}, this.structureDidChange = !0, this.instructionSet = new te(), this._onRenderContainers = [], this.textureNeedsUpdate = !0, this.isCachedAsTexture = !1, this._matrixDirty = 7;
	}
	init(e) {
	...
	disableCacheAsTexture() {
		this.isCachedAsTexture = !1, this.texture &&= (z.returnTexture(this.texture, !0), null);
	}
	updateCacheTexture() {
	...
	get inverseWorldTransform() {
		return this._matrixDirty & 1 ? (this._matrixDirty &= -2, this._inverseWorldTransform ||= new l(), this._inverseWorldTransform.copyFrom(this.worldTransform).invert()) : this._inverseWorldTransform;
	}
	get textureOffsetInverseTransform() {
		return this._matrixDirty & 2 ? (this._matrixDirty &= -3, this._textureOffsetInverseTransform ||= new l(), this._textureOffsetInverseTransform.copyFrom(this.inverseWorldTransform).translate(-this._textureBounds.x, -this._textureBounds.y)) : this._textureOffsetInverseTransform;
	}
	get inverseParentTextureTransform() {
		if (!(this._matrixDirty & 4)) return this._inverseParentTextureTransform;
		this._matrixDirty &= -5;
		let e = this._parentCacheAsTextureRenderGroup;
		return e ? (this._inverseParentTextureTransform ||= new l(), this._inverseParentTextureTransform.copyFrom(this.worldTransform).prepend(e.inverseWorldTransform).translate(-e._textureBounds.x, -e._textureBounds.y)) : this.worldTransform;
	}
...
var V = new v(null), H = new v(null), U = new v(null, 1, 1), W = new v(null), G = class n extends ee {
	constructor(e = {}) {
		super(), this.uid = c("renderable"), this._updateFlags = 15, this.renderGroup = null, this.parentRenderGroup = null, this.parentRenderGroupIndex = 0, this.didChange = !1, this.didViewUpdate = !1, this.relativeRenderGroupDepth = 0, this.children = [], this.parent = null, this.includeInBuild = !0, this.measurable = !0, this.isSimple = !0, this.parentRenderLayer = null, this.updateTick = -1, this.localTransform = new l(), this.relativeGroupTransform = new l(), this.groupTransform = this.relativeGroupTransform, this.destroyed = !1, this._position = new v(this, 0, 0), this._scale = U, this._pivot = H, this._origin = W, this._skew = V, this._cx = 1, this._sx = 0, this._cy = 0, this._sy = 1, this._rotation = 0, this.localColor = 16777215, this.localAlpha = 1, this.groupAlpha = 1, this.groupColor = 16777215, this.groupColorAlpha = 4294967295, this.localBlendMode = "inherit", this.groupBlendMode = "normal", this.localDisplayStatus = 7, this.globalDisplayStatus = 7, this._didContainerChangeTick = 0, this._didViewChangeTick = 0, this._didLocalTransformChangeId = -1, this.effects = [], _e(this, e, {
			children: !0,
			parent: !0,
			effects: !0
	...
	static mixin(e) {
		f("8.8.0", "Container.mixin is deprecated, please use extensions.mixin instead."), t.mixin(n, e);
	}
	set _didChangeId(e) {
	...
	addChild(...t) {
		if (this.allowChildren || f(e, "addChild: Only Containers will be allowed to add children in v8.0.0"), t.length > 1) {
			for (let e = 0; e < t.length; e++) this.addChild(t[e]);
			return t[0];
		}
		let n = t[0], r = this.renderGroup || this.parentRenderGroup;
	...
	enableRenderGroup() {
		...
		e?.removeChild(this), this.renderGroup = i.get(B, this), this.groupTransform = l.IDENTITY, e?.addChild(this), this._updateIsSimple();
	}
	disableRenderGroup() {
		if (!this.renderGroup) return;
		let e = this.parentRenderGroup;
		e?.removeChild(this), i.return(this.renderGroup), this.renderGroup = null, this.groupTransform = this.relativeGroupTransform, e?.addChild(this), this._updateIsSimple();
	}
	_updateIsSimple() {
		this.isSimple = !this.renderGroup && this.effects.length === 0;
	}
	get worldTransform() {
		return this._worldTransform ||= new l(), this.renderGroup ? this._worldTransform.copyFrom(this.renderGroup.worldTransform) : this.parentRenderGroup && this._worldTransform.appendFrom(this.relativeGroupTransform, this.parentRenderGroup.worldTransform), this._worldTransform;
	}
	get x() {
	...
	get pivot() {
		return this._pivot === H && (this._pivot = new v(this, 0, 0)), this._pivot;
	}
	set pivot(e) {
		this._pivot === H && (this._pivot = new v(this, 0, 0), this._origin !== W && u("Setting both a pivot and origin on a Container is not recommended. This can lead to unexpected behavior if not handled carefully.")), typeof e == "number" ? this._pivot.set(e) : this._pivot.copyFrom(e);
	}
	get skew() {
		return this._skew === V && (this._skew = new v(this, 0, 0)), this._skew;
	}
	set skew(e) {
		this._skew === V && (this._skew = new v(this, 0, 0)), this._skew.copyFrom(e);
	}
	get scale() {
		return this._scale === U && (this._scale = new v(this, 1, 1)), this._scale;
	}
	set scale(e) {
		this._scale === U && (this._scale = new v(this, 0, 0)), typeof e == "string" && (e = parseFloat(e)), typeof e == "number" ? this._scale.set(e) : this._scale.copyFrom(e);
	}
	get origin() {
		return this._origin === W && (this._origin = new v(this, 0, 0)), this._origin;
	}
	set origin(e) {
		this._origin === W && (this._origin = new v(this, 0, 0), this._pivot !== H && u("Setting both a pivot and origin on a Container is not recommended. This can lead to unexpected behavior if not handled carefully.")), typeof e == "number" ? this._origin.set(e) : this._origin.copyFrom(e);
	}
	get width() {
	...
	set tint(e) {
		let t = s.shared.setValue(e ?? 16777215).toBgrNumber();
		t !== this.localColor && (this.localColor = t, this._updateFlags |= 1, this._onUpdate());
	}
	get tint() {
		return A(this.localColor);
	}
	set blendMode(e) {
...
t.mixin(G, le, pe, he, I, F, de, S, L, se, ce, me, ue);
//#endregion
//#region node_modules/pixi.js/lib/ticker/const.mjs
var K = /* @__PURE__ */ ((e) => (e[e.INTERACTION = 50] = "INTERACTION", e[e.HIGH = 25] = "HIGH", e[e.NORMAL = 0] = "NORMAL", e[e.LOW = -25] = "LOW", e[e.UTILITY = -50] = "UTILITY", e))(K || {}), q = class {
	...
	constructor() {
		this.autoStart = !1, this.deltaTime = 1, this.lastTime = -1, this.speed = 1, this.started = !1, this._requestId = null, this._maxElapsedMS = 100, this._minElapsedMS = 0, this._protected = !1, this._lastFrame = -1, this._head = new q(null, null, Infinity), this.deltaMS = 1 / e.targetFPMS, this.elapsedMS = 1 / e.targetFPMS, this._tick = (e) => {
	...
	add(e, t, n = K.NORMAL) {
		return this._addListener(new q(e, t, n));
	}
	addOnce(e, t, n = K.NORMAL) {
		return this._addListener(new q(e, t, n, !0));
	}
	_addListener(e) {
...
J.targetFPMS = .06;
var ve = J, Y = class extends G {
	constructor(e) {
		super(e), this.canBundle = !0, this.allowChildren = !1, this._roundPixels = 0, this._lastUsed = -1, this._gpuData = /* @__PURE__ */ Object.create(null), this.autoGarbageCollect = !0, this._gcLastUsed = -1, this._bounds = new h(0, 1, 0, 0), this._boundsDirty = !0, this.autoGarbageCollect = e.autoGarbageCollect ?? !0;
	}
	get bounds() {
...
var be = class e extends Y {
	constructor(e = p.EMPTY) {
		e instanceof p && (e = { texture: e });
		let { texture: t = p.EMPTY, anchor: n, roundPixels: r, width: i, height: a, ...o } = e;
		super({
			label: "Sprite",
			...o
	...
	static from(t, n = !1) {
		return t instanceof p ? new e(t) : new e(p.from(t, n));
	}
	set texture(e) {
		e ||= p.EMPTY;
		let t = this._texture;
	...
	get visualBounds() {
		return ye(this._visualBounds, this._anchor, this._texture), this._visualBounds;
	}
	get sourceBounds() {
...
var xe = {
	...
	set blend(e) {
		!!(this.data & 1) !== e && (this.data ^= 1);
	}
	get offsets() {
		return !!(this.data & 2);
	}
	set offsets(e) {
		!!(this.data & 2) !== e && (this.data ^= 2);
	}
	set cullMode(e) {
		if (e === "none") {
			this.culling = !1;
	...
	set culling(e) {
		!!(this.data & 4) !== e && (this.data ^= 4);
	}
	get depthTest() {
		return !!(this.data & 8);
	}
	set depthTest(e) {
		!!(this.data & 8) !== e && (this.data ^= 8);
	}
	get depthMask() {
		return !!(this.data & 32);
	}
	set depthMask(e) {
		!!(this.data & 32) !== e && (this.data ^= 32);
	}
	get clockwiseFrontFace() {
		return !!(this.data & 16);
	}
	set clockwiseFrontFace(e) {
		!!(this.data & 16) !== e && (this.data ^= 16);
	}
	get blendMode() {
		return this._blendMode;
	}
	set blendMode(e) {
		this.blend = e !== "none", this._blendMode = e, this._blendModeId = xe[e] || 0;
	}
	get polygonOffset() {
...
Z.default2d = Z.for2d();
var Q = Z, $ = class e extends re {
	constructor(t) {
		t = {
			...e.defaultOptions,
			...t
		}, super(t), this.enabled = !0, this._state = Q.for2d(), this.blendMode = t.blendMode, this.padding = t.padding, this.antialias = typeof t.antialias == "boolean" ? t.antialias ? "on" : "off" : t.antialias, this.resolution = t.resolution, this.blendRequired = t.blendRequired, this.clipToViewport = t.clipToViewport, this.addResource("uTexture", 0, 1), t.blendRequired && this.addResource("uBackTexture", 0, 3);
	}
	apply(e, t, n, r) {
	...
	static from(t) {
		...
		return n && (a = ne.from(n)), r && (o = ae.from(r)), new e({
			gpuProgram: a,
			glProgram: o,
			...i
		});
...
var Se = $;
//#endregion
export { b as _, Y as a, G as c, j as d, A as f, C as g, w as h, be as i, B as l, T as m, Q as n, ve as o, k as p, X as r, K as s, Se as t, z as u, y as v };
