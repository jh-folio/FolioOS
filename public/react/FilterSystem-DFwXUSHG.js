import { B as e, N as t, O as n, T as r, a as i, c as a, g as o, m as s, o as c, p as l, s as u, t as d, u as f, v as p, w as m, z as h } from "./Geometry-BFCE0DPo.js";
import { c as g, d as _, g as v, h as y, i as b, m as ee, o as x, r as te, t as ne, u as S } from "./Filter-Bn4pCCDL.js";
import { n as C, t as w } from "./Cache-BRp-gP8S.js";
import { r as re, t as ie } from "./canvasUtils-BTqx9q1Z.js";
import { t as ae } from "./CanvasPool-MBzGEYFt.js";
//#region node_modules/pixi.js/lib/assets/loader/parsers/LoaderParser.mjs
var T = /* @__PURE__ */ ((e) => (e[e.Low = 0] = "Low", e[e.Normal = 1] = "Normal", e[e.High = 2] = "High", e))(T || {});
//#endregion
...
function se(e, t, n) {
	return e.replace(new RegExp(oe(t), "g"), n);
}
function ce(e, t) {
...
var O = {
	...
	toAbsolute(e, t, n) {
		if (E(e), this.isDataUrl(e) || this.isBlobUrl(e)) return e;
		let r = D(this.toPosix(t ?? l.get().getBaseUrl())), i = D(this.toPosix(n ?? this.rootname(r)));
		return e = this.toPosix(e), e.startsWith("/") ? O.join(i, e.slice(1)) : this.isAbsolute(e) ? e : this.join(r, e);
	},
	normalize(e) {
		...
		let r = e.endsWith("/");
		return e = ce(e, !1), e.length > 0 && r && (e += "/"), n ? `/${e}` : t + e;
	},
	isAbsolute(e) {
		return E(e), e = this.toPosix(e), this.hasProtocol(e) ? !0 : e.startsWith("/");
	},
	join(...e) {
		...
		for (let n = 0; n < e.length; ++n) {
			let r = e[n];
			if (E(r), r.length > 0) if (t === void 0) t = r;
			else {
				let i = e[n - 1] ?? "";
...
function k(e, t, n, r, i) {
	...
	for (let o = 0; o < a.length; o++) {
		let s = a[o];
		n < t.length - 1 ? k(e.replace(r[n], s), t, n + 1, r, i) : i.push(e.replace(r[n], s));
	}
}
function le(e) {
	let t = e.match(/\{(.*?)\}/g), n = [];
...
var A = (e) => !Array.isArray(e), j = class {
	constructor() {
	...
	getAlias(e) {
		let { alias: t, src: n } = e;
		return C(t || n, (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map((e) => e?.src ?? e) : e?.src ? e.src : e, !0);
	}
	removeAlias(e, t) {
	...
	add(e) {
		...
		C(t).forEach((e) => {
			let { src: t } = e, { data: n, format: i, loadParser: a, parser: o } = e, s = C(t).map((e) => typeof e == "string" ? le(e) : Array.isArray(e) ? e : [e]), c = this.getAlias(e);
	...
	_buildResolvedAsset(e, t) {
		...
		return (this._basePath || this._rootPath) && (e.src = O.toAbsolute(e.src, this._basePath, this._rootPath)), e.alias = n ?? e.alias ?? [e.src], e.src = this._appendDefaultSearchParams(e.src), e.data = {
			...r || {},
			...e.data
		}, e.loadParser = i ?? e.loadParser, e.parser = a ?? e.parser, e.format = o ?? e.format ?? ue(e.src), s !== void 0 && (e.progressSize = s), e;
	}
};
...
var M = (e, t) => {
	...
	constructor(e, t) {
		this.linkedSheets = [];
		let n = e;
		e?.source instanceof p && (n = {
			texture: e,
			data: t
		});
		let { texture: r, data: i, cachePrefix: a = "" } = n;
		this.cachePrefix = a, this._texture = r instanceof s ? r : null, this.textureSource = r.source, this.textures = {}, this.animations = {}, this.data = i;
	...
	_processFrames(t, n = !1) {
		let i = t, a = n ? Infinity : e.BATCH_SIZE;
		for (; i - t < a && i < this._frameKeys.length;) {
			let e = this._frameKeys[i], t = this._frames[e], n = t.frame;
			if (n) {
				let i = null, a = null, o = t.trimmed !== !1 && t.sourceSize ? t.sourceSize : t.frame, c = new r(0, 0, Math.floor(o.w) / this.resolution, Math.floor(o.h) / this.resolution);
				i = t.rotated ? new r(Math.floor(n.x) / this.resolution, Math.floor(n.y) / this.resolution, Math.floor(n.h) / this.resolution, Math.floor(n.w) / this.resolution) : new r(Math.floor(n.x) / this.resolution, Math.floor(n.y) / this.resolution, Math.floor(n.w) / this.resolution, Math.floor(n.h) / this.resolution), t.trimmed !== !1 && t.spriteSourceSize && (a = new r(Math.floor(t.spriteSourceSize.x) / this.resolution, Math.floor(t.spriteSourceSize.y) / this.resolution, Math.floor(n.w) / this.resolution, Math.floor(n.h) / this.resolution)), this.textures[e] = new s({
...
function F(e, t, n) {
	...
	if (e.forEach((e) => {
		...
		t.linkedSheets.forEach((e, i) => {
			let a = F([`${n}/${t.data.meta.related_multi_packs[i]}`], e, !0);
			Object.assign(r, a);
		});
	}
	return r;
...
var fe = {
	...
	cache: {
		...
		getCacheableAssets: (e, t) => F(e, t, !1)
	},
	resolver: {
		extension: {
			type: h.ResolveParser,
			name: "resolveSpritesheet"
		},
		test: (e) => {
			let t = e.split("?")[0].split("."), n = t.pop(), r = t.pop();
			return n === "json" && de.includes(r);
		},
		parse: (e) => {
			let t = e.split(".");
			return {
	...
	loader: {
		...
		async testParse(e, t) {
			return O.extname(t.src).toLowerCase() === ".json" && !!e.frames;
		},
		async parse(e, t, n) {
			let { texture: r, imageFilename: i, textureOptions: a, cachePrefix: o } = t?.data ?? {}, c = O.dirname(t.src);
			c && c.lastIndexOf("/") !== c.length - 1 && (c += "/");
			let l;
			if (r instanceof s) l = r;
			else {
				let r = M(c + (i ?? e.meta.image), t.src);
				l = (await n.load([{
					src: r,
					data: a
				}]))[r];
			...
			if (Array.isArray(d)) {
				...
				for (let r of d) {
					...
					let i = c + r;
					t.data?.ignoreMultiPack || (i = M(i, t.src), e.push(n.load({
						src: i,
						data: {
							textureOptions: a,
							ignoreMultiPack: !0
...
function L(e, t, n) {
	let r = y.get();
	e.measurable = !0;
	let i = v.get().identity();
	_(e, r, R(e, n, i)), e.measurable = !1, t.addBoundsMask(r), v.return(i), y.return(r);
}
function R(e, t, r) {
	return e ? (e !== t && (R(e.parent, t, r), e.updateLocalTransform(), r.append(e.localTransform)), r) : (n("Mask bounds, renderable is not inside the root container"), r);
}
//#endregion
...
var z = class {
	...
	init(e) {
		this.mask = e, this.renderMaskToTexture = !(e instanceof b), this.mask.renderable = this.renderMaskToTexture, this.mask.includeInBuild = !this.renderMaskToTexture, this.mask.measurable = !1;
	}
	reset() {
		this.mask !== null && (this.mask.measurable = !0, this.mask = null);
	}
	addBounds(e, t) {
		this.inverse || I(this.mask, e, t);
	}
	addLocalBounds(e, t) {
		L(this.mask, e, t);
	}
...
var W = class e extends p {
	...
	updateFrame() {
		if (!this.destroyed) {
			if (this._updateFPS) {
				let e = x.shared.elapsedMS * this.resource.playbackRate;
	...
	_configureAutoUpdate() {
		this._autoUpdate && this._isSourcePlaying() ? !this._updateFPS && this.resource.requestVideoFrameCallback ? (this._isConnectedToTicker && (x.shared.remove(this.updateFrame, this), this._isConnectedToTicker = !1, this._msToNextUpdate = 0), this._videoFrameRequestCallbackHandle === null && (this._videoFrameRequestCallbackHandle = this.resource.requestVideoFrameCallback(this._videoFrameRequestCallback))) : (this._videoFrameRequestCallbackHandle !== null && (this.resource.cancelVideoFrameCallback(this._videoFrameRequestCallbackHandle), this._videoFrameRequestCallbackHandle = null), this._isConnectedToTicker || (x.shared.add(this.updateFrame, this), this._isConnectedToTicker = !0, this._msToNextUpdate = 0)) : (this._videoFrameRequestCallbackHandle !== null && (this.resource.cancelVideoFrameCallback(this._videoFrameRequestCallbackHandle), this._videoFrameRequestCallbackHandle = null), this._isConnectedToTicker && (x.shared.remove(this.updateFrame, this), this._isConnectedToTicker = !1, this._msToNextUpdate = 0));
	}
	static test(e) {
		return globalThis.HTMLVideoElement && e instanceof HTMLVideoElement;
	}
};
W.extension = h.TextureSource, W.defaultOptions = {
	...p.defaultOptions,
	autoLoad: !0,
	autoPlay: !0,
	updateFPS: 0,
...
var G = W, K = [];
e.handleByList(h.TextureSource, K);
function q(e = {}) {
...
function me(e = {}, t = !1) {
	...
	if (!t && w.has(r)) return w.get(r);
	let a = new s({ source: q(i) });
	return a.on("destroy", () => {
		w.has(r) && w.remove(r);
	}), t || w.set(r, a), a;
}
function he(e, t = !1) {
	return typeof e == "string" ? w.get(e) : e instanceof p ? new s({ source: e }) : me(e, t);
}
//#endregion
//#region node_modules/pixi.js/lib/rendering/init.mjs
s.from = he, p.from = q, e.add(z, B, V, G, re, te, o);
//#endregion
...
function Y(e, t) {
	...
	for (let n = 0; n < e.length; n++) {
		...
		i?.isCachedAsTexture ? t.matrix = J.copyFrom(i.textureOffsetInverseTransform).append(r.worldTransform) : i?._parentCacheAsTextureRenderGroup ? t.matrix = J.copyFrom(i._parentCacheAsTextureRenderGroup.inverseWorldTransform).append(r.groupTransform) : t.matrix = r.worldTransform, t.addBounds(r.bounds);
	}
	return t.matrix = n, t;
}
//#endregion
...
var ge = new m();
function _e(e, t, n, r, i = !1) {
	let a = ge;
	a.minX = 0, a.minY = 0, a.maxX = e.width / r | 0, a.maxY = e.height / r | 0;
	let o = S.getOptimalTexture(a.width, a.height, r, !1, i);
...
var ve = class {
	constructor() {
		this.skip = !1, this.useClip = !1, this.filters = null, this.container = null, this.bounds = new m(), this.cssFilterString = "";
	}
}, Z = class {
	constructor(e) {
	...
	generateFilteredTexture({ texture: e, filters: t }) {
		...
		let r = ie.getCanvasSource(e);
		if (!r) return e;
		let i = e.frame, a = e.source._resolution ?? e.source.resolution ?? 1, o = i.width, s = i.height, { canvas: c, context: l } = ae.getOptimalCanvasAndContext(o, s, a);
		l.setTransform(1, 0, 0, 1, 0, 0), l.clearRect(0, 0, c.width, c.height), n.length && (l.filter = n.join(" "));
		let u = i.x * a, d = i.y * a, f = o * a, p = s * a;
		return l.drawImage(r, u, d, f, p, 0, 0, f, p), l.filter = "none", l.globalAlpha = 1, _e(c, o, s, a);
	}
	_calculateFilterArea(e, t) {
		if (e.renderables ? Y(e.renderables, t) : e.filterEffect.filterArea ? (t.clear(), t.addRect(e.filterEffect.filterArea), t.applyMatrix(e.container.worldTransform)) : e.container.getFastGlobalBounds(!0, t), e.container) {
	...
	_pushFilterFrame() {
		...
		return e ||= this._filterStack[this._filterStackIndex] = new ve(), this._filterStackIndex++, e;
	}
	_popFilterFrame() {
...
var ye = "in vec2 aPosition;\nout vec2 vTextureCoord;\n\nuniform vec4 uInputSize;\nuniform vec4 uOutputFrame;\nuniform vec4 uOutputTexture;\n\nvec4 filterVertexPosition( void )\n{\n    vec2 position = aPosition * uOutputFrame.zw + uOutputFrame.xy;\n    \n    position.x = position.x * (2.0 / uOutputTexture.x) - 1.0;\n    position.y = position.y * (2.0*uOutputTexture.z / uOutputTexture.y) - uOutputTexture.z;\n\n    return vec4(position, 0.0, 1.0);\n}\n\nvec2 filterTextureCoord( void )\n{\n    return aPosition * (uOutputFrame.zw * uInputSize.zw);\n}\n\nvoid main(void)\n{\n    gl_Position = filterVertexPosition();\n    vTextureCoord = filterTextureCoord();\n}\n", be = "in vec2 vTextureCoord;\nout vec4 finalColor;\nuniform sampler2D uTexture;\nvoid main() {\n    finalColor = texture(uTexture, vTextureCoord);\n}\n", xe = "struct GlobalFilterUniforms {\n  uInputSize: vec4<f32>,\n  uInputPixel: vec4<f32>,\n  uInputClamp: vec4<f32>,\n  uOutputFrame: vec4<f32>,\n  uGlobalFrame: vec4<f32>,\n  uOutputTexture: vec4<f32>,\n};\n\n@group(0) @binding(0) var <uniform> gfu: GlobalFilterUniforms;\n@group(0) @binding(1) var uTexture: texture_2d<f32>;\n@group(0) @binding(2) var uSampler: sampler;\n\nstruct VSOutput {\n  @builtin(position) position: vec4<f32>,\n  @location(0) uv: vec2<f32>\n};\n\nfn filterVertexPosition(aPosition: vec2<f32>) -> vec4<f32>\n{\n    var position = aPosition * gfu.uOutputFrame.zw + gfu.uOutputFrame.xy;\n\n    position.x = position.x * (2.0 / gfu.uOutputTexture.x) - 1.0;\n    position.y = position.y * (2.0 * gfu.uOutputTexture.z / gfu.uOutputTexture.y) - gfu.uOutputTexture.z;\n\n    return vec4(position, 0.0, 1.0);\n}\n\nfn filterTextureCoord(aPosition: vec2<f32>) -> vec2<f32>\n{\n    return aPosition * (gfu.uOutputFrame.zw * gfu.uInputSize.zw);\n}\n\n@vertex\nfn mainVertex(\n  @location(0) aPosition: vec2<f32>,\n) -> VSOutput {\n  return VSOutput(\n   filterVertexPosition(aPosition),\n   filterTextureCoord(aPosition)\n  );\n}\n\n@fragment\nfn mainFragment(\n  @location(0) uv: vec2<f32>,\n) -> @location(0) vec4<f32> {\n    return textureSample(uTexture, uSampler, uv);\n}\n", Se = class extends ne {
	...
	constructor() {
		this.skip = !1, this.inputTexture = null, this.backTexture = null, this.filters = null, this.bounds = new m(), this.container = null, this.blendRequired = !1, this.outputRenderSurface = null, this.globalFrame = {
			x: 0,
			y: 0,
			width: 0,
			height: 0
	...
	constructor(e) {
		this._filterStackIndex = 0, this._filterStack = [], this._filterGlobalUniforms = new i({
			uInputSize: {
		...
		}), this._globalFilterBindGroup = new u({}), this.renderer = e;
	}
	...
	generateFilteredTexture({ texture: e, filters: t }) {
		...
		let c = i;
		this._calculateGlobalFrame(n, 0, 0, c, r.width, r.height), n.outputRenderSurface = S.getOptimalTexture(o.width, o.height, n.resolution, n.antialias), n.backTexture = s.EMPTY, n.inputTexture = e, this.renderer.renderTarget.finishRenderPass(), this._applyFiltersToTexture(n, !0);
		let l = n.outputRenderSurface;
		return l.source.alphaMode = "premultiplied-alpha", l;
	}
	pop() {
		let e = this.renderer, t = this._popFilterData();
		t.skip || (e.globalUniforms.pop(), e.renderTarget.finishRenderPass(), this._activeFilterData = t, this._applyFiltersToTexture(t, !1), t.blendRequired && S.returnTexture(t.backTexture), S.returnTexture(t.inputTexture));
	}
	getBackTexture(e, t, n) {
		let r = e.colorTexture.source._resolution, i = S.getOptimalTexture(t.width, t.height, r, !1), a = t.minX, o = t.minY;
	...
	_getPassthroughFilter() {
		return this._passthroughFilter ??= new Se(), this._passthroughFilter;
	}
	_setupBindGroupsAndRender(e, t, n) {
		...
		}), n.type === c.WEBGL && n.renderTarget.finishRenderPass();
	}
	_setupFilterTextures(e, t, n, r) {
		if (e.backTexture = s.EMPTY, e.inputTexture = S.getOptimalTexture(t.width, t.height, e.resolution, e.antialias), e.blendRequired) {
	...
	_updateFilterUniforms(e, t, n, r, i, a, o, c) {
		...
		o ? (u[0] = n.bounds.minX - r, u[1] = n.bounds.minY - i) : (u[0] = 0, u[1] = 0), u[2] = e.frame.width, u[3] = e.frame.height, d[0] = e.source.width, d[1] = e.source.height, d[2] = 1 / d[0], d[3] = 1 / d[1], f[0] = e.source.pixelWidth, f[1] = e.source.pixelHeight, f[2] = 1 / f[0], f[3] = 1 / f[1], p[0] = .5 * f[2], p[1] = .5 * f[3], p[2] = e.frame.width * d[2] - .5 * f[2], p[3] = e.frame.height * d[3] - .5 * f[3];
		let g = this.renderer.renderTarget.rootRenderTarget.colorTexture;
		m[0] = r * a, m[1] = i * a, m[2] = g.source.width * a, m[3] = g.source.height * a, t instanceof s && (t.source.resource = null);
		let _ = this.renderer.renderTarget.getRenderTarget(t);
		this.renderer.renderTarget.bind(t, !!c), t instanceof s ? (h[0] = t.frame.width, h[1] = t.frame.height) : (h[0] = _.width, h[1] = _.height), h[2] = _.isRoot ? -1 : 1, this._filterGlobalUniforms.update();
	}
	...
	_applyFiltersToTexture(e, t) {
		...
		if (this._globalFilterBindGroup.setResource(n.source.style, 2), this._globalFilterBindGroup.setResource(e.backTexture.source, 3), a === o) i[a].apply(this, n, e.outputRenderSurface, t);
			...
			let n = e.inputTexture, s = S.getOptimalTexture(r.width, r.height, n.source._resolution, !1), c = s;
			for (let e = a; e < o; e++) {
				let t = i[e];
			...
			i[o].apply(this, n, e.outputRenderSurface, t), S.returnTexture(s);
		}
	}
	...
	_pushFilterData() {
		let e = this._filterStack[this._filterStackIndex];
		return e ||= this._filterStack[this._filterStackIndex] = new we(), this._filterStackIndex++, e;
	}
};
$.extension = {
	type: [h.WebGLSystem, h.WebGPUSystem],
	name: "filter"
};
//#endregion
export { U as a, A as c, G as i, O as l, Q as n, M as o, Z as r, j as s, $ as t, T as u };
