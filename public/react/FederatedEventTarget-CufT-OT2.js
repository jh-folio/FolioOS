import { O as e, P as t, R as n, z as r } from "./Geometry-BFCE0DPo.js";
import { o as i, s as a, v as o } from "./Filter-Bn4pCCDL.js";
...
var s = class {
	...
	_attachObserver() {
		...
		}), this._observer.observe(this._canvas)) : this._tickerAttached || i.shared.add(this.updateTranslation, this, a.HIGH);
	}
	destroy() {
	...
	constructor(n) {
		this.bubbles = !0, this.cancelBubble = !0, this.cancelable = !1, this.composed = !1, this.defaultPrevented = !1, this.eventPhase = e.prototype.NONE, this.propagationStopped = !1, this.propagationImmediatelyStopped = !1, this.layer = new t(), this.page = new t(), this.NONE = 0, this.CAPTURING_PHASE = 1, this.AT_TARGET = 2, this.BUBBLING_PHASE = 3, this.manager = n;
	}
	get layerX() {
		return this.layer.x;
	}
...
var D = (E.default ?? E)(globalThis.navigator), O = 9, k = 100, A = 0, j = 0, M = 2, N = 1, P = -1e3, F = -1e3, I = 2, L = class e {
	...
	postrender() {
		...
		for (let e = this._children.length - 1; e >= 0; e--) {
			...
			t.has(e) || (n._accessibleDiv && n._accessibleDiv.parentNode && (n._accessibleDiv.parentNode.removeChild(n._accessibleDiv), this._getPool(n.accessibleType).push(n._accessibleDiv), n._accessibleDiv = null), n._accessibleActive = !1, o(this._children, e, 1));
		}
...
var V = new class {
	...
	addTickerListener() {
		this._tickerAdded || !this.domElement || (i.system.add(this._tickerUpdate, this, a.INTERACTION), this._tickerAdded = !0);
	}
...
var G = 2048, K = new t(), q = new t(), J = class {
	constructor(e) {
...
//#endregion
export { R as a, z as i, Q as n, B as r, $ as t };
