import { A as e, B as t, D as n, E as r, L as i, M as a, N as o, O as s, P as c, R as l, T as u, a as d, c as f, h as p, k as m, m as h, o as g, p as _, s as ee, u as te, v, w as y, y as ne, z as b } from "./Geometry-BFCE0DPo.js";
import { _ as re, c as x, d as ie, i as ae, l as oe, m as se, n as ce, o as S, p as le, r as C, t as ue, u as w } from "./Filter-Bn4pCCDL.js";
import { n as de, p as T } from "./GCManagedHash-CBZAeQ_B.js";
...
var j = class e {
	...
	buildStart(e) {
		...
		t || (t = this._batchersByInstructionSet[e.uid] = /* @__PURE__ */ Object.create(null), t.default ||= new de({ maxTextures: this.renderer.limits.maxBatchableTextures })), this._activeBatches = t, this._activeBatch = this._activeBatches.default;
...
var z = /* @__PURE__ */ ((e) => (e[e.NONE = 0] = "NONE", e[e.COLOR = 16384] = "COLOR", e[e.STENCIL = 1024] = "STENCIL", e[e.DEPTH = 256] = "DEPTH", e[e.COLOR_DEPTH = 16640] = "COLOR_DEPTH", e[e.COLOR_STENCIL = 17408] = "COLOR_STENCIL", e[e.DEPTH_STENCIL = 1280] = "DEPTH_STENCIL", e[e.ALL = 17664] = "ALL", e))(z || {}), be = class {
	...
	async init(e = {}) {
		await ve(e.skipExtensionImports === !0 ? !0 : e.manageImports === !1), this._addSystems(this.config.systems), this._addPipes(this.config.renderPipes, this.config.renderPipeAdaptors);
	...
	render(t, n) {
		this.tick++;
		let r = t;
		if (r instanceof x && (r = { container: r }, n && (m(e, "passing a second argument is deprecated, please use render options instead"), r.target = n.renderTexture)), r.target ||= this.view.renderTarget, r.target === this.view.renderTarget && (this._lastObjectRendered = r.container, r.clearColor ??= this.background.colorRgba, r.clear ??= this.background.clearBeforeRender), r.clearColor) {
